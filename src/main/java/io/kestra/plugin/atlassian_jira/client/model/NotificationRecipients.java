...
public class NotificationRecipients {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("assignee", "groupIds", "groups", "reporter", "users", "voters", "watchers"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!NotificationRecipients.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in NotificationRecipients is not found in the empty JSON string",
            NotificationRecipients.openapiRequiredFields.toString()));
      }
    }
    ...
    if (jsonObj.get("groupIds") != null && !jsonObj.get("groupIds").isJsonNull()
      ...
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `groupIds` to be an array in the JSON string but got `%s`",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<NotificationRecipients> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(NotificationRecipients.class));

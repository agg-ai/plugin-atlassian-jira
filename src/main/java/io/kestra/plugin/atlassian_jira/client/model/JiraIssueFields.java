...
import io.kestra.plugin.atlassian_jira.client.model.JiraCascadingSelectField;
import io.kestra.plugin.atlassian_jira.client.model.JiraColorField;
import io.kestra.plugin.atlassian_jira.client.model.JiraDateField;
import io.kestra.plugin.atlassian_jira.client.model.JiraDateTimeField;
import io.kestra.plugin.atlassian_jira.client.model.JiraDurationField;
import io.kestra.plugin.atlassian_jira.client.model.JiraIssueTypeField;
import io.kestra.plugin.atlassian_jira.client.model.JiraLabelsField;
import io.kestra.plugin.atlassian_jira.client.model.JiraMultiSelectComponentField;
import io.kestra.plugin.atlassian_jira.client.model.JiraMultipleGroupPickerField;
import io.kestra.plugin.atlassian_jira.client.model.JiraMultipleSelectField;
import io.kestra.plugin.atlassian_jira.client.model.JiraMultipleSelectUserPickerField;
import io.kestra.plugin.atlassian_jira.client.model.JiraMultipleVersionPickerField;
import io.kestra.plugin.atlassian_jira.client.model.JiraNumberField;
import io.kestra.plugin.atlassian_jira.client.model.JiraPriorityField;
import io.kestra.plugin.atlassian_jira.client.model.JiraRichTextField;
import io.kestra.plugin.atlassian_jira.client.model.JiraSingleGroupPickerField;
import io.kestra.plugin.atlassian_jira.client.model.JiraSingleLineTextField;
import io.kestra.plugin.atlassian_jira.client.model.JiraSingleSelectField;
import io.kestra.plugin.atlassian_jira.client.model.JiraSingleSelectUserPickerField;
import io.kestra.plugin.atlassian_jira.client.model.JiraSingleVersionPickerField;
import io.kestra.plugin.atlassian_jira.client.model.JiraStatusInput;
import io.kestra.plugin.atlassian_jira.client.model.JiraTimeTrackingField;
import io.kestra.plugin.atlassian_jira.client.model.JiraUrlField;
...
public class JiraIssueFields {
  ...
  public JiraIssueFields cascadingSelectFields(
      @javax.annotation.Nullable List<JiraCascadingSelectField> cascadingSelectFields) {
  ...
  /**
   * Add or clear a cascading select field: * To add, specify &#x60;optionId&#x60;
   * for both parent and child. * To clear the child, set its &#x60;optionId&#x60;
   * to null. * To clear both, set the parent&#39;s &#x60;optionId&#x60; to null.
   * 
  ...
  public void setCascadingSelectFields(
      @javax.annotation.Nullable List<JiraCascadingSelectField> cascadingSelectFields) {
    this.cascadingSelectFields = cascadingSelectFields;
  }
  ...
  /**
   * Add or clear a number field: * To add, specify a numeric &#x60;value&#x60;. *
  ...
  /**
   * Add or clear a color field: * To add, specify the color &#x60;name&#x60;.
   * Available colors are: &#x60;purple&#x60;, &#x60;blue&#x60;,
   * &#x60;green&#x60;, &#x60;teal&#x60;, &#x60;yellow&#x60;, &#x60;orange&#x60;,
   * &#x60;grey&#x60;, &#x60;dark purple&#x60;, &#x60;dark blue&#x60;, &#x60;dark
   * green&#x60;, &#x60;dark teal&#x60;, &#x60;dark yellow&#x60;, &#x60;dark
   * orange&#x60;, &#x60;dark grey&#x60;. * To clear, set the color
  ...
  /**
   * Add or clear a date picker field: * To add, specify the date in
   * &#x60;d/mmm/yy&#x60; format or ISO format &#x60;dd-mm-yyyy&#x60;. * To clear,
   * set &#x60;formattedDate&#x60; to an empty string.
   * 
  ...
  /**
   * Add or clear the planned start date and time: * To add, specify the date and
   * time in ISO format for &#x60;formattedDateTime&#x60;. * To clear, provide an
   * empty string for &#x60;formattedDateTime&#x60;.
   * 
  ...
  /**
   * Edit a labels field: * Options include &#x60;ADD&#x60;, &#x60;REPLACE&#x60;,
   * &#x60;REMOVE&#x60;, or &#x60;REMOVE_ALL&#x60; for bulk edits. * To clear
   * labels, use the &#x60;REMOVE_ALL&#x60; option with an empty
   * &#x60;labels&#x60; array.
   * 
   * @return labelsFields
   */
  ...
  public JiraIssueFields multipleGroupPickerFields(
      @javax.annotation.Nullable List<JiraMultipleGroupPickerField> multipleGroupPickerFields) {
  ...
  /**
   * Add or clear a multi-group picker field: * To add groups, provide an array of
   * groups with &#x60;groupName&#x60;s. * To clear all groups, use an empty
   * &#x60;groups&#x60; array.
   * 
  ...
  public void setMultipleGroupPickerFields(
      @javax.annotation.Nullable List<JiraMultipleGroupPickerField> multipleGroupPickerFields) {
    this.multipleGroupPickerFields = multipleGroupPickerFields;
  }

  public JiraIssueFields multipleSelectClearableUserPickerFields(
      @javax.annotation.Nullable List<JiraMultipleSelectUserPickerField> multipleSelectClearableUserPickerFields) {
    this.multipleSelectClearableUserPickerFields = multipleSelectClearableUserPickerFields;
    return this;
  }

  public JiraIssueFields addMultipleSelectClearableUserPickerFieldsItem(
      JiraMultipleSelectUserPickerField multipleSelectClearableUserPickerFieldsItem) {
  ...
  /**
   * Assign or unassign multiple users to/from a field: * To assign, provide an
   * array of user &#x60;accountId&#x60;s. * To clear, set &#x60;users&#x60; to
   * &#x60;null&#x60;.
   * 
  ...
  public void setMultipleSelectClearableUserPickerFields(
      @javax.annotation.Nullable List<JiraMultipleSelectUserPickerField> multipleSelectClearableUserPickerFields) {
    this.multipleSelectClearableUserPickerFields = multipleSelectClearableUserPickerFields;
  }

  public JiraIssueFields multipleSelectFields(
      @javax.annotation.Nullable List<JiraMultipleSelectField> multipleSelectFields) {
  ...
  /**
   * Add or clear a multi-select field: * To add, provide an array of options with
   * &#x60;optionId&#x60;s. * To clear, use an empty &#x60;options&#x60; array.
   * 
  ...
  public JiraIssueFields multipleVersionPickerFields(
      @javax.annotation.Nullable List<JiraMultipleVersionPickerField> multipleVersionPickerFields) {
    this.multipleVersionPickerFields = multipleVersionPickerFields;
    return this;
  }

  public JiraIssueFields addMultipleVersionPickerFieldsItem(
      JiraMultipleVersionPickerField multipleVersionPickerFieldsItem) {
   ...
   * Options include &#x60;ADD&#x60;, &#x60;REPLACE&#x60;, &#x60;REMOVE&#x60;, or
   * &#x60;REMOVE_ALL&#x60; for bulk edits. * To clear the field, use the
   * &#x60;REMOVE_ALL&#x60; option with an empty &#x60;versions&#x60; array.
   * 
  ...
  public void setMultipleVersionPickerFields(
      @javax.annotation.Nullable List<JiraMultipleVersionPickerField> multipleVersionPickerFields) {
    this.multipleVersionPickerFields = multipleVersionPickerFields;
  }

  public JiraIssueFields multiselectComponents(
      @javax.annotation.Nullable JiraMultiSelectComponentField multiselectComponents) {
    this.multiselectComponents = multiselectComponents;
    return this;
  }

  /**
   * Edit a multi select components field: * Options include &#x60;ADD&#x60;,
   * &#x60;REPLACE&#x60;, &#x60;REMOVE&#x60;, or &#x60;REMOVE_ALL&#x60; for bulk
   * edits. * To clear, use the &#x60;REMOVE_ALL&#x60; option with an empty
   * &#x60;components&#x60; array.
   * 
  ...
  /**
   * Add or clear a rich text field: * To add, provide &#x60;adfValue&#x60;. Note
   * that rich text fields only support ADF values. * To clear, use an empty
   * &#x60;richText&#x60; object. For ADF format details, refer to: [Atlassian
   * Document
  ...
  public JiraIssueFields singleGroupPickerFields(
      @javax.annotation.Nullable List<JiraSingleGroupPickerField> singleGroupPickerFields) {
  ...
  /**
   * Add or clear a single group picker field: * To add, specify the group with
   * &#x60;groupName&#x60;. * To clear, set &#x60;groupName&#x60; to an empty
   * string.
   * 
  ...
  public void setSingleGroupPickerFields(
      @javax.annotation.Nullable List<JiraSingleGroupPickerField> singleGroupPickerFields) {
    this.singleGroupPickerFields = singleGroupPickerFields;
  }

  public JiraIssueFields singleLineTextFields(
      @javax.annotation.Nullable List<JiraSingleLineTextField> singleLineTextFields) {
   ...
   * value. * To clear, set &#x60;text&#x60; to an empty string.
   * 
  ...
  public JiraIssueFields singleSelectClearableUserPickerFields(
      @javax.annotation.Nullable List<JiraSingleSelectUserPickerField> singleSelectClearableUserPickerFields) {
    this.singleSelectClearableUserPickerFields = singleSelectClearableUserPickerFields;
    return this;
  }

  public JiraIssueFields addSingleSelectClearableUserPickerFieldsItem(
      JiraSingleSelectUserPickerField singleSelectClearableUserPickerFieldsItem) {
   ...
   * * To assign an issue, specify the user&#39;s &#x60;accountId&#x60;. * To
   * unassign an issue, set &#x60;user&#x60; to &#x60;null&#x60;. * For automatic
   * assignment, set &#x60;accountId&#x60; to &#x60;-1&#x60;.
   * 
  ...
  public void setSingleSelectClearableUserPickerFields(
      @javax.annotation.Nullable List<JiraSingleSelectUserPickerField> singleSelectClearableUserPickerFields) {
    this.singleSelectClearableUserPickerFields = singleSelectClearableUserPickerFields;
  }
  ...
  /**
   * Add or clear a single select field: * To add, specify the option with an
   * &#x60;optionId&#x60;. * To clear, pass an option with &#x60;optionId&#x60; as
   * &#x60;-1&#x60;.
   * 
  ...
  public JiraIssueFields singleVersionPickerFields(
      @javax.annotation.Nullable List<JiraSingleVersionPickerField> singleVersionPickerFields) {
  ...
  /**
   * Add or clear a single version picker field: * To add, specify the version
   * with a &#x60;versionId&#x60;. * To clear, set &#x60;versionId&#x60; to
   * &#x60;-1&#x60;.
   * 
  ...
  public void setSingleVersionPickerFields(
      @javax.annotation.Nullable List<JiraSingleVersionPickerField> singleVersionPickerFields) {
    this.singleVersionPickerFields = singleVersionPickerFields;
  }
  ...
  /**
   * Add or clear a URL field: * To add, provide the &#x60;url&#x60; with the
   * desired URL value. * To clear, set &#x60;url&#x60; to an empty string.
   * 
   * @return urlFields
   */
  @javax.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cascadingSelectFields, jiraIssueFields.cascadingSelectFields) &&
        ...
        Objects.equals(this.multipleSelectClearableUserPickerFields,
            jiraIssueFields.multipleSelectClearableUserPickerFields)
        &&
        ...
        Objects.equals(this.singleSelectClearableUserPickerFields,
            jiraIssueFields.singleSelectClearableUserPickerFields)
        &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cascadingSelectFields, clearableNumberFields, colorFields, datePickerFields,
        dateTimePickerFields, issueType, labelsFields, multipleGroupPickerFields,
        multipleSelectClearableUserPickerFields, multipleSelectFields, multipleVersionPickerFields,
        multiselectComponents, originalEstimateField, priority, richTextFields, singleGroupPickerFields,
        singleLineTextFields, singleSelectClearableUserPickerFields, singleSelectFields, singleVersionPickerFields,
        status, timeTrackingField, urlFields);
  }
  ...
  public String toString() {
    ...
    sb.append("    multipleSelectClearableUserPickerFields: ")
        .append(toIndentedString(multipleSelectClearableUserPickerFields)).append("\n");
    ...
    sb.append("    singleSelectClearableUserPickerFields: ")
        .append(toIndentedString(singleSelectClearableUserPickerFields)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("cascadingSelectFields", "clearableNumberFields", "colorFields",
        "datePickerFields", "dateTimePickerFields", "issueType", "labelsFields", "multipleGroupPickerFields",
        "multipleSelectClearableUserPickerFields", "multipleSelectFields", "multipleVersionPickerFields",
        "multiselectComponents", "originalEstimateField", "priority", "richTextFields", "singleGroupPickerFields",
        "singleLineTextFields", "singleSelectClearableUserPickerFields", "singleSelectFields",
        "singleVersionPickerFields", "status", "timeTrackingField", "urlFields"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!JiraIssueFields.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in JiraIssueFields is not found in the empty JSON string",
            JiraIssueFields.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!JiraIssueFields.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `JiraIssueFields` properties. JSON: %s",
    ...
    if (jsonObj.get("cascadingSelectFields") != null && !jsonObj.get("cascadingSelectFields").isJsonNull()) {
      ...
      if (jsonArraycascadingSelectFields != null) {
        ...
        if (!jsonObj.get("cascadingSelectFields").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `cascadingSelectFields` to be an array in the JSON string but got `%s`",
              jsonObj.get("cascadingSelectFields").toString()));
        }
    ...
    if (jsonObj.get("clearableNumberFields") != null && !jsonObj.get("clearableNumberFields").isJsonNull()) {
      ...
      if (jsonArrayclearableNumberFields != null) {
        ...
        if (!jsonObj.get("clearableNumberFields").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `clearableNumberFields` to be an array in the JSON string but got `%s`",
              jsonObj.get("clearableNumberFields").toString()));
        }
    ...
    if (jsonObj.get("colorFields") != null && !jsonObj.get("colorFields").isJsonNull()) {
      ...
      if (jsonArraycolorFields != null) {
        ...
        if (!jsonObj.get("colorFields").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `colorFields` to be an array in the JSON string but got `%s`",
              jsonObj.get("colorFields").toString()));
        }
    ...
    if (jsonObj.get("datePickerFields") != null && !jsonObj.get("datePickerFields").isJsonNull()) {
      ...
      if (jsonArraydatePickerFields != null) {
        ...
        if (!jsonObj.get("datePickerFields").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `datePickerFields` to be an array in the JSON string but got `%s`",
              jsonObj.get("datePickerFields").toString()));
        }
    ...
    if (jsonObj.get("dateTimePickerFields") != null && !jsonObj.get("dateTimePickerFields").isJsonNull()) {
      ...
      if (jsonArraydateTimePickerFields != null) {
        ...
        if (!jsonObj.get("dateTimePickerFields").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `dateTimePickerFields` to be an array in the JSON string but got `%s`",
              jsonObj.get("dateTimePickerFields").toString()));
        }
    ...
    if (jsonObj.get("labelsFields") != null && !jsonObj.get("labelsFields").isJsonNull()) {
      ...
      if (jsonArraylabelsFields != null) {
        ...
        if (!jsonObj.get("labelsFields").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `labelsFields` to be an array in the JSON string but got `%s`",
              jsonObj.get("labelsFields").toString()));
        }
    ...
    if (jsonObj.get("multipleGroupPickerFields") != null && !jsonObj.get("multipleGroupPickerFields").isJsonNull()) {
      ...
      if (jsonArraymultipleGroupPickerFields != null) {
        ...
        if (!jsonObj.get("multipleGroupPickerFields").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `multipleGroupPickerFields` to be an array in the JSON string but got `%s`",
              jsonObj.get("multipleGroupPickerFields").toString()));
        }
    ...
    if (jsonObj.get("multipleSelectClearableUserPickerFields") != null
        && !jsonObj.get("multipleSelectClearableUserPickerFields").isJsonNull()) {
      JsonArray jsonArraymultipleSelectClearableUserPickerFields = jsonObj
          .getAsJsonArray("multipleSelectClearableUserPickerFields");
      if (jsonArraymultipleSelectClearableUserPickerFields != null) {
        ...
        if (!jsonObj.get("multipleSelectClearableUserPickerFields").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `multipleSelectClearableUserPickerFields` to be an array in the JSON string but got `%s`",
              jsonObj.get("multipleSelectClearableUserPickerFields").toString()));
        }
        ...
        for (int i = 0; i < jsonArraymultipleSelectClearableUserPickerFields.size(); i++) {
          JiraMultipleSelectUserPickerField
              .validateJsonElement(jsonArraymultipleSelectClearableUserPickerFields.get(i));
        }
        ;
      }
    }
    if (jsonObj.get("multipleSelectFields") != null && !jsonObj.get("multipleSelectFields").isJsonNull()) {
      ...
      if (jsonArraymultipleSelectFields != null) {
        ...
        if (!jsonObj.get("multipleSelectFields").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `multipleSelectFields` to be an array in the JSON string but got `%s`",
              jsonObj.get("multipleSelectFields").toString()));
        }
    ...
    if (jsonObj.get("multipleVersionPickerFields") != null
        && !jsonObj.get("multipleVersionPickerFields").isJsonNull()) {
      ...
      if (jsonArraymultipleVersionPickerFields != null) {
        ...
        if (!jsonObj.get("multipleVersionPickerFields").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `multipleVersionPickerFields` to be an array in the JSON string but got `%s`",
              jsonObj.get("multipleVersionPickerFields").toString()));
        }
    ...
    if (jsonObj.get("richTextFields") != null && !jsonObj.get("richTextFields").isJsonNull()) {
      ...
      if (jsonArrayrichTextFields != null) {
        ...
        if (!jsonObj.get("richTextFields").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `richTextFields` to be an array in the JSON string but got `%s`",
              jsonObj.get("richTextFields").toString()));
        }
    ...
    if (jsonObj.get("singleGroupPickerFields") != null && !jsonObj.get("singleGroupPickerFields").isJsonNull()) {
      ...
      if (jsonArraysingleGroupPickerFields != null) {
        ...
        if (!jsonObj.get("singleGroupPickerFields").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `singleGroupPickerFields` to be an array in the JSON string but got `%s`",
              jsonObj.get("singleGroupPickerFields").toString()));
        }
    ...
    if (jsonObj.get("singleLineTextFields") != null && !jsonObj.get("singleLineTextFields").isJsonNull()) {
      ...
      if (jsonArraysingleLineTextFields != null) {
        ...
        if (!jsonObj.get("singleLineTextFields").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `singleLineTextFields` to be an array in the JSON string but got `%s`",
              jsonObj.get("singleLineTextFields").toString()));
        }
    ...
    if (jsonObj.get("singleSelectClearableUserPickerFields") != null
        && !jsonObj.get("singleSelectClearableUserPickerFields").isJsonNull()) {
      JsonArray jsonArraysingleSelectClearableUserPickerFields = jsonObj
          .getAsJsonArray("singleSelectClearableUserPickerFields");
      if (jsonArraysingleSelectClearableUserPickerFields != null) {
        // ensure the json data is an array
        if (!jsonObj.get("singleSelectClearableUserPickerFields").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `singleSelectClearableUserPickerFields` to be an array in the JSON string but got `%s`",
              jsonObj.get("singleSelectClearableUserPickerFields").toString()));
        }
    ...
    if (jsonObj.get("singleSelectFields") != null && !jsonObj.get("singleSelectFields").isJsonNull()) {
      ...
      if (jsonArraysingleSelectFields != null) {
        ...
        if (!jsonObj.get("singleSelectFields").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `singleSelectFields` to be an array in the JSON string but got `%s`",
              jsonObj.get("singleSelectFields").toString()));
        }
    ...
    if (jsonObj.get("singleVersionPickerFields") != null && !jsonObj.get("singleVersionPickerFields").isJsonNull()) {
      ...
      if (jsonArraysingleVersionPickerFields != null) {
        ...
        if (!jsonObj.get("singleVersionPickerFields").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `singleVersionPickerFields` to be an array in the JSON string but got `%s`",
              jsonObj.get("singleVersionPickerFields").toString()));
        }
    ...
    if (jsonObj.get("urlFields") != null && !jsonObj.get("urlFields").isJsonNull()) {
      ...
      if (jsonArrayurlFields != null) {
        ...
        if (!jsonObj.get("urlFields").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `urlFields` to be an array in the JSON string but got `%s`",
              jsonObj.get("urlFields").toString()));
        }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<JiraIssueFields> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(JiraIssueFields.class));

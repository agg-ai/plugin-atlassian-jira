...
public class VersionUsageInCustomField {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customFieldId, versionUsageInCustomField.customFieldId) &&
        ...
        Objects.equals(this.issueCountWithVersionInCustomField,
            versionUsageInCustomField.issueCountWithVersionInCustomField);
  }
  ...
  public String toString() {
    ...
    sb.append("    issueCountWithVersionInCustomField: ").append(toIndentedString(issueCountWithVersionInCustomField))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("customFieldId", "fieldName", "issueCountWithVersionInCustomField"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!VersionUsageInCustomField.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in VersionUsageInCustomField is not found in the empty JSON string",
            VersionUsageInCustomField.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!VersionUsageInCustomField.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `VersionUsageInCustomField` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<VersionUsageInCustomField> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(VersionUsageInCustomField.class));

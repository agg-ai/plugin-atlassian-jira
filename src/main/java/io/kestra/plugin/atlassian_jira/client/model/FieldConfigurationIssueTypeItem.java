...
public class FieldConfigurationIssueTypeItem {
  ...
  public FieldConfigurationIssueTypeItem fieldConfigurationSchemeId(
      @javax.annotation.Nonnull String fieldConfigurationSchemeId) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("fieldConfigurationId", "fieldConfigurationSchemeId", "issueTypeId"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!FieldConfigurationIssueTypeItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                              // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in FieldConfigurationIssueTypeItem is not found in the empty JSON string",
            FieldConfigurationIssueTypeItem.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!FieldConfigurationIssueTypeItem.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `FieldConfigurationIssueTypeItem` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<FieldConfigurationIssueTypeItem> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(FieldConfigurationIssueTypeItem.class));

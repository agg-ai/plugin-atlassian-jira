...
public class AddNotificationsDetails {
  ...
  public AddNotificationsDetails notificationSchemeEvents(
      @javax.annotation.Nonnull List<NotificationSchemeEventDetails> notificationSchemeEvents) {
    this.notificationSchemeEvents = notificationSchemeEvents;
    return this;
  }

  public AddNotificationsDetails addNotificationSchemeEventsItem(
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("notificationSchemeEvents"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("notificationSchemeEvents"));
  }
    ...
    if (jsonElement == null) {
      if (!AddNotificationsDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in AddNotificationsDetails is not found in the empty JSON string",
            AddNotificationsDetails.openapiRequiredFields.toString()));
      }
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<AddNotificationsDetails> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(AddNotificationsDetails.class));

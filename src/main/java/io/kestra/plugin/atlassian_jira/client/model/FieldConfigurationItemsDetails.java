...
public class FieldConfigurationItemsDetails {
  ...
  public FieldConfigurationItemsDetails fieldConfigurationItems(
      @javax.annotation.Nonnull List<FieldConfigurationItem> fieldConfigurationItems) {
    this.fieldConfigurationItems = fieldConfigurationItems;
    return this;
  }

  public FieldConfigurationItemsDetails addFieldConfigurationItemsItem(
      FieldConfigurationItem fieldConfigurationItemsItem) {
  ...
  public void setFieldConfigurationItems(
      @javax.annotation.Nonnull List<FieldConfigurationItem> fieldConfigurationItems) {
    this.fieldConfigurationItems = fieldConfigurationItems;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("fieldConfigurationItems"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("fieldConfigurationItems"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!FieldConfigurationItemsDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                             // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in FieldConfigurationItemsDetails is not found in the empty JSON string",
            FieldConfigurationItemsDetails.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!FieldConfigurationItemsDetails.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `FieldConfigurationItemsDetails` properties. JSON: %s",
    ...
    if (!jsonObj.get("fieldConfigurationItems").isJsonArray()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `fieldConfigurationItems` to be an array in the JSON string but got `%s`",
          jsonObj.get("fieldConfigurationItems").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<FieldConfigurationItemsDetails> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(FieldConfigurationItemsDetails.class));

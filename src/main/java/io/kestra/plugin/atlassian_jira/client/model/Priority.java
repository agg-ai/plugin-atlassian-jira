...
import io.kestra.plugin.atlassian_jira.client.model.ExpandPrioritySchemePage;
...
public class Priority {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(avatarId, description, iconUrl, id, isDefault, name, schemes, self, statusColor,
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("avatarId", "description", "iconUrl", "id", "isDefault", "name",
        "schemes", "self", "statusColor"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!Priority.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in Priority is not found in the empty JSON string",
                Priority.openapiRequiredFields.toString()));
      }
    }
    ...
    if ((jsonObj.get("iconUrl") != null && !jsonObj.get("iconUrl").isJsonNull())
      ...
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `iconUrl` to be a primitive type in the JSON string but got `%s`",
    ...
    if ((jsonObj.get("statusColor") != null && !jsonObj.get("statusColor").isJsonNull())
        && !jsonObj.get("statusColor").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `statusColor` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("statusColor").toString()));
    }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<Priority> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(Priority.class));

...
import io.kestra.plugin.atlassian_jira.client.model.FilterSubscription;
...
public class FilterDetails {
  ...
  public FilterDetails description(@javax.annotation.Nullable String description) {
  ...
  public FilterDetails editPermissions(@javax.annotation.Nullable List<SharePermission> editPermissions) {
  ...
  public FilterDetails name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public FilterDetails sharePermissions(@javax.annotation.Nullable List<SharePermission> sharePermissions) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(approximateLastUsed, description, editPermissions, expand, favourite, favouritedCount, id, jql,
        name, owner, searchUrl, self, sharePermissions, subscriptions, viewUrl);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("approximateLastUsed", "description", "editPermissions", "expand", "favourite", "favouritedCount",
            "id", "jql", "name", "owner", "searchUrl", "self", "sharePermissions", "subscriptions", "viewUrl"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!FilterDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in FilterDetails is not found in the empty JSON string",
            FilterDetails.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!FilterDetails.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `FilterDetails` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<FilterDetails> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(FilterDetails.class));

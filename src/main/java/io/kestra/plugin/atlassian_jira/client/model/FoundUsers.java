...
import io.kestra.plugin.atlassian_jira.client.model.UserPickerUser;
...
public class FoundUsers {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("header", "total", "users"));
    ...
    if (jsonElement == null) {
      if (!FoundUsers.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in FoundUsers is not found in the empty JSON string",
                FoundUsers.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!FoundUsers.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `FoundUsers` properties. JSON: %s", entry.getKey(),
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<FoundUsers> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(FoundUsers.class));

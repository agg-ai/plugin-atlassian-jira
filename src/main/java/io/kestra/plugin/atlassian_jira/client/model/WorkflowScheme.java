...
public class WorkflowScheme {
   ...
   * &#x60;defaultWorkflow&#x60; is not specified when creating a workflow scheme,
  ...
  /**
   * The issue type to workflow mappings, where each mapping is an issue type ID
   * and workflow name pair. Note that an issue type can only be mapped to one
   ...
   * change to the issue type-project mappings only. This property does not apply
   * to non-draft workflows.
   * 
  ...
  /**
   * The name of the workflow scheme. The name must be unique. The maximum length
   * is 255 characters. Required when creating a workflow scheme.
   * 
   * @return name
   */
  @javax.annotation.Nullable
   ...
   * type ID and workflow name pair. Note that an issue type can only be mapped to
   ...
   * workflow scheme. An active workflow scheme is a workflow scheme that is used
   * by at least one project. The following examples show how this property works:
   * * Update an active workflow scheme with &#x60;updateDraftIfNeeded&#x60; set
   * to &#x60;true&#x60;: If a draft workflow scheme exists, it is updated.
   * Otherwise, a draft workflow scheme is created. * Update an active workflow
   * scheme with &#x60;updateDraftIfNeeded&#x60; set to &#x60;false&#x60;: An
   * error is returned, as active workflow schemes cannot be updated. * Update an
   * inactive workflow scheme with &#x60;updateDraftIfNeeded&#x60; set to
   * &#x60;true&#x60;: The workflow scheme is updated, as inactive workflow
   * schemes do not require drafts to update. Defaults to &#x60;false&#x60;.
   * 
  ...
  @Override
  public int hashCode() {
    return Objects.hash(defaultWorkflow, description, draft, id, issueTypeMappings, issueTypes, lastModified,
        lastModifiedUser, name, originalDefaultWorkflow, originalIssueTypeMappings, self, updateDraftIfNeeded);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("defaultWorkflow", "description", "draft", "id",
        "issueTypeMappings", "issueTypes", "lastModified", "lastModifiedUser", "name", "originalDefaultWorkflow",
        "originalIssueTypeMappings", "self", "updateDraftIfNeeded"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!WorkflowScheme.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in WorkflowScheme is not found in the empty JSON string",
            WorkflowScheme.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!WorkflowScheme.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `WorkflowScheme` properties. JSON: %s",
            entry.getKey(), jsonElement.toString()));
      }
    }
    JsonObject jsonObj = jsonElement.getAsJsonObject();
    if ((jsonObj.get("defaultWorkflow") != null && !jsonObj.get("defaultWorkflow").isJsonNull())
        && !jsonObj.get("defaultWorkflow").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `defaultWorkflow` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("defaultWorkflow").toString()));
    }
    ...
    if ((jsonObj.get("lastModified") != null && !jsonObj.get("lastModified").isJsonNull())
      ...
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `lastModified` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("lastModified").toString()));
    }
    ...
    if ((jsonObj.get("originalDefaultWorkflow") != null && !jsonObj.get("originalDefaultWorkflow").isJsonNull())
        && !jsonObj.get("originalDefaultWorkflow").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `originalDefaultWorkflow` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("originalDefaultWorkflow").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<WorkflowScheme> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(WorkflowScheme.class));

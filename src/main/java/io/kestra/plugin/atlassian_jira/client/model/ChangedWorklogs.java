...
import io.kestra.plugin.atlassian_jira.client.model.ChangedWorklog;
...
public class ChangedWorklogs {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("lastPage", "nextPage", "self", "since", "until", "values"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ChangedWorklogs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in ChangedWorklogs is not found in the empty JSON string",
            ChangedWorklogs.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ChangedWorklogs.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ChangedWorklogs` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ChangedWorklogs> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(ChangedWorklogs.class));

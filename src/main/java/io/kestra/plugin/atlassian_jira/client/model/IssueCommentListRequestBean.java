...
public class IssueCommentListRequestBean {
  ...
  public IssueCommentListRequestBean ids(@javax.annotation.Nonnull Set<Long> ids) {
    this.ids = ids;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!IssueCommentListRequestBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                          // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssueCommentListRequestBean is not found in the empty JSON string",
            IssueCommentListRequestBean.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!IssueCommentListRequestBean.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `IssueCommentListRequestBean` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssueCommentListRequestBean> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssueCommentListRequestBean.class));

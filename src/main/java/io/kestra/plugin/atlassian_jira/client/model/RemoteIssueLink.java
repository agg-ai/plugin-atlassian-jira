...
public class RemoteIssueLink {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("application", "globalId", "id", "object", "relationship", "self"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!RemoteIssueLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in RemoteIssueLink is not found in the empty JSON string",
            RemoteIssueLink.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!RemoteIssueLink.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `RemoteIssueLink` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<RemoteIssueLink> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(RemoteIssueLink.class));

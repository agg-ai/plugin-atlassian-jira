...
public class IssueBulkEditField {
  ...
  public IssueBulkEditField multiSelectFieldOptions(
      @javax.annotation.Nullable List<MultiSelectFieldOptionsEnum> multiSelectFieldOptions) {
  ...
  public void setMultiSelectFieldOptions(
      @javax.annotation.Nullable List<MultiSelectFieldOptionsEnum> multiSelectFieldOptions) {
    this.multiSelectFieldOptions = multiSelectFieldOptions;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, fieldOptions, id, isRequired, multiSelectFieldOptions, name, searchUrl, type,
        unavailableMessage);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("description", "fieldOptions", "id", "isRequired",
        "multiSelectFieldOptions", "name", "searchUrl", "type", "unavailableMessage"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!IssueBulkEditField.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssueBulkEditField is not found in the empty JSON string",
            IssueBulkEditField.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!IssueBulkEditField.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `IssueBulkEditField` properties. JSON: %s",
    ...
    if (jsonObj.get("fieldOptions") != null && !jsonObj.get("fieldOptions").isJsonNull()
        && !jsonObj.get("fieldOptions").isJsonArray()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `fieldOptions` to be an array in the JSON string but got `%s`",
              jsonObj.get("fieldOptions").toString()));
    }
    ...
    // ensure the optional json data is an array if present
    if (jsonObj.get("multiSelectFieldOptions") != null && !jsonObj.get("multiSelectFieldOptions").isJsonNull()
        && !jsonObj.get("multiSelectFieldOptions").isJsonArray()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `multiSelectFieldOptions` to be an array in the JSON string but got `%s`",
          jsonObj.get("multiSelectFieldOptions").toString()));
    }
    ...
    if ((jsonObj.get("unavailableMessage") != null && !jsonObj.get("unavailableMessage").isJsonNull())
        && !jsonObj.get("unavailableMessage").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `unavailableMessage` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("unavailableMessage").toString()));
    }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssueBulkEditField> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssueBulkEditField.class));

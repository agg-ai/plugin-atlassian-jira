...
public class ProjectType {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ProjectType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in ProjectType is not found in the empty JSON string",
                ProjectType.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ProjectType.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ProjectType` properties. JSON: %s",
    ...
    if ((jsonObj.get("descriptionI18nKey") != null && !jsonObj.get("descriptionI18nKey").isJsonNull())
        && !jsonObj.get("descriptionI18nKey").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `descriptionI18nKey` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("descriptionI18nKey").toString()));
    }
    if ((jsonObj.get("formattedKey") != null && !jsonObj.get("formattedKey").isJsonNull())
        && !jsonObj.get("formattedKey").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `formattedKey` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("formattedKey").toString()));
    }
    if ((jsonObj.get("icon") != null && !jsonObj.get("icon").isJsonNull()) && !jsonObj.get("icon").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `icon` to be a primitive type in the JSON string but got `%s`",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ProjectType> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(ProjectType.class));

...
import io.kestra.plugin.atlassian_jira.client.model.WorkflowProjectIssueTypeUsagePage;
...
public class WorkflowProjectIssueTypeUsageDTO {
  ...
  public WorkflowProjectIssueTypeUsageDTO issueTypes(
      @javax.annotation.Nullable WorkflowProjectIssueTypeUsagePage issueTypes) {
  ...
  public WorkflowProjectIssueTypeUsageDTO projectId(@javax.annotation.Nullable String projectId) {
  ...
  public WorkflowProjectIssueTypeUsageDTO workflowId(@javax.annotation.Nullable String workflowId) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!WorkflowProjectIssueTypeUsageDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element
                                                                               // is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in WorkflowProjectIssueTypeUsageDTO is not found in the empty JSON string",
            WorkflowProjectIssueTypeUsageDTO.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!WorkflowProjectIssueTypeUsageDTO.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `WorkflowProjectIssueTypeUsageDTO` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!WorkflowProjectIssueTypeUsageDTO.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'WorkflowProjectIssueTypeUsageDTO' and its
                     // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<WorkflowProjectIssueTypeUsageDTO> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(WorkflowProjectIssueTypeUsageDTO.class));

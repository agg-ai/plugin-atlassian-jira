...
public class CreateWorkflowTransitionRule {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("configuration", "type"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CreateWorkflowTransitionRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                           // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CreateWorkflowTransitionRule is not found in the empty JSON string",
            CreateWorkflowTransitionRule.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CreateWorkflowTransitionRule.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CreateWorkflowTransitionRule` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<CreateWorkflowTransitionRule> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CreateWorkflowTransitionRule.class));

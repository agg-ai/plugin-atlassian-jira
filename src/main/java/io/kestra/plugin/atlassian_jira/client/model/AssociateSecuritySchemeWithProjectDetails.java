...
import io.kestra.plugin.atlassian_jira.client.model.OldToNewSecurityLevelMappingsBean;
...
public class AssociateSecuritySchemeWithProjectDetails {
  ...
  public AssociateSecuritySchemeWithProjectDetails oldToNewSecurityLevelMappings(
      @javax.annotation.Nullable List<OldToNewSecurityLevelMappingsBean> oldToNewSecurityLevelMappings) {
    this.oldToNewSecurityLevelMappings = oldToNewSecurityLevelMappings;
    return this;
  }

  public AssociateSecuritySchemeWithProjectDetails addOldToNewSecurityLevelMappingsItem(
      OldToNewSecurityLevelMappingsBean oldToNewSecurityLevelMappingsItem) {
  ...
  public void setOldToNewSecurityLevelMappings(
      @javax.annotation.Nullable List<OldToNewSecurityLevelMappingsBean> oldToNewSecurityLevelMappings) {
    this.oldToNewSecurityLevelMappings = oldToNewSecurityLevelMappings;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.oldToNewSecurityLevelMappings,
        associateSecuritySchemeWithProjectDetails.oldToNewSecurityLevelMappings) &&
  ...
  public String toString() {
    ...
    sb.append("    oldToNewSecurityLevelMappings: ").append(toIndentedString(oldToNewSecurityLevelMappings))
        .append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("oldToNewSecurityLevelMappings", "projectId", "schemeId"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("projectId", "schemeId"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!AssociateSecuritySchemeWithProjectDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON
                                                                                        // element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in AssociateSecuritySchemeWithProjectDetails is not found in the empty JSON string",
            AssociateSecuritySchemeWithProjectDetails.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!AssociateSecuritySchemeWithProjectDetails.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `AssociateSecuritySchemeWithProjectDetails` properties. JSON: %s",
    ...
    if (jsonObj.get("oldToNewSecurityLevelMappings") != null
        && !jsonObj.get("oldToNewSecurityLevelMappings").isJsonNull()) {
      ...
      if (jsonArrayoldToNewSecurityLevelMappings != null) {
        ...
        if (!jsonObj.get("oldToNewSecurityLevelMappings").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `oldToNewSecurityLevelMappings` to be an array in the JSON string but got `%s`",
              jsonObj.get("oldToNewSecurityLevelMappings").toString()));
        }
    ...
    if (!jsonObj.get("schemeId").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `schemeId` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("schemeId").toString()));
    }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!AssociateSecuritySchemeWithProjectDetails.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'AssociateSecuritySchemeWithProjectDetails' and
                     // its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<AssociateSecuritySchemeWithProjectDetails> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(AssociateSecuritySchemeWithProjectDetails.class));
  ...
  /**
   * Create an instance of AssociateSecuritySchemeWithProjectDetails given an JSON
   * string
   *
  ...
  /**
   * Convert an instance of AssociateSecuritySchemeWithProjectDetails to an JSON
   * string
   *
   * @return JSON string
   */

...
public class IssueMatchesForJQL {
  ...
  public IssueMatchesForJQL errors(@javax.annotation.Nonnull Set<String> errors) {
    this.errors = errors;
    return this;
  }
  ...
  public void setErrors(@javax.annotation.Nonnull Set<String> errors) {
    this.errors = errors;
  }

  public IssueMatchesForJQL matchedIssues(@javax.annotation.Nonnull Set<Long> matchedIssues) {
  ...
  public void setMatchedIssues(@javax.annotation.Nonnull Set<Long> matchedIssues) {
    this.matchedIssues = matchedIssues;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("errors", "matchedIssues"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("errors", "matchedIssues"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!IssueMatchesForJQL.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssueMatchesForJQL is not found in the empty JSON string",
            IssueMatchesForJQL.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!IssueMatchesForJQL.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `IssueMatchesForJQL` properties. JSON: %s",
    ...
    if (jsonObj.get("matchedIssues") == null) {
      ...
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `matchedIssues` to be an array in the JSON string but got `%s`",
          jsonObj.get("matchedIssues").toString()));
    }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssueMatchesForJQL> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssueMatchesForJQL.class));

...
public class FieldReferenceData {
  ...
  /**
   * The display name contains the following: * for system fields, the field name.
   * For example, &#x60;Summary&#x60;. * for collapsed custom fields, the field
   * name followed by a hyphen and then the field name and field type. For
   * example, &#x60;Component - Component[Dropdown]&#x60;. * for other custom
   * fields, the field name followed by a hyphen and then the custom field ID. For
   * example, &#x60;Component - cf[10061]&#x60;.
   * 
   * @return displayName
   */
  @javax.annotation.Nullable
  ...
  @Override
  public int hashCode() {
    return Objects.hash(auto, cfid, deprecated, deprecatedSearcherKey, displayName, operators, orderable, searchable,
        types, value);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("auto", "cfid", "deprecated", "deprecatedSearcherKey",
        "displayName", "operators", "orderable", "searchable", "types", "value"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!FieldReferenceData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in FieldReferenceData is not found in the empty JSON string",
            FieldReferenceData.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!FieldReferenceData.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `FieldReferenceData` properties. JSON: %s",
    ...
    if ((jsonObj.get("auto") != null && !jsonObj.get("auto").isJsonNull()) && !jsonObj.get("auto").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `auto` to be a primitive type in the JSON string but got `%s`",
              jsonObj.get("auto").toString()));
    }
    ...
    if ((jsonObj.get("cfid") != null && !jsonObj.get("cfid").isJsonNull()) && !jsonObj.get("cfid").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `cfid` to be a primitive type in the JSON string but got `%s`",
              jsonObj.get("cfid").toString()));
    }
    if ((jsonObj.get("deprecated") != null && !jsonObj.get("deprecated").isJsonNull())
        && !jsonObj.get("deprecated").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `deprecated` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("deprecated").toString()));
    }
    // validate the optional field `deprecated`
    if (jsonObj.get("deprecated") != null && !jsonObj.get("deprecated").isJsonNull()) {
      DeprecatedEnum.validateJsonElement(jsonObj.get("deprecated"));
    }
    if ((jsonObj.get("deprecatedSearcherKey") != null && !jsonObj.get("deprecatedSearcherKey").isJsonNull())
        && !jsonObj.get("deprecatedSearcherKey").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `deprecatedSearcherKey` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("deprecatedSearcherKey").toString()));
    }
    ...
    if (jsonObj.get("operators") != null && !jsonObj.get("operators").isJsonNull()
        && !jsonObj.get("operators").isJsonArray()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `operators` to be an array in the JSON string but got `%s`",
              jsonObj.get("operators").toString()));
    }
    if ((jsonObj.get("orderable") != null && !jsonObj.get("orderable").isJsonNull())
        && !jsonObj.get("orderable").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `orderable` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("orderable").toString()));
    }
    ...
    if ((jsonObj.get("searchable") != null && !jsonObj.get("searchable").isJsonNull())
        && !jsonObj.get("searchable").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `searchable` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("searchable").toString()));
    }
    ...
    if (jsonObj.get("types") != null && !jsonObj.get("types").isJsonNull() && !jsonObj.get("types").isJsonArray()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `types` to be an array in the JSON string but got `%s`",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<FieldReferenceData> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(FieldReferenceData.class));

...
public class FunctionReferenceData {
  ...
  public enum SupportsListAndSingleValueOperatorsEnum {
    ...
    public static class Adapter extends TypeAdapter<SupportsListAndSingleValueOperatorsEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final SupportsListAndSingleValueOperatorsEnum enumeration)
          throws IOException {
        jsonWriter.value(enumeration.getValue());
      }
  ...
  public FunctionReferenceData supportsListAndSingleValueOperators(
      @javax.annotation.Nullable SupportsListAndSingleValueOperatorsEnum supportsListAndSingleValueOperators) {
  ...
  public void setSupportsListAndSingleValueOperators(
      @javax.annotation.Nullable SupportsListAndSingleValueOperatorsEnum supportsListAndSingleValueOperators) {
    this.supportsListAndSingleValueOperators = supportsListAndSingleValueOperators;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.displayName, functionReferenceData.displayName) &&
        ...
        Objects.equals(this.supportsListAndSingleValueOperators,
            functionReferenceData.supportsListAndSingleValueOperators)
        &&
  ...
  public String toString() {
    ...
    sb.append("    supportsListAndSingleValueOperators: ").append(toIndentedString(supportsListAndSingleValueOperators))
        .append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("displayName", "isList", "supportsListAndSingleValueOperators", "types", "value"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!FunctionReferenceData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in FunctionReferenceData is not found in the empty JSON string",
            FunctionReferenceData.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!FunctionReferenceData.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `FunctionReferenceData` properties. JSON: %s",
    ...
    if ((jsonObj.get("isList") != null && !jsonObj.get("isList").isJsonNull())
        && !jsonObj.get("isList").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `isList` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("isList").toString()));
    }
    // validate the optional field `isList`
    if (jsonObj.get("isList") != null && !jsonObj.get("isList").isJsonNull()) {
      IsListEnum.validateJsonElement(jsonObj.get("isList"));
    }
    if ((jsonObj.get("supportsListAndSingleValueOperators") != null
        && !jsonObj.get("supportsListAndSingleValueOperators").isJsonNull())
        && !jsonObj.get("supportsListAndSingleValueOperators").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `supportsListAndSingleValueOperators` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("supportsListAndSingleValueOperators").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<FunctionReferenceData> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(FunctionReferenceData.class));

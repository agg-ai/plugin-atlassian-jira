...
import io.kestra.plugin.atlassian_jira.client.model.ProjectDataPolicy;
...
public class ProjectWithDataPolicy {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ProjectWithDataPolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in ProjectWithDataPolicy is not found in the empty JSON string",
            ProjectWithDataPolicy.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ProjectWithDataPolicy.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ProjectWithDataPolicy` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ProjectWithDataPolicy> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(ProjectWithDataPolicy.class));

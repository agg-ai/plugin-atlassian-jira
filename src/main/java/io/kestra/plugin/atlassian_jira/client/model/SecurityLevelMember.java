...
public class SecurityLevelMember {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("holder", "id", "issueSecurityLevelId", "issueSecuritySchemeId", "managed"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(
        Arrays.asList("holder", "id", "issueSecurityLevelId", "issueSecuritySchemeId"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!SecurityLevelMember.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in SecurityLevelMember is not found in the empty JSON string",
            SecurityLevelMember.openapiRequiredFields.toString()));
      }
    }
    ...
    if (!jsonObj.get("issueSecurityLevelId").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `issueSecurityLevelId` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("issueSecurityLevelId").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<SecurityLevelMember> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(SecurityLevelMember.class));

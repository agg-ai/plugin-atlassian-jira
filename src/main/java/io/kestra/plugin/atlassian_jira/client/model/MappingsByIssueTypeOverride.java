...
public class MappingsByIssueTypeOverride {
  ...
  public MappingsByIssueTypeOverride statusMappings(
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!MappingsByIssueTypeOverride.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                          // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in MappingsByIssueTypeOverride is not found in the empty JSON string",
            MappingsByIssueTypeOverride.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!MappingsByIssueTypeOverride.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `MappingsByIssueTypeOverride` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<MappingsByIssueTypeOverride> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(MappingsByIssueTypeOverride.class));

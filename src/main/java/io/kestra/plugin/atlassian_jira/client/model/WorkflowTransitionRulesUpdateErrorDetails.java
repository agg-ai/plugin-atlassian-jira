...
public class WorkflowTransitionRulesUpdateErrorDetails {
  ...
  public WorkflowTransitionRulesUpdateErrorDetails ruleUpdateErrors(
      @javax.annotation.Nonnull Map<String, Set<String>> ruleUpdateErrors) {
    this.ruleUpdateErrors = ruleUpdateErrors;
    return this;
  }

  public WorkflowTransitionRulesUpdateErrorDetails putRuleUpdateErrorsItem(String key,
      Set<String> ruleUpdateErrorsItem) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!WorkflowTransitionRulesUpdateErrorDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON
                                                                                        // element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in WorkflowTransitionRulesUpdateErrorDetails is not found in the empty JSON string",
            WorkflowTransitionRulesUpdateErrorDetails.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!WorkflowTransitionRulesUpdateErrorDetails.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `WorkflowTransitionRulesUpdateErrorDetails` properties. JSON: %s",
    ...
    if (jsonObj.get("updateErrors") == null) {
      ...
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `updateErrors` to be an array in the JSON string but got `%s`",
              jsonObj.get("updateErrors").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!WorkflowTransitionRulesUpdateErrorDetails.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'WorkflowTransitionRulesUpdateErrorDetails' and
                     // its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<WorkflowTransitionRulesUpdateErrorDetails> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(WorkflowTransitionRulesUpdateErrorDetails.class));
  ...
  /**
   * Create an instance of WorkflowTransitionRulesUpdateErrorDetails given an JSON
   * string
   *
  ...
  /**
   * Convert an instance of WorkflowTransitionRulesUpdateErrorDetails to an JSON
   * string
   *
   * @return JSON string
   */

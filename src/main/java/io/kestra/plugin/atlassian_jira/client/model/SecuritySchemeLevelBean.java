...
import io.kestra.plugin.atlassian_jira.client.model.SecuritySchemeLevelMemberBean;
...
public class SecuritySchemeLevelBean {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("description", "isDefault", "members", "name"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!SecuritySchemeLevelBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in SecuritySchemeLevelBean is not found in the empty JSON string",
            SecuritySchemeLevelBean.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!SecuritySchemeLevelBean.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `SecuritySchemeLevelBean` properties. JSON: %s",
      ...
      if (jsonArraymembers != null) {
        ...
        if (!jsonObj.get("members").isJsonArray()) {
          throw new IllegalArgumentException(
              String.format(Locale.ROOT, "Expected the field `members` to be an array in the JSON string but got `%s`",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<SecuritySchemeLevelBean> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(SecuritySchemeLevelBean.class));

...
public class ValueOperand {
  ...
  public ValueOperand value(@javax.annotation.Nonnull String value) {
    this.value = value;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ValueOperand.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in ValueOperand is not found in the empty JSON string",
                ValueOperand.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ValueOperand.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ValueOperand` properties. JSON: %s",
    ...
    if ((jsonObj.get("encodedValue") != null && !jsonObj.get("encodedValue").isJsonNull())
        && !jsonObj.get("encodedValue").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `encodedValue` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("encodedValue").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ValueOperand> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(ValueOperand.class));

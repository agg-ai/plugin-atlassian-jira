...
import io.kestra.plugin.atlassian_jira.client.model.WorkflowTransitionRulesUpdateErrorDetails;
...
public class WorkflowTransitionRulesUpdateErrors {
  ...
  public WorkflowTransitionRulesUpdateErrors updateResults(
      @javax.annotation.Nonnull List<WorkflowTransitionRulesUpdateErrorDetails> updateResults) {
    this.updateResults = updateResults;
    return this;
  }

  public WorkflowTransitionRulesUpdateErrors addUpdateResultsItem(
      WorkflowTransitionRulesUpdateErrorDetails updateResultsItem) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("updateResults"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("updateResults"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!WorkflowTransitionRulesUpdateErrors.openapiRequiredFields.isEmpty()) { // has required fields but JSON
                                                                                  // element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in WorkflowTransitionRulesUpdateErrors is not found in the empty JSON string",
            WorkflowTransitionRulesUpdateErrors.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!WorkflowTransitionRulesUpdateErrors.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `WorkflowTransitionRulesUpdateErrors` properties. JSON: %s",
    ...
    if (!jsonObj.get("updateResults").isJsonArray()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `updateResults` to be an array in the JSON string but got `%s`",
          jsonObj.get("updateResults").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!WorkflowTransitionRulesUpdateErrors.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'WorkflowTransitionRulesUpdateErrors' and its
                     // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<WorkflowTransitionRulesUpdateErrors> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(WorkflowTransitionRulesUpdateErrors.class));
  ...
  /**
   * Create an instance of WorkflowTransitionRulesUpdateErrors given an JSON
   * string
   *

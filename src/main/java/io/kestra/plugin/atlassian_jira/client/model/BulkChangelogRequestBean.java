...
public class BulkChangelogRequestBean {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!BulkChangelogRequestBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in BulkChangelogRequestBean is not found in the empty JSON string",
            BulkChangelogRequestBean.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!BulkChangelogRequestBean.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `BulkChangelogRequestBean` properties. JSON: %s",
    ...
    if (jsonObj.get("fieldIds") != null && !jsonObj.get("fieldIds").isJsonNull()
        && !jsonObj.get("fieldIds").isJsonArray()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `fieldIds` to be an array in the JSON string but got `%s`",
              jsonObj.get("fieldIds").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<BulkChangelogRequestBean> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(BulkChangelogRequestBean.class));

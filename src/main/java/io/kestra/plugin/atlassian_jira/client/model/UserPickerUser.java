...
public class UserPickerUser {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("accountId", "accountType", "avatarUrl", "displayName", "html", "key", "name"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!UserPickerUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in UserPickerUser is not found in the empty JSON string",
            UserPickerUser.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!UserPickerUser.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `UserPickerUser` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<UserPickerUser> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(UserPickerUser.class));

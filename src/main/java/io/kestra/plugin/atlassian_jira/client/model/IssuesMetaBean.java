...
import io.kestra.plugin.atlassian_jira.client.model.IssuesJqlMetaDataBean;
...
public class IssuesMetaBean {
  ...
  public IssuesMetaBean jql(@javax.annotation.Nullable IssuesJqlMetaDataBean jql) {
    this.jql = jql;
    return this;
  }
  ...
  public void setJql(@javax.annotation.Nullable IssuesJqlMetaDataBean jql) {
    this.jql = jql;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!IssuesMetaBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssuesMetaBean is not found in the empty JSON string",
            IssuesMetaBean.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!IssuesMetaBean.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `IssuesMetaBean` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssuesMetaBean> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssuesMetaBean.class));

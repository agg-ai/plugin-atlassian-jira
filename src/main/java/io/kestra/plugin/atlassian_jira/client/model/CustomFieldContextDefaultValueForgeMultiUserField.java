...
public class CustomFieldContextDefaultValueForgeMultiUserField {
  ...
  public CustomFieldContextDefaultValueForgeMultiUserField accountIds(
      @javax.annotation.Nonnull List<String> accountIds) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("accountIds", "contextId", "type"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("accountIds", "contextId", "type"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CustomFieldContextDefaultValueForgeMultiUserField.openapiRequiredFields.isEmpty()) { // has required fields
                                                                                                // but JSON element is
                                                                                                // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CustomFieldContextDefaultValueForgeMultiUserField is not found in the empty JSON string",
            CustomFieldContextDefaultValueForgeMultiUserField.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CustomFieldContextDefaultValueForgeMultiUserField.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CustomFieldContextDefaultValueForgeMultiUserField` properties. JSON: %s",
    ...
    if (jsonObj.get("accountIds") == null) {
      ...
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `accountIds` to be an array in the JSON string but got `%s`",
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!CustomFieldContextDefaultValueForgeMultiUserField.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes
                     // 'CustomFieldContextDefaultValueForgeMultiUserField' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<CustomFieldContextDefaultValueForgeMultiUserField> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CustomFieldContextDefaultValueForgeMultiUserField.class));
  ...
  /**
   * Create an instance of CustomFieldContextDefaultValueForgeMultiUserField given
   * an JSON string
   *
  ...
  /**
   * Convert an instance of CustomFieldContextDefaultValueForgeMultiUserField to
   * an JSON string
   *
   * @return JSON string
   */

...
public class IssueFieldOption {
   ...
   * can be searched using JQL, if the extractions (see [Issue Field Option
   * Property
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("config", "id", "properties", "value"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!IssueFieldOption.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssueFieldOption is not found in the empty JSON string",
            IssueFieldOption.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!IssueFieldOption.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `IssueFieldOption` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssueFieldOption> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssueFieldOption.class));

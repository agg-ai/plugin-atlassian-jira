...
import io.kestra.plugin.atlassian_jira.client.model.IssueFilterForBulkPropertySet;
...
public class BulkIssuePropertyUpdateRequest {
   ...
   * as a number, boolean, string, list, or map. The context variables available
   * to the expression are &#x60;issue&#x60; and &#x60;user&#x60;. Issues for
   * which the expression returns a value whose JSON representation is longer than
   * 32768 characters are ignored.
   * 
   * @return expression
   */
  @javax.annotation.Nullable
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!BulkIssuePropertyUpdateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                             // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in BulkIssuePropertyUpdateRequest is not found in the empty JSON string",
            BulkIssuePropertyUpdateRequest.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!BulkIssuePropertyUpdateRequest.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `BulkIssuePropertyUpdateRequest` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<BulkIssuePropertyUpdateRequest> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(BulkIssuePropertyUpdateRequest.class));

...
public class MultipleCustomFieldValuesUpdate {
  ...
  public MultipleCustomFieldValuesUpdate issueIds(@javax.annotation.Nonnull List<Long> issueIds) {
  ...
  public MultipleCustomFieldValuesUpdate value(@javax.annotation.Nullable Object value) {
    this.value = value;
    return this;
  }
   ...
   * as follows: * &#x60;string&#x60; the value must be a string. *
   * &#x60;number&#x60; the value must be a number. * &#x60;datetime&#x60; the
   * value must be a string that represents a date in the ISO format or the
   * simplified extended ISO format. For example,
   * &#x60;\&quot;2023-01-18T12:00:00-03:00\&quot;&#x60; or
   * &#x60;\&quot;2023-01-18T12:00:00.000Z\&quot;&#x60;. However, the milliseconds
   * part is ignored. * &#x60;user&#x60; the value must be an object that contains
   * the &#x60;accountId&#x60; field. * &#x60;group&#x60; the value must be an
   * object that contains the group &#x60;name&#x60; or &#x60;groupId&#x60; field.
   * Because group names can change, we recommend using &#x60;groupId&#x60;. A
   * list of appropriate values must be provided if the field is of the
   * &#x60;list&#x60; [collection
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!MultipleCustomFieldValuesUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                              // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in MultipleCustomFieldValuesUpdate is not found in the empty JSON string",
            MultipleCustomFieldValuesUpdate.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!MultipleCustomFieldValuesUpdate.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `MultipleCustomFieldValuesUpdate` properties. JSON: %s",
    ...
    if (!jsonObj.get("customField").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `customField` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("customField").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<MultipleCustomFieldValuesUpdate> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(MultipleCustomFieldValuesUpdate.class));

...
import io.kestra.plugin.atlassian_jira.client.model.StatusLayoutUpdate;
import io.kestra.plugin.atlassian_jira.client.model.StatusMappingDTO;
import io.kestra.plugin.atlassian_jira.client.model.StatusMigration;
import io.kestra.plugin.atlassian_jira.client.model.TransitionUpdateDTO;
...
public class WorkflowUpdate {
  ...
  public WorkflowUpdate loopedTransitionContainerLayout(
  ...
  @Override
  public int hashCode() {
    return Objects.hash(defaultStatusMappings, description, id, loopedTransitionContainerLayout, startPointLayout,
        statusMappings, statuses, transitions, version, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("defaultStatusMappings", "description", "id",
        "loopedTransitionContainerLayout", "startPointLayout", "statusMappings", "statuses", "transitions", "version"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!WorkflowUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in WorkflowUpdate is not found in the empty JSON string",
            WorkflowUpdate.openapiRequiredFields.toString()));
      }
    }
    ...
    if (jsonObj.get("defaultStatusMappings") != null && !jsonObj.get("defaultStatusMappings").isJsonNull()
        && !jsonObj.get("defaultStatusMappings").isJsonArray()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `defaultStatusMappings` to be an array in the JSON string but got `%s`",
          jsonObj.get("defaultStatusMappings").toString()));
    }
    ...
    if (jsonObj.get("statusMappings") != null && !jsonObj.get("statusMappings").isJsonNull()
        && !jsonObj.get("statusMappings").isJsonArray()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `statusMappings` to be an array in the JSON string but got `%s`",
          jsonObj.get("statusMappings").toString()));
    }
    ...
    if (jsonObj.get("transitions") == null) {
      ...
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `transitions` to be an array in the JSON string but got `%s`",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<WorkflowUpdate> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(WorkflowUpdate.class));

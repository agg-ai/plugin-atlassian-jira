...
import io.kestra.plugin.atlassian_jira.client.model.Application;
import io.kestra.plugin.atlassian_jira.client.model.RemoteObject;
...
public class RemoteIssueLinkRequest {
   ...
   * page ID, like this: &#x60;appId&#x3D;456&amp;pageId&#x3D;123&#x60;. Setting
   * this field enables the remote issue link details to be updated or deleted
   * using remote system and item details as the record identifier, rather than
   * using the record&#39;s Jira ID. The maximum length is 255 characters.
   * 
   * @return globalId
   */
  @javax.annotation.Nullable
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("application", "globalId", "object", "relationship"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!RemoteIssueLinkRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in RemoteIssueLinkRequest is not found in the empty JSON string",
            RemoteIssueLinkRequest.openapiRequiredFields.toString()));
      }
    }
    ...
    if ((jsonObj.get("globalId") != null && !jsonObj.get("globalId").isJsonNull())
        && !jsonObj.get("globalId").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `globalId` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("globalId").toString()));
    }
    if ((jsonObj.get("relationship") != null && !jsonObj.get("relationship").isJsonNull())
        && !jsonObj.get("relationship").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `relationship` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("relationship").toString()));
    }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<RemoteIssueLinkRequest> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(RemoteIssueLinkRequest.class));

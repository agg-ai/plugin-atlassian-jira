...
public class DeprecatedWorkflow {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(_default, description, lastModifiedDate, lastModifiedUser, lastModifiedUserAccountId, name,
        scope, steps);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("default", "description", "lastModifiedDate", "lastModifiedUser",
        "lastModifiedUserAccountId", "name", "scope", "steps"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!DeprecatedWorkflow.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in DeprecatedWorkflow is not found in the empty JSON string",
            DeprecatedWorkflow.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!DeprecatedWorkflow.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `DeprecatedWorkflow` properties. JSON: %s",
    ...
    if ((jsonObj.get("lastModifiedUser") != null && !jsonObj.get("lastModifiedUser").isJsonNull())
        && !jsonObj.get("lastModifiedUser").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `lastModifiedUser` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("lastModifiedUser").toString()));
    }
    if ((jsonObj.get("lastModifiedUserAccountId") != null && !jsonObj.get("lastModifiedUserAccountId").isJsonNull())
        && !jsonObj.get("lastModifiedUserAccountId").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `lastModifiedUserAccountId` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("lastModifiedUserAccountId").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<DeprecatedWorkflow> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(DeprecatedWorkflow.class));

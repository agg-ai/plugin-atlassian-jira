...
import io.kestra.plugin.atlassian_jira.client.model.JqlQuery;
...
public class ParsedJqlQuery {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("errors", "query", "structure", "warnings"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ParsedJqlQuery.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in ParsedJqlQuery is not found in the empty JSON string",
            ParsedJqlQuery.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ParsedJqlQuery.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ParsedJqlQuery` properties. JSON: %s",
    ...
    if (jsonObj.get("warnings") != null && !jsonObj.get("warnings").isJsonNull()
      ...
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `warnings` to be an array in the JSON string but got `%s`",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ParsedJqlQuery> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(ParsedJqlQuery.class));

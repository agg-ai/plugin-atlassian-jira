...
import io.kestra.plugin.atlassian_jira.client.model.WorkflowTransitionRulesDetails;
...
public class WorkflowsWithTransitionRulesDetails {
  ...
  public WorkflowsWithTransitionRulesDetails workflows(
      @javax.annotation.Nonnull List<WorkflowTransitionRulesDetails> workflows) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!WorkflowsWithTransitionRulesDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON
                                                                                  // element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in WorkflowsWithTransitionRulesDetails is not found in the empty JSON string",
            WorkflowsWithTransitionRulesDetails.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!WorkflowsWithTransitionRulesDetails.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `WorkflowsWithTransitionRulesDetails` properties. JSON: %s",
    ...
    for (int i = 0; i < jsonArrayworkflows.size(); i++) {
      WorkflowTransitionRulesDetails.validateJsonElement(jsonArrayworkflows.get(i));
    }
    ;
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!WorkflowsWithTransitionRulesDetails.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'WorkflowsWithTransitionRulesDetails' and its
                     // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<WorkflowsWithTransitionRulesDetails> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(WorkflowsWithTransitionRulesDetails.class));
  ...
  /**
   * Create an instance of WorkflowsWithTransitionRulesDetails given an JSON
   * string
   *

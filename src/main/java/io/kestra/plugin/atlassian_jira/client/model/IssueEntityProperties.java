...
public class IssueEntityProperties {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("entitiesIds", "properties"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!IssueEntityProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssueEntityProperties is not found in the empty JSON string",
            IssueEntityProperties.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!IssueEntityProperties.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `IssueEntityProperties` properties. JSON: %s",
            entry.getKey(), jsonElement.toString()));
      }
    }
    JsonObject jsonObj = jsonElement.getAsJsonObject();
    // ensure the optional json data is an array if present
    if (jsonObj.get("entitiesIds") != null && !jsonObj.get("entitiesIds").isJsonNull()
        && !jsonObj.get("entitiesIds").isJsonArray()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `entitiesIds` to be an array in the JSON string but got `%s`",
              jsonObj.get("entitiesIds").toString()));
    }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssueEntityProperties> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssueEntityProperties.class));

...
/**
 * A workflow transition rule condition. This object returns
 * &#x60;nodeType&#x60; as &#x60;simple&#x60;.
 */
...
public class WorkflowSimpleCondition {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("configuration", "nodeType", "type"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("nodeType", "type"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!WorkflowSimpleCondition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in WorkflowSimpleCondition is not found in the empty JSON string",
            WorkflowSimpleCondition.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!WorkflowSimpleCondition.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `WorkflowSimpleCondition` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<WorkflowSimpleCondition> thisAdapter = gson.getDelegateAdapter(this,

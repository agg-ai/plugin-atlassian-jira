...
public class CreateProjectDetails {
  ...
  public enum ProjectTemplateKeyEnum {
    ...
    COM_ATLASSIAN_SERVICEDESK_SIMPLIFIED_BLANK_PROJECT_BUSINESS(
    ...
    COM_ATLASSIAN_SERVICEDESK_NEXT_GEN_GENERAL_IT_SERVICE_DESK(
        "com.atlassian.servicedesk:next-gen-general-it-service-desk"),

    COM_ATLASSIAN_SERVICEDESK_NEXT_GEN_GENERAL_BUSINESS_SERVICE_DESK(
   ...
   * schemes](#api-rest-api-3-issuetypescheme-get) operation to get a list of
   * issue type scheme IDs. If you specify the issue type scheme you cannot
  ...
  /**
   * The ID of the issue type screen scheme for the project. Use the [Get all
   * issue type screen schemes](#api-rest-api-3-issuetypescreenscheme-get)
   * operation to get a list of issue type screen scheme IDs. If you specify the
   * issue type screen scheme you cannot specify the project template key.
   * 
  ...
  /**
   * The account ID of the project lead. Either &#x60;lead&#x60; or
   * &#x60;leadAccountId&#x60; must be set when creating a project. Cannot be
   * provided with &#x60;lead&#x60;.
   * 
   ...
   * workflow scheme IDs. If you specify the workflow scheme you cannot specify
   * the project template key.
   * 
  ...
  @Override
  public int hashCode() {
    return Objects.hash(assigneeType, avatarId, categoryId, description, fieldConfigurationScheme, issueSecurityScheme,
        issueTypeScheme, issueTypeScreenScheme, key, lead, leadAccountId, name, notificationScheme, permissionScheme,
        projectTemplateKey, projectTypeKey, url, workflowScheme);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("assigneeType", "avatarId", "categoryId", "description", "fieldConfigurationScheme",
            "issueSecurityScheme", "issueTypeScheme", "issueTypeScreenScheme", "key", "lead", "leadAccountId", "name",
            "notificationScheme", "permissionScheme", "projectTemplateKey", "projectTypeKey", "url", "workflowScheme"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CreateProjectDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CreateProjectDetails is not found in the empty JSON string",
            CreateProjectDetails.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CreateProjectDetails.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CreateProjectDetails` properties. JSON: %s",
    ...
    if ((jsonObj.get("assigneeType") != null && !jsonObj.get("assigneeType").isJsonNull())
        && !jsonObj.get("assigneeType").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `assigneeType` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("assigneeType").toString()));
    }
    ...
    if ((jsonObj.get("lead") != null && !jsonObj.get("lead").isJsonNull()) && !jsonObj.get("lead").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `lead` to be a primitive type in the JSON string but got `%s`",
              jsonObj.get("lead").toString()));
    }
    if ((jsonObj.get("leadAccountId") != null && !jsonObj.get("leadAccountId").isJsonNull())
        && !jsonObj.get("leadAccountId").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `leadAccountId` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("leadAccountId").toString()));
    }
    ...
    if ((jsonObj.get("projectTemplateKey") != null && !jsonObj.get("projectTemplateKey").isJsonNull())
        && !jsonObj.get("projectTemplateKey").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `projectTemplateKey` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("projectTemplateKey").toString()));
    }
    ...
    if ((jsonObj.get("url") != null && !jsonObj.get("url").isJsonNull()) && !jsonObj.get("url").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `url` to be a primitive type in the JSON string but got `%s`",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<CreateProjectDetails> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CreateProjectDetails.class));

...
import io.kestra.plugin.atlassian_jira.client.model.EventNotification;
import io.kestra.plugin.atlassian_jira.client.model.NotificationEvent;
...
public class NotificationSchemeEvent {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!NotificationSchemeEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in NotificationSchemeEvent is not found in the empty JSON string",
            NotificationSchemeEvent.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!NotificationSchemeEvent.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `NotificationSchemeEvent` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<NotificationSchemeEvent> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(NotificationSchemeEvent.class));

...
public class UpdatePriorityDetails {
    ...
    if (jsonElement == null) {
      if (!UpdatePriorityDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in UpdatePriorityDetails is not found in the empty JSON string",
            UpdatePriorityDetails.openapiRequiredFields.toString()));
      }
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<UpdatePriorityDetails> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(UpdatePriorityDetails.class));

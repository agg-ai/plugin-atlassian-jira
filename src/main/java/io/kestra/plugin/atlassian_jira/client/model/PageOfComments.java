...
public class PageOfComments {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("comments", "maxResults", "startAt", "total"));
    ...
    if (jsonElement == null) {
      if (!PageOfComments.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in PageOfComments is not found in the empty JSON string",
            PageOfComments.openapiRequiredFields.toString()));
      }
    }
    JsonObject jsonObj = jsonElement.getAsJsonObject();
    // ensure the optional json data is an array if present
    if (jsonObj.get("comments") != null && !jsonObj.get("comments").isJsonNull()
        && !jsonObj.get("comments").isJsonArray()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `comments` to be an array in the JSON string but got `%s`",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<PageOfComments> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(PageOfComments.class));

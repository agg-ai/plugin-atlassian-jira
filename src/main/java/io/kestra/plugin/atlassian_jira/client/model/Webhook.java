...
public class Webhook {
   ...
   * webhook &#x60;jira:issue_updated&#x60; is sent. If this parameter is not
   ...
   * the &#x60;issue_property_set&#x60; or &#x60;issue_property_deleted&#x60;
   * webhooks. If this parameter is not present, the app is notified about all
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("events", "expirationDate", "fieldIdsFilter", "id",
        "issuePropertyKeysFilter", "jqlFilter", "url"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("events", "id", "jqlFilter", "url"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!Webhook.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in Webhook is not found in the empty JSON string",
                Webhook.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!Webhook.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `Webhook` properties. JSON: %s", entry.getKey(),
    ...
    if (jsonObj.get("events") == null) {
      ...
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `events` to be an array in the JSON string but got `%s`",
              jsonObj.get("events").toString()));
    }
    // ensure the optional json data is an array if present
    if (jsonObj.get("fieldIdsFilter") != null && !jsonObj.get("fieldIdsFilter").isJsonNull()
        && !jsonObj.get("fieldIdsFilter").isJsonArray()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `fieldIdsFilter` to be an array in the JSON string but got `%s`",
          jsonObj.get("fieldIdsFilter").toString()));
    }
    // ensure the optional json data is an array if present
    if (jsonObj.get("issuePropertyKeysFilter") != null && !jsonObj.get("issuePropertyKeysFilter").isJsonNull()
        && !jsonObj.get("issuePropertyKeysFilter").isJsonArray()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `issuePropertyKeysFilter` to be an array in the JSON string but got `%s`",
          jsonObj.get("issuePropertyKeysFilter").toString()));
    }
    if (!jsonObj.get("jqlFilter").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `jqlFilter` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("jqlFilter").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<Webhook> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(Webhook.class));

...
import io.kestra.plugin.atlassian_jira.client.model.ScreenTypes;
...
public class ScreenScheme {
  ...
  public ScreenScheme issueTypeScreenSchemes(
      @javax.annotation.Nullable PageBeanIssueTypeScreenScheme issueTypeScreenSchemes) {
  ...
  public void setIssueTypeScreenSchemes(
      @javax.annotation.Nullable PageBeanIssueTypeScreenScheme issueTypeScreenSchemes) {
    this.issueTypeScreenSchemes = issueTypeScreenSchemes;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("description", "id", "issueTypeScreenSchemes", "name", "screens"));
    ...
    if (jsonElement == null) {
      if (!ScreenScheme.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in ScreenScheme is not found in the empty JSON string",
                ScreenScheme.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ScreenScheme.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ScreenScheme` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ScreenScheme> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(ScreenScheme.class));

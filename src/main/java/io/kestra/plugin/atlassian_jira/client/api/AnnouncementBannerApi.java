...
import io.kestra.plugin.atlassian_jira.client.model.AnnouncementBannerConfiguration;
import io.kestra.plugin.atlassian_jira.client.model.AnnouncementBannerConfigurationUpdate;
...
public class AnnouncementBannerApi {
    ...
    public ApiResponse<AnnouncementBannerConfiguration> getBannerWithHttpInfo() throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<AnnouncementBannerConfiguration>() {
        }.getType();
     ...
     *                        </table>
     */
    public okhttp3.Call getBannerAsync(final ApiCallback<AnnouncementBannerConfiguration> _callback)
            throws ApiException {
     ...
     *                        <tr>
     *                        <td>400</td>
     *                        <td>Returned if an invalid parameter is passed.</td>
     *                        <td>-</td>
     *                        </tr>
     *                        <tr>
     *                        <td>401</td>
     ...
     *                        </table>
     */
    public okhttp3.Call setBannerCall(
            @javax.annotation.Nonnull AnnouncementBannerConfigurationUpdate announcementBannerConfigurationUpdate,
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call setBannerValidateBeforeCall(
            @javax.annotation.Nonnull AnnouncementBannerConfigurationUpdate announcementBannerConfigurationUpdate,
            final ApiCallback _callback) throws ApiException {
        ...
        if (announcementBannerConfigurationUpdate == null) {
            throw new ApiException(
                    "Missing the required parameter 'announcementBannerConfigurationUpdate' when calling setBanner(Async)");
        }
     ...
     * Updates the announcement banner configuration. **[Permissions](#permissions)
     ...
     *                        </table>
     */
    public ApiResponse<Object> setBannerWithHttpInfo(
            @javax.annotation.Nonnull AnnouncementBannerConfigurationUpdate announcementBannerConfigurationUpdate)
            throws ApiException {
     ...
     *                        </table>
     */
    public okhttp3.Call setBannerAsync(
            @javax.annotation.Nonnull AnnouncementBannerConfigurationUpdate announcementBannerConfigurationUpdate,

...
public class WorkflowStatusUpdate {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("description", "id", "name", "statusCategory", "statusReference"));
    ...
    if (jsonElement == null) {
      if (!WorkflowStatusUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in WorkflowStatusUpdate is not found in the empty JSON string",
            WorkflowStatusUpdate.openapiRequiredFields.toString()));
      }
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<WorkflowStatusUpdate> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(WorkflowStatusUpdate.class));

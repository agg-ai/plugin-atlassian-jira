...
import io.kestra.plugin.atlassian_jira.client.model.JiraComponentField;
...
public class JiraMultiSelectComponentField {
  ...
  public JiraMultiSelectComponentField bulkEditMultiSelectFieldOption(
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bulkEditMultiSelectFieldOption,
        jiraMultiSelectComponentField.bulkEditMultiSelectFieldOption) &&
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("bulkEditMultiSelectFieldOption", "components", "fieldId"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(
        Arrays.asList("bulkEditMultiSelectFieldOption", "components", "fieldId"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!JiraMultiSelectComponentField.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                            // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in JiraMultiSelectComponentField is not found in the empty JSON string",
            JiraMultiSelectComponentField.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!JiraMultiSelectComponentField.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `JiraMultiSelectComponentField` properties. JSON: %s",
    ...
    if (!jsonObj.get("components").isJsonArray()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `components` to be an array in the JSON string but got `%s`",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<JiraMultiSelectComponentField> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(JiraMultiSelectComponentField.class));

...
import io.kestra.plugin.atlassian_jira.client.model.AssociationContextObject;
...
public class FieldAssociationsRequest {
  ...
  public FieldAssociationsRequest associationContexts(
      @javax.annotation.Nonnull List<AssociationContextObject> associationContexts) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!FieldAssociationsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in FieldAssociationsRequest is not found in the empty JSON string",
            FieldAssociationsRequest.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!FieldAssociationsRequest.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `FieldAssociationsRequest` properties. JSON: %s",
    ...
    if (!jsonObj.get("associationContexts").isJsonArray()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `associationContexts` to be an array in the JSON string but got `%s`",
          jsonObj.get("associationContexts").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<FieldAssociationsRequest> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(FieldAssociationsRequest.class));

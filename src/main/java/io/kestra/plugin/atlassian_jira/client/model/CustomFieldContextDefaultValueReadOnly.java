...
public class CustomFieldContextDefaultValueReadOnly {
  ...
  public CustomFieldContextDefaultValueReadOnly type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CustomFieldContextDefaultValueReadOnly.openapiRequiredFields.isEmpty()) { // has required fields but JSON
                                                                                     // element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CustomFieldContextDefaultValueReadOnly is not found in the empty JSON string",
            CustomFieldContextDefaultValueReadOnly.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CustomFieldContextDefaultValueReadOnly.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CustomFieldContextDefaultValueReadOnly` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!CustomFieldContextDefaultValueReadOnly.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'CustomFieldContextDefaultValueReadOnly' and its
                     // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<CustomFieldContextDefaultValueReadOnly> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CustomFieldContextDefaultValueReadOnly.class));
  ...
  /**
   * Create an instance of CustomFieldContextDefaultValueReadOnly given an JSON
   * string
   *
  ...
  /**
   * Convert an instance of CustomFieldContextDefaultValueReadOnly to an JSON
   * string
   *
   * @return JSON string
   */

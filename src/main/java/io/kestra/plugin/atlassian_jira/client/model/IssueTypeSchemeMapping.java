...
public class IssueTypeSchemeMapping {
  ...
  public IssueTypeSchemeMapping issueTypeId(@javax.annotation.Nonnull String issueTypeId) {
  ...
  public IssueTypeSchemeMapping issueTypeSchemeId(@javax.annotation.Nonnull String issueTypeSchemeId) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("issueTypeId", "issueTypeSchemeId"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("issueTypeId", "issueTypeSchemeId"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!IssueTypeSchemeMapping.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssueTypeSchemeMapping is not found in the empty JSON string",
            IssueTypeSchemeMapping.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!IssueTypeSchemeMapping.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `IssueTypeSchemeMapping` properties. JSON: %s",
    ...
    if (!jsonObj.get("issueTypeSchemeId").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `issueTypeSchemeId` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("issueTypeSchemeId").toString()));
    }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssueTypeSchemeMapping> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssueTypeSchemeMapping.class));

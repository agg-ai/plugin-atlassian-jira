...
public class CustomFieldContextDefaultValueForgeDateTimeField {
  ...
  public CustomFieldContextDefaultValueForgeDateTimeField contextId(@javax.annotation.Nonnull String contextId) {
  ...
  public CustomFieldContextDefaultValueForgeDateTimeField dateTime(@javax.annotation.Nullable String dateTime) {
  ...
  public CustomFieldContextDefaultValueForgeDateTimeField type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public CustomFieldContextDefaultValueForgeDateTimeField useCurrent(@javax.annotation.Nullable Boolean useCurrent) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("contextId", "dateTime", "type", "useCurrent"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CustomFieldContextDefaultValueForgeDateTimeField.openapiRequiredFields.isEmpty()) { // has required fields
                                                                                               // but JSON element is
                                                                                               // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CustomFieldContextDefaultValueForgeDateTimeField is not found in the empty JSON string",
            CustomFieldContextDefaultValueForgeDateTimeField.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CustomFieldContextDefaultValueForgeDateTimeField.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CustomFieldContextDefaultValueForgeDateTimeField` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!CustomFieldContextDefaultValueForgeDateTimeField.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'CustomFieldContextDefaultValueForgeDateTimeField'
                     // and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<CustomFieldContextDefaultValueForgeDateTimeField> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CustomFieldContextDefaultValueForgeDateTimeField.class));
  ...
  /**
   * Create an instance of CustomFieldContextDefaultValueForgeDateTimeField given
   * an JSON string
   *
  ...
  /**
   * Convert an instance of CustomFieldContextDefaultValueForgeDateTimeField to an
   * JSON string
   *
   * @return JSON string
   */

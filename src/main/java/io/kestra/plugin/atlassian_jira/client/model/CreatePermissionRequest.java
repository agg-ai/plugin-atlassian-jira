...
import io.kestra.plugin.atlassian_jira.client.model.CreatePermissionHolderRequest;
...
public class CreatePermissionRequest {
  ...
  public CreatePermissionRequest holder(@javax.annotation.Nonnull CreatePermissionHolderRequest holder) {
    this.holder = holder;
    return this;
  }
  ...
  public void setHolder(@javax.annotation.Nonnull CreatePermissionHolderRequest holder) {
    this.holder = holder;
  }

  public CreatePermissionRequest type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("holder", "type"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("holder", "type"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CreatePermissionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CreatePermissionRequest is not found in the empty JSON string",
            CreatePermissionRequest.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CreatePermissionRequest.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CreatePermissionRequest` properties. JSON: %s",
    ...
    CreatePermissionHolderRequest.validateJsonElement(jsonObj.get("holder"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<CreatePermissionRequest> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CreatePermissionRequest.class));

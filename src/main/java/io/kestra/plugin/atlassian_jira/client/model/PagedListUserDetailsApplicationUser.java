 ...
 * &#x60;?expand&#x3D;sharedUsers[10:40]&#x60; returns a list starting at item
 * 10 and finishing at item 40.
 */
...
public class PagedListUserDetailsApplicationUser {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PagedListUserDetailsApplicationUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON
                                                                                  // element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in PagedListUserDetailsApplicationUser is not found in the empty JSON string",
            PagedListUserDetailsApplicationUser.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PagedListUserDetailsApplicationUser.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `PagedListUserDetailsApplicationUser` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!PagedListUserDetailsApplicationUser.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'PagedListUserDetailsApplicationUser' and its
                     // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<PagedListUserDetailsApplicationUser> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(PagedListUserDetailsApplicationUser.class));
  ...
  /**
   * Create an instance of PagedListUserDetailsApplicationUser given an JSON
   * string
   *

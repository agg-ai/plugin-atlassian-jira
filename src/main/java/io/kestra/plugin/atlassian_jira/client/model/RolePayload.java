...
/**
 * The payload used to create a project role. It is optional for CMP projects,
 * as a default role actor will be provided. TMP will add new role actors to the
 * table.
 */
...
public class RolePayload {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("defaultActors", "description", "name", "onConflict", "pcri", "type"));
    ...
    if (jsonElement == null) {
      if (!RolePayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in RolePayload is not found in the empty JSON string",
                RolePayload.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!RolePayload.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `RolePayload` properties. JSON: %s",
    ...
    if (jsonObj.get("defaultActors") != null && !jsonObj.get("defaultActors").isJsonNull()) {
      ...
      if (jsonArraydefaultActors != null) {
        ...
        if (!jsonObj.get("defaultActors").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `defaultActors` to be an array in the JSON string but got `%s`",
              jsonObj.get("defaultActors").toString()));
        }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<RolePayload> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(RolePayload.class));

...
import io.kestra.plugin.atlassian_jira.client.model.RegisteredWebhook;
...
public class ContainerForRegisteredWebhooks {
  ...
  public ContainerForRegisteredWebhooks webhookRegistrationResult(
      @javax.annotation.Nullable List<RegisteredWebhook> webhookRegistrationResult) {
    this.webhookRegistrationResult = webhookRegistrationResult;
    return this;
  }

  public ContainerForRegisteredWebhooks addWebhookRegistrationResultItem(
      RegisteredWebhook webhookRegistrationResultItem) {
  ...
  public void setWebhookRegistrationResult(
      @javax.annotation.Nullable List<RegisteredWebhook> webhookRegistrationResult) {
    this.webhookRegistrationResult = webhookRegistrationResult;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("webhookRegistrationResult"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ContainerForRegisteredWebhooks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                             // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in ContainerForRegisteredWebhooks is not found in the empty JSON string",
            ContainerForRegisteredWebhooks.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ContainerForRegisteredWebhooks.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ContainerForRegisteredWebhooks` properties. JSON: %s",
    ...
    if (jsonObj.get("webhookRegistrationResult") != null && !jsonObj.get("webhookRegistrationResult").isJsonNull()) {
      ...
      if (jsonArraywebhookRegistrationResult != null) {
        ...
        if (!jsonObj.get("webhookRegistrationResult").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `webhookRegistrationResult` to be an array in the JSON string but got `%s`",
              jsonObj.get("webhookRegistrationResult").toString()));
        }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ContainerForRegisteredWebhooks> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(ContainerForRegisteredWebhooks.class));

...
public class GetExclusionRulesResponse {
  ...
  public GetExclusionRulesResponse numberOfDaysToShowCompletedIssues(
      @javax.annotation.Nonnull Integer numberOfDaysToShowCompletedIssues) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.issueIds, getExclusionRulesResponse.issueIds) &&
        ...
        Objects.equals(this.numberOfDaysToShowCompletedIssues,
            getExclusionRulesResponse.numberOfDaysToShowCompletedIssues)
        &&
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("numberOfDaysToShowCompletedIssues"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!GetExclusionRulesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in GetExclusionRulesResponse is not found in the empty JSON string",
            GetExclusionRulesResponse.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!GetExclusionRulesResponse.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `GetExclusionRulesResponse` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<GetExclusionRulesResponse> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(GetExclusionRulesResponse.class));

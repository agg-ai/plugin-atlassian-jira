...
import io.kestra.plugin.atlassian_jira.client.model.CompoundClause;
import io.kestra.plugin.atlassian_jira.client.model.FieldChangedClause;
import io.kestra.plugin.atlassian_jira.client.model.FieldValueClause;
import io.kestra.plugin.atlassian_jira.client.model.FieldWasClause;
import io.kestra.plugin.atlassian_jira.client.model.JqlQueryClauseOperand;
import io.kestra.plugin.atlassian_jira.client.model.JqlQueryClauseTimePredicate;
import io.kestra.plugin.atlassian_jira.client.model.JqlQueryField;
...
public class JqlQueryClause extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<CompoundClause> adapterCompoundClause = gson.getDelegateAdapter(this,
                    TypeToken.get(CompoundClause.class));
            final TypeAdapter<FieldValueClause> adapterFieldValueClause = gson.getDelegateAdapter(this,
                    TypeToken.get(FieldValueClause.class));
            final TypeAdapter<FieldWasClause> adapterFieldWasClause = gson.getDelegateAdapter(this,
                    TypeToken.get(FieldWasClause.class));
            final TypeAdapter<FieldChangedClause> adapterFieldChangedClause = gson.getDelegateAdapter(this,
                    TypeToken.get(FieldChangedClause.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<JqlQueryClause>() {
                ...
                public void write(JsonWriter out, JqlQueryClause value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof CompoundClause) {
                        JsonElement element = adapterCompoundClause
                                .toJsonTree((CompoundClause) value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    // check if the actual instance is of the type `FieldValueClause`
                    if (value.getActualInstance() instanceof FieldValueClause) {
                        JsonElement element = adapterFieldValueClause
                                .toJsonTree((FieldValueClause) value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    // check if the actual instance is of the type `FieldWasClause`
                    if (value.getActualInstance() instanceof FieldWasClause) {
                        JsonElement element = adapterFieldWasClause
                                .toJsonTree((FieldWasClause) value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    // check if the actual instance is of the type `FieldChangedClause`
                    if (value.getActualInstance() instanceof FieldChangedClause) {
                        JsonElement element = adapterFieldChangedClause
                                .toJsonTree((FieldChangedClause) value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    throw new IOException(
                            "Failed to serialize as the type doesn't match anyOf schemas: CompoundClause, FieldChangedClause, FieldValueClause, FieldWasClause");
                }
                ...
                public JqlQueryClause read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        errorMessages.add(String.format(Locale.ROOT,
                                "Deserialization for CompoundClause failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(Locale.ROOT,
                                "Deserialization for FieldValueClause failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(Locale.ROOT,
                                "Deserialization for FieldWasClause failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(Locale.ROOT,
                                "Deserialization for FieldChangedClause failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'FieldChangedClause'", e);
                    }

                    throw new IOException(String.format(Locale.ROOT,
                            "Failed deserialization for JqlQueryClause: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s",
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException(
                "Invalid instance type. Must be CompoundClause, FieldChangedClause, FieldValueClause, FieldWasClause");
    }
     ...
     * CompoundClause, FieldChangedClause, FieldValueClause, FieldWasClause
     *
     * @return The actual instance (CompoundClause, FieldChangedClause,
     *         FieldValueClause, FieldWasClause)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * Get the actual instance of `CompoundClause`. If the actual instance is not
     * `CompoundClause`,
    ...
    /**
     * Get the actual instance of `FieldValueClause`. If the actual instance is not
     * `FieldValueClause`,
     * the ClassCastException will be thrown.
     *
    ...
    /**
     * Get the actual instance of `FieldWasClause`. If the actual instance is not
     * `FieldWasClause`,
     * the ClassCastException will be thrown.
     *
    ...
    /**
     * Get the actual instance of `FieldChangedClause`. If the actual instance is
     * not `FieldChangedClause`,
     * the ClassCastException will be thrown.
     *
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        try {
            ...
            errorMessages.add(
                    String.format(Locale.ROOT, "Deserialization for CompoundClause failed with `%s`.", e.getMessage()));
        ...
        try {
            ...
            errorMessages.add(String.format(Locale.ROOT, "Deserialization for FieldValueClause failed with `%s`.",
                    e.getMessage()));
            // continue to the next one
        }
        ...
        try {
            ...
            errorMessages.add(
                    String.format(Locale.ROOT, "Deserialization for FieldWasClause failed with `%s`.", e.getMessage()));
            // continue to the next one
        }
        ...
        try {
            ...
            errorMessages.add(String.format(Locale.ROOT, "Deserialization for FieldChangedClause failed with `%s`.",
                    e.getMessage()));
            // continue to the next one
        }
        throw new IOException(String.format(Locale.ROOT,
                "The JSON string is invalid for JqlQueryClause with anyOf schemas: CompoundClause, FieldChangedClause, FieldValueClause, FieldWasClause. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s",
                errorMessages, jsonElement.toString()));
    }

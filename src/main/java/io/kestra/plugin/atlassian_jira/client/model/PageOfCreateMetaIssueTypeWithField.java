...
public class PageOfCreateMetaIssueTypeWithField {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("fields", "maxResults", "results", "startAt", "total"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PageOfCreateMetaIssueTypeWithField.openapiRequiredFields.isEmpty()) { // has required fields but JSON element
                                                                                 // is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in PageOfCreateMetaIssueTypeWithField is not found in the empty JSON string",
            PageOfCreateMetaIssueTypeWithField.openapiRequiredFields.toString()));
      }
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!PageOfCreateMetaIssueTypeWithField.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'PageOfCreateMetaIssueTypeWithField' and its
                     // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<PageOfCreateMetaIssueTypeWithField> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(PageOfCreateMetaIssueTypeWithField.class));

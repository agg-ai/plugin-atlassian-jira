...
public class CreatePriorityDetails {
  ...
  /**
   * The ID for the avatar for the priority. Either the iconUrl or avatarId must
   * be defined, but not both. This parameter is nullable and will become
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("avatarId", "description", "iconUrl", "name", "statusColor"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "statusColor"));
  }
    ...
    if (jsonElement == null) {
      if (!CreatePriorityDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CreatePriorityDetails is not found in the empty JSON string",
            CreatePriorityDetails.openapiRequiredFields.toString()));
      }
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<CreatePriorityDetails> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CreatePriorityDetails.class));

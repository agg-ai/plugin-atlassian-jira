...
public class ChangeDetails {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("field", "fieldId", "fieldtype", "from", "fromString", "to", "toString"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ChangeDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in ChangeDetails is not found in the empty JSON string",
            ChangeDetails.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ChangeDetails.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ChangeDetails` properties. JSON: %s",
    ...
    if ((jsonObj.get("fieldtype") != null && !jsonObj.get("fieldtype").isJsonNull())
        && !jsonObj.get("fieldtype").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
    ...
    if ((jsonObj.get("from") != null && !jsonObj.get("from").isJsonNull()) && !jsonObj.get("from").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `from` to be a primitive type in the JSON string but got `%s`",
              jsonObj.get("from").toString()));
    }
    if ((jsonObj.get("fromString") != null && !jsonObj.get("fromString").isJsonNull())
        && !jsonObj.get("fromString").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `fromString` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("fromString").toString()));
    }
    ...
    if ((jsonObj.get("toString") != null && !jsonObj.get("toString").isJsonNull())
        && !jsonObj.get("toString").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `toString` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("toString").toString()));
    }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ChangeDetails> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(ChangeDetails.class));

...
public class ApplicationRole {
   ...
   * group&#39;s name can change, use of &#x60;defaultGroupsDetails&#x60; is
  ...
  @Override
  public int hashCode() {
    return Objects.hash(defaultGroups, defaultGroupsDetails, defined, groupDetails, groups, hasUnlimitedSeats, key,
        name, numberOfSeats, platform, remainingSeats, selectedByDefault, userCount, userCountDescription);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("defaultGroups", "defaultGroupsDetails", "defined",
        "groupDetails", "groups", "hasUnlimitedSeats", "key", "name", "numberOfSeats", "platform", "remainingSeats",
        "selectedByDefault", "userCount", "userCountDescription"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ApplicationRole.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in ApplicationRole is not found in the empty JSON string",
            ApplicationRole.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ApplicationRole.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ApplicationRole` properties. JSON: %s",
    ...
    if (jsonObj.get("defaultGroups") != null && !jsonObj.get("defaultGroups").isJsonNull()
        && !jsonObj.get("defaultGroups").isJsonArray()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `defaultGroups` to be an array in the JSON string but got `%s`",
          jsonObj.get("defaultGroups").toString()));
    }
    if (jsonObj.get("defaultGroupsDetails") != null && !jsonObj.get("defaultGroupsDetails").isJsonNull()) {
      ...
      if (jsonArraydefaultGroupsDetails != null) {
        ...
        if (!jsonObj.get("defaultGroupsDetails").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `defaultGroupsDetails` to be an array in the JSON string but got `%s`",
              jsonObj.get("defaultGroupsDetails").toString()));
        }
    ...
    if (jsonObj.get("groupDetails") != null && !jsonObj.get("groupDetails").isJsonNull()) {
      ...
      if (jsonArraygroupDetails != null) {
        ...
        if (!jsonObj.get("groupDetails").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `groupDetails` to be an array in the JSON string but got `%s`",
              jsonObj.get("groupDetails").toString()));
        }
    ...
    if ((jsonObj.get("userCountDescription") != null && !jsonObj.get("userCountDescription").isJsonNull())
        && !jsonObj.get("userCountDescription").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `userCountDescription` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("userCountDescription").toString()));
    }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ApplicationRole> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(ApplicationRole.class));

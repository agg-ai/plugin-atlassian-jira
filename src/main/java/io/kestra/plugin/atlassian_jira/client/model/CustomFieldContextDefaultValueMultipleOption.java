...
public class CustomFieldContextDefaultValueMultipleOption {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("contextId", "optionIds", "type"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("contextId", "optionIds", "type"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CustomFieldContextDefaultValueMultipleOption.openapiRequiredFields.isEmpty()) { // has required fields but
                                                                                           // JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CustomFieldContextDefaultValueMultipleOption is not found in the empty JSON string",
            CustomFieldContextDefaultValueMultipleOption.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CustomFieldContextDefaultValueMultipleOption.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CustomFieldContextDefaultValueMultipleOption` properties. JSON: %s",
    ...
    if (jsonObj.get("optionIds") == null) {
      ...
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `optionIds` to be an array in the JSON string but got `%s`",
              jsonObj.get("optionIds").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!CustomFieldContextDefaultValueMultipleOption.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'CustomFieldContextDefaultValueMultipleOption' and
                     // its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<CustomFieldContextDefaultValueMultipleOption> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CustomFieldContextDefaultValueMultipleOption.class));
  ...
  /**
   * Create an instance of CustomFieldContextDefaultValueMultipleOption given an
   * JSON string
   *
  ...
  /**
   * Convert an instance of CustomFieldContextDefaultValueMultipleOption to an
   * JSON string
   *
   * @return JSON string
   */

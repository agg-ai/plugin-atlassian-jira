...
import io.kestra.plugin.atlassian_jira.client.model.AssociatedItemBean;
import io.kestra.plugin.atlassian_jira.client.model.ChangedValueBean;
...
public class AuditRecordBean {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(associatedItems, authorKey, category, changedValues, created, description, eventSource, id,
        objectItem, remoteAddress, summary);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("associatedItems", "authorKey", "category", "changedValues",
        "created", "description", "eventSource", "id", "objectItem", "remoteAddress", "summary"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!AuditRecordBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in AuditRecordBean is not found in the empty JSON string",
            AuditRecordBean.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!AuditRecordBean.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `AuditRecordBean` properties. JSON: %s",
    ...
    if ((jsonObj.get("authorKey") != null && !jsonObj.get("authorKey").isJsonNull())
        && !jsonObj.get("authorKey").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `authorKey` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("authorKey").toString()));
    }
    ...
    if (jsonObj.get("changedValues") != null && !jsonObj.get("changedValues").isJsonNull()) {
      ...
      if (jsonArraychangedValues != null) {
        ...
        if (!jsonObj.get("changedValues").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `changedValues` to be an array in the JSON string but got `%s`",
              jsonObj.get("changedValues").toString()));
        }
    ...
    if ((jsonObj.get("eventSource") != null && !jsonObj.get("eventSource").isJsonNull())
        && !jsonObj.get("eventSource").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `eventSource` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("eventSource").toString()));
    }
    ...
    if ((jsonObj.get("remoteAddress") != null && !jsonObj.get("remoteAddress").isJsonNull())
        && !jsonObj.get("remoteAddress").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `remoteAddress` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("remoteAddress").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<AuditRecordBean> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(AuditRecordBean.class));

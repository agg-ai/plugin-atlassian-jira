...
public class FieldCreateMetadata {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowedValues, autoCompleteUrl, _configuration, defaultValue, fieldId, hasDefaultValue, key,
        name, operations, required, schema);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("allowedValues", "autoCompleteUrl", "configuration",
        "defaultValue", "fieldId", "hasDefaultValue", "key", "name", "operations", "required", "schema"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(
        Arrays.asList("fieldId", "key", "name", "operations", "required", "schema"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!FieldCreateMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in FieldCreateMetadata is not found in the empty JSON string",
            FieldCreateMetadata.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!FieldCreateMetadata.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `FieldCreateMetadata` properties. JSON: %s",
    ...
    if ((jsonObj.get("autoCompleteUrl") != null && !jsonObj.get("autoCompleteUrl").isJsonNull())
        && !jsonObj.get("autoCompleteUrl").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `autoCompleteUrl` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("autoCompleteUrl").toString()));
    }
    ...
    if (jsonObj.get("operations") == null) {
      ...
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `operations` to be an array in the JSON string but got `%s`",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<FieldCreateMetadata> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(FieldCreateMetadata.class));

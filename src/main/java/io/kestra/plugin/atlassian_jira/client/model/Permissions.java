...
import io.kestra.plugin.atlassian_jira.client.model.UserPermission;
...
public class Permissions {
    ...
    if (jsonElement == null) {
      if (!Permissions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in Permissions is not found in the empty JSON string",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<Permissions> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(Permissions.class));

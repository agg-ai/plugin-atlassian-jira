...
public class IssueTypeScreenSchemeItem {
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(
        Arrays.asList("issueTypeId", "issueTypeScreenSchemeId", "screenSchemeId"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!IssueTypeScreenSchemeItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssueTypeScreenSchemeItem is not found in the empty JSON string",
            IssueTypeScreenSchemeItem.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!IssueTypeScreenSchemeItem.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `IssueTypeScreenSchemeItem` properties. JSON: %s",
    ...
    if (!jsonObj.get("issueTypeScreenSchemeId").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `issueTypeScreenSchemeId` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("issueTypeScreenSchemeId").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssueTypeScreenSchemeItem> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssueTypeScreenSchemeItem.class));

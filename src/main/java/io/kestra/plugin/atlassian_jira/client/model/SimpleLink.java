...
public class SimpleLink {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("href", "iconClass", "id", "label", "styleClass", "title", "weight"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!SimpleLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in SimpleLink is not found in the empty JSON string",
                SimpleLink.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!SimpleLink.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `SimpleLink` properties. JSON: %s", entry.getKey(),
    ...
    if ((jsonObj.get("href") != null && !jsonObj.get("href").isJsonNull()) && !jsonObj.get("href").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `href` to be a primitive type in the JSON string but got `%s`",
              jsonObj.get("href").toString()));
    }
    if ((jsonObj.get("iconClass") != null && !jsonObj.get("iconClass").isJsonNull())
        && !jsonObj.get("iconClass").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `iconClass` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("iconClass").toString()));
    }
    ...
    if ((jsonObj.get("styleClass") != null && !jsonObj.get("styleClass").isJsonNull())
        && !jsonObj.get("styleClass").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `styleClass` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("styleClass").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<SimpleLink> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(SimpleLink.class));

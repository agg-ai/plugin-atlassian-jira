...
public class UserBeanAvatarUrls {
  ...
  public UserBeanAvatarUrls _24x24(@javax.annotation.Nullable URI _24x24) {
    this._24x24 = _24x24;
    return this;
  }
  ...
  public UserBeanAvatarUrls _32x32(@javax.annotation.Nullable URI _32x32) {
    this._32x32 = _32x32;
    return this;
  }
  ...
  public UserBeanAvatarUrls _48x48(@javax.annotation.Nullable URI _48x48) {
    this._48x48 = _48x48;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!UserBeanAvatarUrls.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in UserBeanAvatarUrls is not found in the empty JSON string",
            UserBeanAvatarUrls.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!UserBeanAvatarUrls.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `UserBeanAvatarUrls` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<UserBeanAvatarUrls> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(UserBeanAvatarUrls.class));

...
public class WorkflowSchemeReadRequest {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!WorkflowSchemeReadRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in WorkflowSchemeReadRequest is not found in the empty JSON string",
            WorkflowSchemeReadRequest.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!WorkflowSchemeReadRequest.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `WorkflowSchemeReadRequest` properties. JSON: %s",
    ...
    // ensure the optional json data is an array if present
    if (jsonObj.get("workflowSchemeIds") != null && !jsonObj.get("workflowSchemeIds").isJsonNull()
        && !jsonObj.get("workflowSchemeIds").isJsonArray()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `workflowSchemeIds` to be an array in the JSON string but got `%s`",
          jsonObj.get("workflowSchemeIds").toString()));
    }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<WorkflowSchemeReadRequest> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(WorkflowSchemeReadRequest.class));

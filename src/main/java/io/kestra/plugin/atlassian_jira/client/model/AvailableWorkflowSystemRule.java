...
public class AvailableWorkflowSystemRule {
  ...
  public AvailableWorkflowSystemRule isAvailableForInitialTransition(
      @javax.annotation.Nonnull Boolean isAvailableForInitialTransition) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, availableWorkflowSystemRule.description) &&
        ...
        Objects.equals(this.isAvailableForInitialTransition,
            availableWorkflowSystemRule.isAvailableForInitialTransition)
        &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, incompatibleRuleKeys, isAvailableForInitialTransition, isVisible, name, ruleKey,
        ruleType);
  }
  ...
  public String toString() {
    ...
    sb.append("    isAvailableForInitialTransition: ").append(toIndentedString(isAvailableForInitialTransition))
        .append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("description", "incompatibleRuleKeys",
        "isAvailableForInitialTransition", "isVisible", "name", "ruleKey", "ruleType"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("description", "incompatibleRuleKeys",
        "isAvailableForInitialTransition", "isVisible", "name", "ruleKey", "ruleType"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!AvailableWorkflowSystemRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                          // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in AvailableWorkflowSystemRule is not found in the empty JSON string",
            AvailableWorkflowSystemRule.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!AvailableWorkflowSystemRule.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `AvailableWorkflowSystemRule` properties. JSON: %s",
    ...
    if (jsonObj.get("incompatibleRuleKeys") == null) {
      ...
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `incompatibleRuleKeys` to be an array in the JSON string but got `%s`",
          jsonObj.get("incompatibleRuleKeys").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<AvailableWorkflowSystemRule> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(AvailableWorkflowSystemRule.class));

...
import io.kestra.plugin.atlassian_jira.client.model.WorkflowMetadataAndIssueTypeRestModel;
import io.kestra.plugin.atlassian_jira.client.model.WorkflowMetadataRestModel;
...
public class WorkflowSchemeReadResponse {
  ...
  public WorkflowSchemeReadResponse defaultWorkflow(
      @javax.annotation.Nullable WorkflowMetadataRestModel defaultWorkflow) {
  ...
  public WorkflowSchemeReadResponse workflowsForIssueTypes(
      @javax.annotation.Nonnull List<WorkflowMetadataAndIssueTypeRestModel> workflowsForIssueTypes) {
    this.workflowsForIssueTypes = workflowsForIssueTypes;
    return this;
  }

  public WorkflowSchemeReadResponse addWorkflowsForIssueTypesItem(
      WorkflowMetadataAndIssueTypeRestModel workflowsForIssueTypesItem) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(defaultWorkflow, description, id, name, scope, taskId, version, workflowsForIssueTypes);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("defaultWorkflow", "description", "id", "name", "scope", "taskId",
        "version", "workflowsForIssueTypes"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(
        Arrays.asList("id", "name", "scope", "version", "workflowsForIssueTypes"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!WorkflowSchemeReadResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in WorkflowSchemeReadResponse is not found in the empty JSON string",
            WorkflowSchemeReadResponse.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!WorkflowSchemeReadResponse.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `WorkflowSchemeReadResponse` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<WorkflowSchemeReadResponse> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(WorkflowSchemeReadResponse.class));

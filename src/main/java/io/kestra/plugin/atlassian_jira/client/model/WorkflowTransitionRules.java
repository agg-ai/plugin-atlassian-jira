...
import io.kestra.plugin.atlassian_jira.client.model.AppWorkflowTransitionRule;
import io.kestra.plugin.atlassian_jira.client.model.WorkflowId;
...
public class WorkflowTransitionRules {
  ...
  public WorkflowTransitionRules postFunctions(
      @javax.annotation.Nullable List<AppWorkflowTransitionRule> postFunctions) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("conditions", "postFunctions", "validators", "workflowId"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("workflowId"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!WorkflowTransitionRules.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in WorkflowTransitionRules is not found in the empty JSON string",
            WorkflowTransitionRules.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!WorkflowTransitionRules.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `WorkflowTransitionRules` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<WorkflowTransitionRules> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(WorkflowTransitionRules.class));

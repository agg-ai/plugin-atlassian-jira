...
import io.kestra.plugin.atlassian_jira.client.model.TaskProgressBeanJsonNode;
...
public class UpdatePrioritySchemeResponseBean {
  ...
  public UpdatePrioritySchemeResponseBean priorityScheme(
      @javax.annotation.Nullable PrioritySchemeWithPaginatedPrioritiesAndProjects priorityScheme) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!UpdatePrioritySchemeResponseBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element
                                                                               // is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in UpdatePrioritySchemeResponseBean is not found in the empty JSON string",
            UpdatePrioritySchemeResponseBean.openapiRequiredFields.toString()));
      }
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!UpdatePrioritySchemeResponseBean.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'UpdatePrioritySchemeResponseBean' and its
                     // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<UpdatePrioritySchemeResponseBean> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(UpdatePrioritySchemeResponseBean.class));

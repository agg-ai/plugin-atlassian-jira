...
public class DataClassificationTagBean {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("color", "description", "guideline", "id", "name", "rank", "status"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!DataClassificationTagBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in DataClassificationTagBean is not found in the empty JSON string",
            DataClassificationTagBean.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!DataClassificationTagBean.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `DataClassificationTagBean` properties. JSON: %s",
    ...
    if ((jsonObj.get("guideline") != null && !jsonObj.get("guideline").isJsonNull())
        && !jsonObj.get("guideline").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `guideline` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("guideline").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<DataClassificationTagBean> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(DataClassificationTagBean.class));

...
public class HealthCheckResult {
  ...
  public HealthCheckResult description(@javax.annotation.Nullable String description) {
  ...
  public HealthCheckResult name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public HealthCheckResult passed(@javax.annotation.Nullable Boolean passed) {
    this.passed = passed;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("description", "name", "passed"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!HealthCheckResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in HealthCheckResult is not found in the empty JSON string",
            HealthCheckResult.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!HealthCheckResult.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `HealthCheckResult` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<HealthCheckResult> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(HealthCheckResult.class));

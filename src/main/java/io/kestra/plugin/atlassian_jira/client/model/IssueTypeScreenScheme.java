...
public class IssueTypeScreenScheme {
  ...
  public IssueTypeScreenScheme description(@javax.annotation.Nullable String description) {
  ...
  public IssueTypeScreenScheme id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public IssueTypeScreenScheme name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("description", "id", "name"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!IssueTypeScreenScheme.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssueTypeScreenScheme is not found in the empty JSON string",
            IssueTypeScreenScheme.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!IssueTypeScreenScheme.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `IssueTypeScreenScheme` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssueTypeScreenScheme> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssueTypeScreenScheme.class));

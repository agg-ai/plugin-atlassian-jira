...
public class PageOfStatuses {
  ...
  public PageOfStatuses isLast(@javax.annotation.Nullable Boolean isLast) {
    this.isLast = isLast;
    return this;
  }
  ...
  public PageOfStatuses maxResults(@javax.annotation.Nullable Integer maxResults) {
  ...
  public PageOfStatuses nextPage(@javax.annotation.Nullable String nextPage) {
  ...
  public PageOfStatuses self(@javax.annotation.Nullable String self) {
    this.self = self;
    return this;
  }
  ...
  public PageOfStatuses startAt(@javax.annotation.Nullable Long startAt) {
  ...
  public PageOfStatuses total(@javax.annotation.Nullable Long total) {
    this.total = total;
    return this;
  }
  ...
  public PageOfStatuses values(@javax.annotation.Nullable List<JiraStatus> values) {
    this.values = values;
    return this;
  }
  ...
  public void setValues(@javax.annotation.Nullable List<JiraStatus> values) {
    this.values = values;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PageOfStatuses.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in PageOfStatuses is not found in the empty JSON string",
            PageOfStatuses.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PageOfStatuses.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `PageOfStatuses` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<PageOfStatuses> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(PageOfStatuses.class));

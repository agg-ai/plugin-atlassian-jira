...
public class DashboardGadgetUpdateRequest {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("color", "position", "title"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!DashboardGadgetUpdateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                           // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in DashboardGadgetUpdateRequest is not found in the empty JSON string",
            DashboardGadgetUpdateRequest.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!DashboardGadgetUpdateRequest.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `DashboardGadgetUpdateRequest` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<DashboardGadgetUpdateRequest> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(DashboardGadgetUpdateRequest.class));

...
import io.kestra.plugin.atlassian_jira.client.model.BulkChangeOwnerDetails;
import io.kestra.plugin.atlassian_jira.client.model.PermissionDetails;
...
public class BulkEditShareableEntityRequest {
  ...
  public BulkEditShareableEntityRequest changeOwnerDetails(
      @javax.annotation.Nullable BulkChangeOwnerDetails changeOwnerDetails) {
  ...
  public BulkEditShareableEntityRequest extendAdminPermissions(
      @javax.annotation.Nullable Boolean extendAdminPermissions) {
  ...
  public BulkEditShareableEntityRequest permissionDetails(
      @javax.annotation.Nullable PermissionDetails permissionDetails) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("action", "changeOwnerDetails", "entityIds", "extendAdminPermissions", "permissionDetails"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!BulkEditShareableEntityRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                             // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in BulkEditShareableEntityRequest is not found in the empty JSON string",
            BulkEditShareableEntityRequest.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!BulkEditShareableEntityRequest.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `BulkEditShareableEntityRequest` properties. JSON: %s",
    ...
    if (jsonObj.get("entityIds") == null) {
      ...
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `entityIds` to be an array in the JSON string but got `%s`",
              jsonObj.get("entityIds").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<BulkEditShareableEntityRequest> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(BulkEditShareableEntityRequest.class));

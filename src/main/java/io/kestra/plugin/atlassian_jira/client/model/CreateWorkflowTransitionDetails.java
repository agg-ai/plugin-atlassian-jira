...
import io.kestra.plugin.atlassian_jira.client.model.CreateWorkflowTransitionRulesDetails;
import io.kestra.plugin.atlassian_jira.client.model.CreateWorkflowTransitionScreenDetails;
...
public class CreateWorkflowTransitionDetails {
  ...
  public CreateWorkflowTransitionDetails screen(
      @javax.annotation.Nullable CreateWorkflowTransitionScreenDetails screen) {
    this.screen = screen;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("description", "from", "name", "properties", "rules", "screen", "to", "type"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "to", "type"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CreateWorkflowTransitionDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                              // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CreateWorkflowTransitionDetails is not found in the empty JSON string",
            CreateWorkflowTransitionDetails.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CreateWorkflowTransitionDetails.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CreateWorkflowTransitionDetails` properties. JSON: %s",
    ...
    if (jsonObj.get("from") != null && !jsonObj.get("from").isJsonNull() && !jsonObj.get("from").isJsonArray()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `from` to be an array in the JSON string but got `%s`", jsonObj.get("from").toString()));
    }
    ...
    if (jsonObj.get("rules") != null && !jsonObj.get("rules").isJsonNull()) {
      CreateWorkflowTransitionRulesDetails.validateJsonElement(jsonObj.get("rules"));
    }
    // validate the optional field `screen`
    if (jsonObj.get("screen") != null && !jsonObj.get("screen").isJsonNull()) {
      CreateWorkflowTransitionScreenDetails.validateJsonElement(jsonObj.get("screen"));
    }
    if (!jsonObj.get("to").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `to` to be a primitive type in the JSON string but got `%s`",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<CreateWorkflowTransitionDetails> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CreateWorkflowTransitionDetails.class));

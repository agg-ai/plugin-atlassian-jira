...
public class CustomFieldContextDefaultValueSingleOption {
  ...
  public CustomFieldContextDefaultValueSingleOption optionId(@javax.annotation.Nonnull String optionId) {
  ...
  public CustomFieldContextDefaultValueSingleOption type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CustomFieldContextDefaultValueSingleOption.openapiRequiredFields.isEmpty()) { // has required fields but JSON
                                                                                         // element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CustomFieldContextDefaultValueSingleOption is not found in the empty JSON string",
            CustomFieldContextDefaultValueSingleOption.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CustomFieldContextDefaultValueSingleOption.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CustomFieldContextDefaultValueSingleOption` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!CustomFieldContextDefaultValueSingleOption.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'CustomFieldContextDefaultValueSingleOption' and
                     // its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<CustomFieldContextDefaultValueSingleOption> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CustomFieldContextDefaultValueSingleOption.class));
  ...
  /**
   * Create an instance of CustomFieldContextDefaultValueSingleOption given an
   * JSON string
   *
  ...
  /**
   * Convert an instance of CustomFieldContextDefaultValueSingleOption to an JSON
   * string
   *
   * @return JSON string
   */

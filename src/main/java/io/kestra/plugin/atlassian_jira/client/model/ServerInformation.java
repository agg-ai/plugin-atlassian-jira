...
import io.kestra.plugin.atlassian_jira.client.model.HealthCheckResult;
...
public class ServerInformation {
  ...
  public ServerInformation displayUrlServicedeskHelpCenter(
      @javax.annotation.Nullable String displayUrlServicedeskHelpCenter) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(baseUrl, buildDate, buildNumber, deploymentType, displayUrl, displayUrlConfluence,
        displayUrlServicedeskHelpCenter, healthChecks, scmInfo, serverTime, serverTimeZone, serverTitle, version,
        versionNumbers);
  }
  ...
  public String toString() {
    ...
    sb.append("    displayUrlServicedeskHelpCenter: ").append(toIndentedString(displayUrlServicedeskHelpCenter))
        .append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("baseUrl", "buildDate", "buildNumber", "deploymentType",
        "displayUrl", "displayUrlConfluence", "displayUrlServicedeskHelpCenter", "healthChecks", "scmInfo",
        "serverTime", "serverTimeZone", "serverTitle", "version", "versionNumbers"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ServerInformation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in ServerInformation is not found in the empty JSON string",
            ServerInformation.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ServerInformation.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ServerInformation` properties. JSON: %s",
            entry.getKey(), jsonElement.toString()));
      }
    }
    JsonObject jsonObj = jsonElement.getAsJsonObject();
    if ((jsonObj.get("baseUrl") != null && !jsonObj.get("baseUrl").isJsonNull())
        && !jsonObj.get("baseUrl").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `baseUrl` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("baseUrl").toString()));
    }
    if ((jsonObj.get("deploymentType") != null && !jsonObj.get("deploymentType").isJsonNull())
        && !jsonObj.get("deploymentType").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `deploymentType` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("deploymentType").toString()));
    }
    if ((jsonObj.get("displayUrl") != null && !jsonObj.get("displayUrl").isJsonNull())
        && !jsonObj.get("displayUrl").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `displayUrl` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("displayUrl").toString()));
    }
    if ((jsonObj.get("displayUrlConfluence") != null && !jsonObj.get("displayUrlConfluence").isJsonNull())
        && !jsonObj.get("displayUrlConfluence").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `displayUrlConfluence` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("displayUrlConfluence").toString()));
    }
    if ((jsonObj.get("displayUrlServicedeskHelpCenter") != null
        && !jsonObj.get("displayUrlServicedeskHelpCenter").isJsonNull())
        && !jsonObj.get("displayUrlServicedeskHelpCenter").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `displayUrlServicedeskHelpCenter` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("displayUrlServicedeskHelpCenter").toString()));
    }
    if (jsonObj.get("healthChecks") != null && !jsonObj.get("healthChecks").isJsonNull()) {
      ...
      if (jsonArrayhealthChecks != null) {
        ...
        if (!jsonObj.get("healthChecks").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `healthChecks` to be an array in the JSON string but got `%s`",
              jsonObj.get("healthChecks").toString()));
        }
    ...
    if ((jsonObj.get("scmInfo") != null && !jsonObj.get("scmInfo").isJsonNull())
        && !jsonObj.get("scmInfo").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `scmInfo` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("scmInfo").toString()));
    }
    if ((jsonObj.get("serverTimeZone") != null && !jsonObj.get("serverTimeZone").isJsonNull())
        && !jsonObj.get("serverTimeZone").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `serverTimeZone` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("serverTimeZone").toString()));
    }
    if ((jsonObj.get("serverTitle") != null && !jsonObj.get("serverTitle").isJsonNull())
        && !jsonObj.get("serverTitle").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `serverTitle` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("serverTitle").toString()));
    }
    ...
    if (jsonObj.get("versionNumbers") != null && !jsonObj.get("versionNumbers").isJsonNull()
        && !jsonObj.get("versionNumbers").isJsonArray()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `versionNumbers` to be an array in the JSON string but got `%s`",
          jsonObj.get("versionNumbers").toString()));
    }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ServerInformation> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(ServerInformation.class));

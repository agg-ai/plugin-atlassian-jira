...
public class JiraSingleSelectUserPickerField {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("fieldId", "user"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!JiraSingleSelectUserPickerField.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                              // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in JiraSingleSelectUserPickerField is not found in the empty JSON string",
            JiraSingleSelectUserPickerField.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!JiraSingleSelectUserPickerField.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `JiraSingleSelectUserPickerField` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<JiraSingleSelectUserPickerField> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(JiraSingleSelectUserPickerField.class));

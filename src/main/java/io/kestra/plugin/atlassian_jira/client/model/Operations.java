...
import io.kestra.plugin.atlassian_jira.client.model.LinkGroup;
...
public class Operations {
   ...
   * @return the Operations instance itself
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("linkGroups"));
    ...
    if (jsonElement == null) {
      if (!Operations.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in Operations is not found in the empty JSON string",
                Operations.openapiRequiredFields.toString()));
      }
    }
    JsonObject jsonObj = jsonElement.getAsJsonObject();
    if (jsonObj.get("linkGroups") != null && !jsonObj.get("linkGroups").isJsonNull()) {
      JsonArray jsonArraylinkGroups = jsonObj.getAsJsonArray("linkGroups");
      if (jsonArraylinkGroups != null) {
        // ensure the json data is an array
        if (!jsonObj.get("linkGroups").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `linkGroups` to be an array in the JSON string but got `%s`",
              jsonObj.get("linkGroups").toString()));
        }

        // validate the optional field `linkGroups` (array)
        for (int i = 0; i < jsonArraylinkGroups.size(); i++) {
          LinkGroup.validateJsonElement(jsonArraylinkGroups.get(i));
        }
        ;
      }
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<Operations> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(Operations.class));
      ...
      return (TypeAdapter<T>) new TypeAdapter<Operations>() {
        ...
        public Operations read(JsonReader in) throws IOException {
          ...
          Operations instance = thisAdapter.fromJsonTree(jsonObj);

...
public class ApprovalConfiguration {
   ...
   * If &#x60;conditionType&#x60; is &#x60;number&#x60;, the value must be 20 or
   * less. If &#x60;conditionType&#x60; is &#x60;percent&#x60;, the value must be
   * 100 or less.
   * 
  ...
  /**
   * The custom field ID of the \&quot;Approvers\&quot; or \&quot;Approver
   * Groups\&quot; field.
   * 
   * @return fieldId
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, conditionType, conditionValue, exclude, fieldId, prePopulatedFieldId,
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("active", "conditionType", "conditionValue", "exclude", "fieldId",
        "prePopulatedFieldId", "transitionApproved", "transitionRejected"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("active", "conditionType", "conditionValue", "fieldId",
        "transitionApproved", "transitionRejected"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ApprovalConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in ApprovalConfiguration is not found in the empty JSON string",
            ApprovalConfiguration.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ApprovalConfiguration.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ApprovalConfiguration` properties. JSON: %s",
    ...
    if (!jsonObj.get("conditionValue").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `conditionValue` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("conditionValue").toString()));
    }
    // ensure the optional json data is an array if present
    if (jsonObj.get("exclude") != null && !jsonObj.get("exclude").isJsonNull()
        && !jsonObj.get("exclude").isJsonArray()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `exclude` to be an array in the JSON string but got `%s`",
              jsonObj.get("exclude").toString()));
    }
    ...
    if ((jsonObj.get("prePopulatedFieldId") != null && !jsonObj.get("prePopulatedFieldId").isJsonNull())
        && !jsonObj.get("prePopulatedFieldId").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `prePopulatedFieldId` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("prePopulatedFieldId").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ApprovalConfiguration> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(ApprovalConfiguration.class));

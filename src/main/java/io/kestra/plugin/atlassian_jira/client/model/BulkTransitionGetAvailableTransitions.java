...
import io.kestra.plugin.atlassian_jira.client.model.IssueBulkTransitionForWorkflow;
...
public class BulkTransitionGetAvailableTransitions {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("availableTransitions", "endingBefore", "startingAfter"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!BulkTransitionGetAvailableTransitions.openapiRequiredFields.isEmpty()) { // has required fields but JSON
                                                                                    // element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in BulkTransitionGetAvailableTransitions is not found in the empty JSON string",
            BulkTransitionGetAvailableTransitions.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!BulkTransitionGetAvailableTransitions.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `BulkTransitionGetAvailableTransitions` properties. JSON: %s",
    ...
    if (jsonObj.get("availableTransitions") != null && !jsonObj.get("availableTransitions").isJsonNull()) {
      ...
      if (jsonArrayavailableTransitions != null) {
        ...
        if (!jsonObj.get("availableTransitions").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `availableTransitions` to be an array in the JSON string but got `%s`",
              jsonObj.get("availableTransitions").toString()));
        }
    ...
    if ((jsonObj.get("endingBefore") != null && !jsonObj.get("endingBefore").isJsonNull())
        && !jsonObj.get("endingBefore").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `endingBefore` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("endingBefore").toString()));
    }
    if ((jsonObj.get("startingAfter") != null && !jsonObj.get("startingAfter").isJsonNull())
        && !jsonObj.get("startingAfter").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `startingAfter` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("startingAfter").toString()));
    }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!BulkTransitionGetAvailableTransitions.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'BulkTransitionGetAvailableTransitions' and its
                     // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<BulkTransitionGetAvailableTransitions> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(BulkTransitionGetAvailableTransitions.class));
  ...
  /**
   * Create an instance of BulkTransitionGetAvailableTransitions given an JSON
   * string
   *
  ...
  /**
   * Convert an instance of BulkTransitionGetAvailableTransitions to an JSON
   * string
   *
   * @return JSON string
   */

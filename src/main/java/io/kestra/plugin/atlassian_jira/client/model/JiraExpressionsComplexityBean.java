...
import io.kestra.plugin.atlassian_jira.client.model.JiraExpressionsComplexityValueBean;
...
public class JiraExpressionsComplexityBean {
  ...
  public JiraExpressionsComplexityBean expensiveOperations(
      @javax.annotation.Nonnull JiraExpressionsComplexityValueBean expensiveOperations) {
  ...
  public JiraExpressionsComplexityBean primitiveValues(
      @javax.annotation.Nonnull JiraExpressionsComplexityValueBean primitiveValues) {
   ...
   * as arithmetic, accessing a property, accessing a context variable, or calling
   * a function.
   * 
   * @return steps
   */
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(
        Arrays.asList("beans", "expensiveOperations", "primitiveValues", "steps"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!JiraExpressionsComplexityBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                            // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in JiraExpressionsComplexityBean is not found in the empty JSON string",
            JiraExpressionsComplexityBean.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!JiraExpressionsComplexityBean.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `JiraExpressionsComplexityBean` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<JiraExpressionsComplexityBean> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(JiraExpressionsComplexityBean.class));

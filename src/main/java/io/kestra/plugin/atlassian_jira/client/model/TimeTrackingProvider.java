...
public class TimeTrackingProvider {
   ...
   * example, *_/example/config/url*. This property is only returned if the
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!TimeTrackingProvider.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in TimeTrackingProvider is not found in the empty JSON string",
            TimeTrackingProvider.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!TimeTrackingProvider.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `TimeTrackingProvider` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<TimeTrackingProvider> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(TimeTrackingProvider.class));

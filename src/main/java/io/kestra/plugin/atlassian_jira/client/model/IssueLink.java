...
import io.kestra.plugin.atlassian_jira.client.model.LinkedIssue;
...
public class IssueLink {
   ...
   * interface, use the &#x60;inward&#x60; field of the issue link type to label
   * the link.
   * 
   * @return inwardIssue
   */
  ...
  /**
   * Provides details about the linked issue. If presenting this link in a user
   * interface, use the &#x60;outward&#x60; field of the issue link type to label
   * the link.
   * 
   * @return outwardIssue
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "inwardIssue", "outwardIssue", "self", "type"));
    ...
    if (jsonElement == null) {
      if (!IssueLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in IssueLink is not found in the empty JSON string",
                IssueLink.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!IssueLink.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `IssueLink` properties. JSON: %s", entry.getKey(),
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssueLink> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(IssueLink.class));

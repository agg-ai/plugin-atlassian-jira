...
import io.kestra.plugin.atlassian_jira.client.model.StatusDetails;
...
public class WorkflowStatusesApi {
     ...
     *                        <tr>
     *                        <td>404</td>
     *                        <td>Returned if: * the status is not found. * the
     *                        status is not associated with a workflow. * the user
     *                        does not have the required permissions.</td>
     *                        <td>-</td>
     *                        </tr>
     *                        </table>
     */
    public okhttp3.Call getStatusCall(@javax.annotation.Nonnull String idOrName, final ApiCallback _callback)
            throws ApiException {
    ...
    private okhttp3.Call getStatusValidateBeforeCall(@javax.annotation.Nonnull String idOrName,
     ...
     * returned. If a name is used on more than one status, only the status found
     * first is returned. Therefore, identifying the status by its ID may be
     * preferable. This operation can be accessed anonymously.
     ...
     *                        </table>
     */
    public ApiResponse<StatusDetails> getStatusWithHttpInfo(@javax.annotation.Nonnull String idOrName)
            throws ApiException {
        okhttp3.Call localVarCall = getStatusValidateBeforeCall(idOrName, null);
        Type localVarReturnType = new TypeToken<StatusDetails>() {
        }.getType();
     ...
     *                        </table>
     */
    public okhttp3.Call getStatusAsync(@javax.annotation.Nonnull String idOrName,
            final ApiCallback<StatusDetails> _callback) throws ApiException {
    ...
    /**
     * Get all statuses
     * Returns a list of all statuses associated with active workflows. This
     * operation can be accessed anonymously. [Permissions](#permissions) required:
    ...
    public ApiResponse<List<StatusDetails>> getStatusesWithHttpInfo() throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<StatusDetails>>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

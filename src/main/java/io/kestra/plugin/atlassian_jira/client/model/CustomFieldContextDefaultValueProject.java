...
public class CustomFieldContextDefaultValueProject {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("contextId", "projectId", "type"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("contextId", "projectId", "type"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CustomFieldContextDefaultValueProject.openapiRequiredFields.isEmpty()) { // has required fields but JSON
                                                                                    // element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CustomFieldContextDefaultValueProject is not found in the empty JSON string",
            CustomFieldContextDefaultValueProject.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CustomFieldContextDefaultValueProject.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CustomFieldContextDefaultValueProject` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!CustomFieldContextDefaultValueProject.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'CustomFieldContextDefaultValueProject' and its
                     // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<CustomFieldContextDefaultValueProject> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CustomFieldContextDefaultValueProject.class));
  ...
  /**
   * Create an instance of CustomFieldContextDefaultValueProject given an JSON
   * string
   *
  ...
  /**
   * Convert an instance of CustomFieldContextDefaultValueProject to an JSON
   * string
   *
   * @return JSON string
   */

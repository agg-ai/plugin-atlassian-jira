...
import io.kestra.plugin.atlassian_jira.client.model.SuggestedMappingsForPrioritiesRequestBean;
import io.kestra.plugin.atlassian_jira.client.model.SuggestedMappingsForProjectsRequestBean;
...
public class SuggestedMappingsRequestBean {
  ...
  public SuggestedMappingsRequestBean priorities(
      @javax.annotation.Nullable SuggestedMappingsForPrioritiesRequestBean priorities) {
  ...
  public SuggestedMappingsRequestBean projects(
      @javax.annotation.Nullable SuggestedMappingsForProjectsRequestBean projects) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!SuggestedMappingsRequestBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                           // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in SuggestedMappingsRequestBean is not found in the empty JSON string",
            SuggestedMappingsRequestBean.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!SuggestedMappingsRequestBean.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `SuggestedMappingsRequestBean` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<SuggestedMappingsRequestBean> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(SuggestedMappingsRequestBean.class));

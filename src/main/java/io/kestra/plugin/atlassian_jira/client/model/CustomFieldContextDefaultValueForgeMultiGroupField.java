...
public class CustomFieldContextDefaultValueForgeMultiGroupField {
  ...
  public CustomFieldContextDefaultValueForgeMultiGroupField contextId(@javax.annotation.Nonnull String contextId) {
  ...
  public CustomFieldContextDefaultValueForgeMultiGroupField groupIds(@javax.annotation.Nonnull Set<String> groupIds) {
  ...
  public CustomFieldContextDefaultValueForgeMultiGroupField type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("contextId", "groupIds", "type"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("contextId", "groupIds", "type"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CustomFieldContextDefaultValueForgeMultiGroupField.openapiRequiredFields.isEmpty()) { // has required fields
                                                                                                 // but JSON element is
                                                                                                 // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CustomFieldContextDefaultValueForgeMultiGroupField is not found in the empty JSON string",
            CustomFieldContextDefaultValueForgeMultiGroupField.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CustomFieldContextDefaultValueForgeMultiGroupField.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CustomFieldContextDefaultValueForgeMultiGroupField` properties. JSON: %s",
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!CustomFieldContextDefaultValueForgeMultiGroupField.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes
                     // 'CustomFieldContextDefaultValueForgeMultiGroupField' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<CustomFieldContextDefaultValueForgeMultiGroupField> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CustomFieldContextDefaultValueForgeMultiGroupField.class));
  ...
  /**
   * Create an instance of CustomFieldContextDefaultValueForgeMultiGroupField
  ...
  /**
   * Convert an instance of CustomFieldContextDefaultValueForgeMultiGroupField to
   * an JSON string
   *
   * @return JSON string
   */

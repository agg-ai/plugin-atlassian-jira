...
import io.kestra.plugin.atlassian_jira.client.model.BulkProjectPermissions;
...
public class BulkPermissionsRequestBean {
  ...
  public BulkPermissionsRequestBean projectPermissions(
      @javax.annotation.Nullable Set<BulkProjectPermissions> projectPermissions) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("accountId", "globalPermissions", "projectPermissions"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!BulkPermissionsRequestBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in BulkPermissionsRequestBean is not found in the empty JSON string",
            BulkPermissionsRequestBean.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!BulkPermissionsRequestBean.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `BulkPermissionsRequestBean` properties. JSON: %s",
    ...
    if (jsonObj.get("globalPermissions") != null && !jsonObj.get("globalPermissions").isJsonNull()
        && !jsonObj.get("globalPermissions").isJsonArray()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<BulkPermissionsRequestBean> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(BulkPermissionsRequestBean.class));

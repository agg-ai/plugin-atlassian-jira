...
public class CustomFieldContextUpdateDetails {
  ...
  public CustomFieldContextUpdateDetails description(@javax.annotation.Nullable String description) {
  ...
  public CustomFieldContextUpdateDetails name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CustomFieldContextUpdateDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                              // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CustomFieldContextUpdateDetails is not found in the empty JSON string",
            CustomFieldContextUpdateDetails.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CustomFieldContextUpdateDetails.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CustomFieldContextUpdateDetails` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<CustomFieldContextUpdateDetails> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CustomFieldContextUpdateDetails.class));

...
public class WorkflowIDs {
  ...
  public WorkflowIDs entityId(@javax.annotation.Nullable String entityId) {
  ...
  public WorkflowIDs name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
    ...
    if (jsonElement == null) {
      if (!WorkflowIDs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in WorkflowIDs is not found in the empty JSON string",
                WorkflowIDs.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!WorkflowIDs.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `WorkflowIDs` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<WorkflowIDs> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(WorkflowIDs.class));

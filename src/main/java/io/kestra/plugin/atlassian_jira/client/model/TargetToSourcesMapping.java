...
import io.kestra.plugin.atlassian_jira.client.model.TargetClassification;
import io.kestra.plugin.atlassian_jira.client.model.TargetMandatoryFields;
import io.kestra.plugin.atlassian_jira.client.model.TargetStatus;
...
public class TargetToSourcesMapping {
  ...
  public TargetToSourcesMapping inferClassificationDefaults(
      @javax.annotation.Nonnull Boolean inferClassificationDefaults) {
    this.inferClassificationDefaults = inferClassificationDefaults;
    return this;
  }

  /**
   * If &#x60;true&#x60;, when issues are moved into this target group, they will
   * adopt the target project&#39;s default classification, if they don&#39;t have
   * a classification already. If they do have a classification, it will be kept
   * the same even after the move. Leave &#x60;targetClassification&#x60; empty
   * when using this. If &#x60;false&#x60;, you must provide a
   * &#x60;targetClassification&#x60; mapping for each classification associated
   * with the selected issues. [Benefit from data
   ...
   * mandatory fields in the field configuration of the destination project. The
   * &#x60;targetMandatoryFields&#x60; property shouldn&#39;t be defined. If
   * &#x60;false&#x60;, the user is required to set values for mandatory fields
   * present in the field configuration of the destination project. Provide input
   * by defining the &#x60;targetMandatoryFields&#x60; property
   * 
  ...
  /**
   * If &#x60;true&#x60;, the statuses of issues being moved in this target group
   * that are not present in the target workflow will be changed to the default
   * status of the target workflow (see below). Leave &#x60;targetStatus&#x60;
   * empty when using this. If &#x60;false&#x60;, you must provide a
   * &#x60;targetStatus&#x60; for each status not present in the target workflow.
   * The default status in a workflow is referred to as the \&quot;initial
   * status\&quot;. Each workflow has its own unique initial status. When an issue
   * is created, it is automatically assigned to this initial status. Read more
   * about configuring initial statuses: [Configure the initial status | Atlassian
   ...
   * it. &#x60;inferSubtaskTypeDefault&#x60; helps with moving the subtasks by
   * picking a random subtask type in the target project. If &#x60;true&#x60;,
   * subtasks will automatically move to the same project as their parent. When
   * they move: * Their &#x60;issueType&#x60; will be set to the default for
   * subtasks in the target project. * Values for mandatory fields will be
   * retained from the source issues * Specifying separate mapping for implicit
   * subtasks won’t be allowed. If &#x60;false&#x60;, you must manually move the
   * subtasks. They will retain the parent which they had in the current project
   * after being moved.
   * 
  ...
  public TargetToSourcesMapping targetClassification(
      @javax.annotation.Nullable List<TargetClassification> targetClassification) {
   ...
   * new values which need to be set during the bulk move operation. It is
   * mandatory to provide source classification to target classification mapping
   * when the source classification is invalid for the target project and issue
   * type. * **You should only define this property when
   * &#x60;inferClassificationDefaults&#x60; is &#x60;false&#x60;.** * **In order
   * to provide mapping for issues which don&#39;t have a classification, use
   * &#x60;\&quot;-1\&quot;&#x60;.**
   * 
  ...
  public TargetToSourcesMapping targetMandatoryFields(
      @javax.annotation.Nullable List<TargetMandatoryFields> targetMandatoryFields) {
   ...
   * and new values that need to be set during the bulk move operation. The new
   * values will only be applied if the field is mandatory in the target project
   * and at least one issue from the source has that field empty, or if the field
   * context is different in the target project (e.g. project-scoped version
   * fields). **You should only define this property when
   * &#x60;inferFieldDefaults&#x60; is &#x60;false&#x60;.**
   * 
   ...
   * values which need to be set during the bulk move operation. The new values
   * will only be applied if the source status is invalid for the target project
   * and issue type. It is mandatory to provide source status to target status
   * mapping when the source status is invalid for the target project and issue
   * type. **You should only define this property when
   * &#x60;inferStatusDefaults&#x60; is &#x60;false&#x60;.**
   * 
   * @return targetStatus
   */
  @javax.annotation.Nullable
  ...
  @Override
  public int hashCode() {
    return Objects.hash(inferClassificationDefaults, inferFieldDefaults, inferStatusDefaults, inferSubtaskTypeDefault,
        issueIdsOrKeys, targetClassification, targetMandatoryFields, targetStatus);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("inferClassificationDefaults", "inferFieldDefaults",
        "inferStatusDefaults", "inferSubtaskTypeDefault", "issueIdsOrKeys", "targetClassification",
        "targetMandatoryFields", "targetStatus"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("inferClassificationDefaults", "inferFieldDefaults",
        "inferStatusDefaults", "inferSubtaskTypeDefault"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!TargetToSourcesMapping.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in TargetToSourcesMapping is not found in the empty JSON string",
            TargetToSourcesMapping.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!TargetToSourcesMapping.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `TargetToSourcesMapping` properties. JSON: %s",
    ...
    if (jsonObj.get("issueIdsOrKeys") != null && !jsonObj.get("issueIdsOrKeys").isJsonNull()
        && !jsonObj.get("issueIdsOrKeys").isJsonArray()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `issueIdsOrKeys` to be an array in the JSON string but got `%s`",
          jsonObj.get("issueIdsOrKeys").toString()));
    }
    if (jsonObj.get("targetClassification") != null && !jsonObj.get("targetClassification").isJsonNull()) {
      ...
      if (jsonArraytargetClassification != null) {
        ...
        if (!jsonObj.get("targetClassification").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `targetClassification` to be an array in the JSON string but got `%s`",
              jsonObj.get("targetClassification").toString()));
        }
    ...
    if (jsonObj.get("targetMandatoryFields") != null && !jsonObj.get("targetMandatoryFields").isJsonNull()) {
      ...
      if (jsonArraytargetMandatoryFields != null) {
        ...
        if (!jsonObj.get("targetMandatoryFields").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `targetMandatoryFields` to be an array in the JSON string but got `%s`",
              jsonObj.get("targetMandatoryFields").toString()));
        }
    ...
    if (jsonObj.get("targetStatus") != null && !jsonObj.get("targetStatus").isJsonNull()) {
      ...
      if (jsonArraytargetStatus != null) {
        ...
        if (!jsonObj.get("targetStatus").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `targetStatus` to be an array in the JSON string but got `%s`",
              jsonObj.get("targetStatus").toString()));
        }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<TargetToSourcesMapping> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(TargetToSourcesMapping.class));

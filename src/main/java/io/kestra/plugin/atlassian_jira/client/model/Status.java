...
public class Status {
   ...
   * issue is displayed in a strikethrough font, otherwise the link displays in
   * normal font.
   * 
   * @return resolved
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("icon", "resolved"));
    ...
    if (jsonElement == null) {
      if (!Status.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in Status is not found in the empty JSON string",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<Status> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(Status.class));

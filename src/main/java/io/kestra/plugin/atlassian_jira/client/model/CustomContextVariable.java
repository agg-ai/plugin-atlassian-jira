...
import io.kestra.plugin.atlassian_jira.client.model.IssueContextVariable;
import io.kestra.plugin.atlassian_jira.client.model.JsonContextVariable;
import io.kestra.plugin.atlassian_jira.client.model.UserContextVariable;
...
public class CustomContextVariable extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<UserContextVariable> adapterUserContextVariable = gson.getDelegateAdapter(this,
                    TypeToken.get(UserContextVariable.class));
            final TypeAdapter<IssueContextVariable> adapterIssueContextVariable = gson.getDelegateAdapter(this,
                    TypeToken.get(IssueContextVariable.class));
            final TypeAdapter<JsonContextVariable> adapterJsonContextVariable = gson.getDelegateAdapter(this,
                    TypeToken.get(JsonContextVariable.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<CustomContextVariable>() {
                ...
                public void write(JsonWriter out, CustomContextVariable value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof UserContextVariable) {
                        JsonElement element = adapterUserContextVariable
                                .toJsonTree((UserContextVariable) value.getActualInstance());
                    ...
                    if (value.getActualInstance() instanceof IssueContextVariable) {
                        JsonElement element = adapterIssueContextVariable
                                .toJsonTree((IssueContextVariable) value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    // check if the actual instance is of the type `JsonContextVariable`
                    if (value.getActualInstance() instanceof JsonContextVariable) {
                        JsonElement element = adapterJsonContextVariable
                                .toJsonTree((JsonContextVariable) value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    throw new IOException(
                            "Failed to serialize as the type doesn't match oneOf schemas: IssueContextVariable, JsonContextVariable, UserContextVariable");
                }
                ...
                public CustomContextVariable read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        errorMessages.add(String.format(Locale.ROOT,
                                "Deserialization for UserContextVariable failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(Locale.ROOT,
                                "Deserialization for IssueContextVariable failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(Locale.ROOT,
                                "Deserialization for JsonContextVariable failed with `%s`.", e.getMessage()));
                    ...
                    throw new IOException(String.format(Locale.ROOT,
                            "Failed deserialization for CustomContextVariable: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s",
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException(
                "Invalid instance type. Must be IssueContextVariable, JsonContextVariable, UserContextVariable");
    }
     ...
     * IssueContextVariable, JsonContextVariable, UserContextVariable
     *
     * @return The actual instance (IssueContextVariable, JsonContextVariable,
     *         UserContextVariable)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * Get the actual instance of `UserContextVariable`. If the actual instance is
     * not `UserContextVariable`,
    ...
    /**
     * Get the actual instance of `IssueContextVariable`. If the actual instance is
     * not `IssueContextVariable`,
     * the ClassCastException will be thrown.
     *
    ...
    /**
     * Get the actual instance of `JsonContextVariable`. If the actual instance is
     * not `JsonContextVariable`,
     * the ClassCastException will be thrown.
     *
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        try {
            ...
            errorMessages.add(String.format(Locale.ROOT, "Deserialization for UserContextVariable failed with `%s`.",
                    e.getMessage()));
        ...
        try {
            ...
            errorMessages.add(String.format(Locale.ROOT, "Deserialization for IssueContextVariable failed with `%s`.",
                    e.getMessage()));
            // continue to the next one
        }
        ...
        try {
            ...
            errorMessages.add(String.format(Locale.ROOT, "Deserialization for JsonContextVariable failed with `%s`.",
                    e.getMessage()));
            // continue to the next one
        }
        if (validCount != 1) {
            throw new IOException(String.format(Locale.ROOT,
                    "The JSON string is invalid for CustomContextVariable with oneOf schemas: IssueContextVariable, JsonContextVariable, UserContextVariable. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s",

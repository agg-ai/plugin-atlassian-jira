...
import io.kestra.plugin.atlassian_jira.client.model.JiraVersionField;
...
public class JiraMultipleVersionPickerField {
  ...
  public JiraMultipleVersionPickerField bulkEditMultiSelectFieldOption(
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bulkEditMultiSelectFieldOption,
        jiraMultipleVersionPickerField.bulkEditMultiSelectFieldOption) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!JiraMultipleVersionPickerField.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                             // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in JiraMultipleVersionPickerField is not found in the empty JSON string",
            JiraMultipleVersionPickerField.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!JiraMultipleVersionPickerField.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `JiraMultipleVersionPickerField` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<JiraMultipleVersionPickerField> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(JiraMultipleVersionPickerField.class));

...
import io.kestra.plugin.atlassian_jira.client.model.GetDateFieldResponse;
...
public class GetSchedulingResponse {
  /**
   * The dependencies for the plan. This is \&quot;Sequential\&quot; or
   * \&quot;Concurrent\&quot;.
   */
  ...
  /**
   * The estimation unit for the plan. This is \&quot;StoryPoints\&quot;,
   * \&quot;Days\&quot; or \&quot;Hours\&quot;.
   */
  ...
  /**
   * The inferred dates for the plan. This is \&quot;None\&quot;,
   * \&quot;SprintDates\&quot; or \&quot;ReleaseDates\&quot;.
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("dependencies", "endDate", "estimation", "inferredDates", "startDate"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!GetSchedulingResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in GetSchedulingResponse is not found in the empty JSON string",
            GetSchedulingResponse.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!GetSchedulingResponse.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `GetSchedulingResponse` properties. JSON: %s",
    ...
    if (!jsonObj.get("dependencies").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `dependencies` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("dependencies").toString()));
    }
    ...
    if (!jsonObj.get("estimation").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `estimation` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("estimation").toString()));
    }
    ...
    if (!jsonObj.get("inferredDates").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `inferredDates` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("inferredDates").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<GetSchedulingResponse> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(GetSchedulingResponse.class));

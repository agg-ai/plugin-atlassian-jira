...
import io.kestra.plugin.atlassian_jira.client.model.AvailableWorkflowConnectRule;
import io.kestra.plugin.atlassian_jira.client.model.AvailableWorkflowForgeRule;
import io.kestra.plugin.atlassian_jira.client.model.AvailableWorkflowSystemRule;
import io.kestra.plugin.atlassian_jira.client.model.AvailableWorkflowTriggers;
...
public class WorkflowCapabilities {
  ...
  /**
   * The scope of the workflow capabilities. &#x60;GLOBAL&#x60; for
   * company-managed projects and &#x60;PROJECT&#x60; for team-managed projects.
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("connectRules", "editorScope", "forgeRules", "projectTypes", "systemRules", "triggerRules"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!WorkflowCapabilities.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in WorkflowCapabilities is not found in the empty JSON string",
            WorkflowCapabilities.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!WorkflowCapabilities.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `WorkflowCapabilities` properties. JSON: %s",
    ...
    if (jsonObj.get("connectRules") != null && !jsonObj.get("connectRules").isJsonNull()) {
      ...
      if (jsonArrayconnectRules != null) {
        ...
        if (!jsonObj.get("connectRules").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `connectRules` to be an array in the JSON string but got `%s`",
              jsonObj.get("connectRules").toString()));
        }
    ...
    if ((jsonObj.get("editorScope") != null && !jsonObj.get("editorScope").isJsonNull())
        && !jsonObj.get("editorScope").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `editorScope` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("editorScope").toString()));
    }
    ...
    if (jsonObj.get("forgeRules") != null && !jsonObj.get("forgeRules").isJsonNull()) {
      ...
      if (jsonArrayforgeRules != null) {
        ...
        if (!jsonObj.get("forgeRules").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `forgeRules` to be an array in the JSON string but got `%s`",
              jsonObj.get("forgeRules").toString()));
        }
    ...
    if (jsonObj.get("projectTypes") != null && !jsonObj.get("projectTypes").isJsonNull()
        && !jsonObj.get("projectTypes").isJsonArray()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `projectTypes` to be an array in the JSON string but got `%s`",
              jsonObj.get("projectTypes").toString()));
    }
    if (jsonObj.get("systemRules") != null && !jsonObj.get("systemRules").isJsonNull()) {
      ...
      if (jsonArraysystemRules != null) {
        ...
        if (!jsonObj.get("systemRules").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `systemRules` to be an array in the JSON string but got `%s`",
              jsonObj.get("systemRules").toString()));
        }
    ...
    if (jsonObj.get("triggerRules") != null && !jsonObj.get("triggerRules").isJsonNull()) {
      ...
      if (jsonArraytriggerRules != null) {
        ...
        if (!jsonObj.get("triggerRules").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `triggerRules` to be an array in the JSON string but got `%s`",
              jsonObj.get("triggerRules").toString()));
        }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<WorkflowCapabilities> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(WorkflowCapabilities.class));

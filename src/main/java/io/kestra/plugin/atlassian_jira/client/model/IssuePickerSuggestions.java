...
import io.kestra.plugin.atlassian_jira.client.model.IssuePickerSuggestionsIssueType;
...
public class IssuePickerSuggestions {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sections"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!IssuePickerSuggestions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssuePickerSuggestions is not found in the empty JSON string",
            IssuePickerSuggestions.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!IssuePickerSuggestions.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `IssuePickerSuggestions` properties. JSON: %s",
      ...
      if (jsonArraysections != null) {
        ...
        if (!jsonObj.get("sections").isJsonArray()) {
          throw new IllegalArgumentException(
              String.format(Locale.ROOT, "Expected the field `sections` to be an array in the JSON string but got `%s`",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssuePickerSuggestions> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssuePickerSuggestions.class));

...
import io.kestra.plugin.atlassian_jira.client.model.ProjectDetails;
import io.kestra.plugin.atlassian_jira.client.model.PublishedWorkflowId;
import io.kestra.plugin.atlassian_jira.client.model.Transition;
import io.kestra.plugin.atlassian_jira.client.model.WorkflowOperations;
import io.kestra.plugin.atlassian_jira.client.model.WorkflowSchemeIdName;
import io.kestra.plugin.atlassian_jira.client.model.WorkflowStatus;
...
public class Workflow {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(created, description, hasDraftWorkflow, id, isDefault, operations, projects, schemes, statuses,
        transitions, updated);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("created", "description", "hasDraftWorkflow", "id", "isDefault",
        "operations", "projects", "schemes", "statuses", "transitions", "updated"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("description", "id"));
  }
    ...
    if (jsonElement == null) {
      if (!Workflow.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in Workflow is not found in the empty JSON string",
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!Workflow.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `Workflow` properties. JSON: %s", entry.getKey(),
    ...
    if (jsonObj.get("schemes") != null && !jsonObj.get("schemes").isJsonNull()) {
      ...
      if (jsonArrayschemes != null) {
        ...
        if (!jsonObj.get("schemes").isJsonArray()) {
          throw new IllegalArgumentException(
              String.format(Locale.ROOT, "Expected the field `schemes` to be an array in the JSON string but got `%s`",
                  jsonObj.get("schemes").toString()));
        }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<Workflow> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(Workflow.class));

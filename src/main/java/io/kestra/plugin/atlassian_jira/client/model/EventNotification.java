...
import io.kestra.plugin.atlassian_jira.client.model.UserDetails;
...
public class EventNotification {
  ...
  /**
   * As a group&#39;s name can change, use of &#x60;recipient&#x60; is
   * recommended. The identifier associated with the &#x60;notificationType&#x60;
   * value that defines the receiver of the notification, where the receiver
   * isn&#39;t implied by &#x60;notificationType&#x60; value. So, when
   * &#x60;notificationType&#x60; is: * &#x60;User&#x60; The &#x60;parameter&#x60;
   * is the user account ID. * &#x60;Group&#x60; The &#x60;parameter&#x60; is the
   * group name. * &#x60;ProjectRole&#x60; The &#x60;parameter&#x60; is the
   * project role ID. * &#x60;UserCustomField&#x60; The &#x60;parameter&#x60; is
   * the ID of the custom field. * &#x60;GroupCustomField&#x60; The
   * &#x60;parameter&#x60; is the ID of the custom field.
   * 
   * @return parameter
   */
  @javax.annotation.Nullable
   ...
   * implied by the &#x60;notificationType&#x60; value. So, when
   * &#x60;notificationType&#x60; is: * &#x60;User&#x60;, &#x60;recipient&#x60; is
   * the user account ID. * &#x60;Group&#x60;, &#x60;recipient&#x60; is the group
   * ID. * &#x60;ProjectRole&#x60;, &#x60;recipient&#x60; is the project role ID.
   * * &#x60;UserCustomField&#x60;, &#x60;recipient&#x60; is the ID of the custom
   * field. * &#x60;GroupCustomField&#x60;, &#x60;recipient&#x60; is the ID of the
   * custom field.
   * 
   * @return recipient
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(emailAddress, expand, field, group, id, notificationType, parameter, projectRole, recipient,
        user);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("emailAddress", "expand", "field", "group", "id",
        "notificationType", "parameter", "projectRole", "recipient", "user"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!EventNotification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in EventNotification is not found in the empty JSON string",
            EventNotification.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!EventNotification.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `EventNotification` properties. JSON: %s",
            entry.getKey(), jsonElement.toString()));
      }
    }
    JsonObject jsonObj = jsonElement.getAsJsonObject();
    if ((jsonObj.get("emailAddress") != null && !jsonObj.get("emailAddress").isJsonNull())
        && !jsonObj.get("emailAddress").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
    ...
    if ((jsonObj.get("recipient") != null && !jsonObj.get("recipient").isJsonNull())
        && !jsonObj.get("recipient").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `recipient` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("recipient").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<EventNotification> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(EventNotification.class));

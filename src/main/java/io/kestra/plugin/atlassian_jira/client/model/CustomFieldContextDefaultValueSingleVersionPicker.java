...
public class CustomFieldContextDefaultValueSingleVersionPicker {
  ...
  public CustomFieldContextDefaultValueSingleVersionPicker versionOrder(
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CustomFieldContextDefaultValueSingleVersionPicker.openapiRequiredFields.isEmpty()) { // has required fields
                                                                                                // but JSON element is
                                                                                                // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CustomFieldContextDefaultValueSingleVersionPicker is not found in the empty JSON string",
            CustomFieldContextDefaultValueSingleVersionPicker.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CustomFieldContextDefaultValueSingleVersionPicker.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CustomFieldContextDefaultValueSingleVersionPicker` properties. JSON: %s",
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!CustomFieldContextDefaultValueSingleVersionPicker.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes
                     // 'CustomFieldContextDefaultValueSingleVersionPicker' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<CustomFieldContextDefaultValueSingleVersionPicker> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CustomFieldContextDefaultValueSingleVersionPicker.class));
  ...
  /**
   * Create an instance of CustomFieldContextDefaultValueSingleVersionPicker given
   * an JSON string
   *
  ...
  /**
   * Convert an instance of CustomFieldContextDefaultValueSingleVersionPicker to
   * an JSON string
   *
   * @return JSON string
   */

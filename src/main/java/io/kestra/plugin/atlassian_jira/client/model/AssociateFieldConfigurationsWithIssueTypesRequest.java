...
import io.kestra.plugin.atlassian_jira.client.model.FieldConfigurationToIssueTypeMapping;
...
public class AssociateFieldConfigurationsWithIssueTypesRequest {
  ...
  public AssociateFieldConfigurationsWithIssueTypesRequest mappings(
      @javax.annotation.Nonnull Set<FieldConfigurationToIssueTypeMapping> mappings) {
    this.mappings = mappings;
    return this;
  }

  public AssociateFieldConfigurationsWithIssueTypesRequest addMappingsItem(
      FieldConfigurationToIssueTypeMapping mappingsItem) {
  ...
  public void setMappings(@javax.annotation.Nonnull Set<FieldConfigurationToIssueTypeMapping> mappings) {
    this.mappings = mappings;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!AssociateFieldConfigurationsWithIssueTypesRequest.openapiRequiredFields.isEmpty()) { // has required fields
                                                                                                // but JSON element is
                                                                                                // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in AssociateFieldConfigurationsWithIssueTypesRequest is not found in the empty JSON string",
            AssociateFieldConfigurationsWithIssueTypesRequest.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!AssociateFieldConfigurationsWithIssueTypesRequest.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `AssociateFieldConfigurationsWithIssueTypesRequest` properties. JSON: %s",
    ...
    if (!jsonObj.get("mappings").isJsonArray()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `mappings` to be an array in the JSON string but got `%s`",
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!AssociateFieldConfigurationsWithIssueTypesRequest.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes
                     // 'AssociateFieldConfigurationsWithIssueTypesRequest' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<AssociateFieldConfigurationsWithIssueTypesRequest> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(AssociateFieldConfigurationsWithIssueTypesRequest.class));
  ...
  /**
   * Create an instance of AssociateFieldConfigurationsWithIssueTypesRequest given
   * an JSON string
   *
  ...
  /**
   * Convert an instance of AssociateFieldConfigurationsWithIssueTypesRequest to
   * an JSON string
   *
   * @return JSON string
   */

...
public class MandatoryFieldValue {
  ...
  /**
   * Will treat as &#x60;MandatoryFieldValue&#x60; if type is &#x60;raw&#x60; or
   * &#x60;empty&#x60;
   */
  ...
  /**
   * Value for each field. Provide a &#x60;list of strings&#x60; for non-ADF
   * fields.
   * 
   * @return value
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!MandatoryFieldValue.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in MandatoryFieldValue is not found in the empty JSON string",
            MandatoryFieldValue.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!MandatoryFieldValue.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `MandatoryFieldValue` properties. JSON: %s",
    ...
    if (jsonObj.get("value") == null) {
      ...
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `value` to be an array in the JSON string but got `%s`",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<MandatoryFieldValue> thisAdapter = gson.getDelegateAdapter(this,

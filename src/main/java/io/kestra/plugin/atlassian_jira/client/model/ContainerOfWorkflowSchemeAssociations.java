...
import io.kestra.plugin.atlassian_jira.client.model.WorkflowSchemeAssociations;
...
public class ContainerOfWorkflowSchemeAssociations {
  ...
  public ContainerOfWorkflowSchemeAssociations values(
      @javax.annotation.Nonnull List<WorkflowSchemeAssociations> values) {
    this.values = values;
    return this;
  }
  ...
  public void setValues(@javax.annotation.Nonnull List<WorkflowSchemeAssociations> values) {
    this.values = values;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ContainerOfWorkflowSchemeAssociations.openapiRequiredFields.isEmpty()) { // has required fields but JSON
                                                                                    // element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in ContainerOfWorkflowSchemeAssociations is not found in the empty JSON string",
            ContainerOfWorkflowSchemeAssociations.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ContainerOfWorkflowSchemeAssociations.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ContainerOfWorkflowSchemeAssociations` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!ContainerOfWorkflowSchemeAssociations.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'ContainerOfWorkflowSchemeAssociations' and its
                     // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<ContainerOfWorkflowSchemeAssociations> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(ContainerOfWorkflowSchemeAssociations.class));
  ...
  /**
   * Create an instance of ContainerOfWorkflowSchemeAssociations given an JSON
   * string
   *
  ...
  /**
   * Convert an instance of ContainerOfWorkflowSchemeAssociations to an JSON
   * string
   *
   * @return JSON string
   */

...
import io.kestra.plugin.atlassian_jira.client.model.FieldConfigurationSchemeProjects;
...
public class PageBeanFieldConfigurationSchemeProjects {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PageBeanFieldConfigurationSchemeProjects.openapiRequiredFields.isEmpty()) { // has required fields but JSON
                                                                                       // element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in PageBeanFieldConfigurationSchemeProjects is not found in the empty JSON string",
            PageBeanFieldConfigurationSchemeProjects.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PageBeanFieldConfigurationSchemeProjects.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `PageBeanFieldConfigurationSchemeProjects` properties. JSON: %s",
    ...
    if (jsonObj.get("values") != null && !jsonObj.get("values").isJsonNull()) {
      ...
      if (jsonArrayvalues != null) {
        ...
        for (int i = 0; i < jsonArrayvalues.size(); i++) {
          FieldConfigurationSchemeProjects.validateJsonElement(jsonArrayvalues.get(i));
        }
        ;
      }
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!PageBeanFieldConfigurationSchemeProjects.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'PageBeanFieldConfigurationSchemeProjects' and its
                     // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<PageBeanFieldConfigurationSchemeProjects> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(PageBeanFieldConfigurationSchemeProjects.class));
  ...
  /**
   * Create an instance of PageBeanFieldConfigurationSchemeProjects given an JSON
   * string
   *
  ...
  /**
   * Convert an instance of PageBeanFieldConfigurationSchemeProjects to an JSON
   * string
   *
   * @return JSON string
   */

...
public class CustomFieldContextDefaultValueUpdate {
  ...
  public CustomFieldContextDefaultValueUpdate defaultValues(
      @javax.annotation.Nullable List<CustomFieldContextDefaultValue> defaultValues) {
  ...
  public void setDefaultValues(@javax.annotation.Nullable List<CustomFieldContextDefaultValue> defaultValues) {
    this.defaultValues = defaultValues;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CustomFieldContextDefaultValueUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON
                                                                                   // element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CustomFieldContextDefaultValueUpdate is not found in the empty JSON string",
            CustomFieldContextDefaultValueUpdate.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CustomFieldContextDefaultValueUpdate.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CustomFieldContextDefaultValueUpdate` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!CustomFieldContextDefaultValueUpdate.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'CustomFieldContextDefaultValueUpdate' and its
                     // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<CustomFieldContextDefaultValueUpdate> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CustomFieldContextDefaultValueUpdate.class));
  ...
  /**
   * Create an instance of CustomFieldContextDefaultValueUpdate given an JSON
   * string
   *

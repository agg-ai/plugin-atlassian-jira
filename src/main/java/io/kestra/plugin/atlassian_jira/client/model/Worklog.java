...
import io.kestra.plugin.atlassian_jira.client.model.Visibility;
...
public class Worklog {
  ...
  /**
   * The datetime on which the worklog effort was started. Required when creating
   * a worklog. Optional when updating a worklog.
   * 
   * @return started
   */
  @javax.annotation.Nullable
   ...
   * worklog if &#x60;timeSpent&#x60; isn&#39;t provided. Optional when updating a
   * worklog. Cannot be provided if &#x60;timeSpent&#x60; is provided.
   * 
  ...
  @Override
  public int hashCode() {
    return Objects.hash(author, comment, created, id, issueId, properties, self, started, timeSpent, timeSpentSeconds,
        updateAuthor, updated, visibility, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("author", "comment", "created", "id", "issueId", "properties",
        "self", "started", "timeSpent", "timeSpentSeconds", "updateAuthor", "updated", "visibility"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!Worklog.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in Worklog is not found in the empty JSON string",
                Worklog.openapiRequiredFields.toString()));
      }
    }
    ...
    if ((jsonObj.get("issueId") != null && !jsonObj.get("issueId").isJsonNull())
        && !jsonObj.get("issueId").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `issueId` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("issueId").toString()));
    }
    if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()) {
      ...
      if (jsonArrayproperties != null) {
        ...
        if (!jsonObj.get("properties").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `properties` to be an array in the JSON string but got `%s`",
    ...
    if ((jsonObj.get("timeSpent") != null && !jsonObj.get("timeSpent").isJsonNull())
        && !jsonObj.get("timeSpent").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `timeSpent` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("timeSpent").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<Worklog> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(Worklog.class));

...
import io.kestra.plugin.atlassian_jira.client.model.BulkEditActionError;
...
public class BulkEditShareableEntityResponse {
  ...
  public BulkEditShareableEntityResponse entityErrors(
      @javax.annotation.Nullable Map<String, BulkEditActionError> entityErrors) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!BulkEditShareableEntityResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                              // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in BulkEditShareableEntityResponse is not found in the empty JSON string",
            BulkEditShareableEntityResponse.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!BulkEditShareableEntityResponse.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `BulkEditShareableEntityResponse` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<BulkEditShareableEntityResponse> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(BulkEditShareableEntityResponse.class));

...
import io.kestra.plugin.atlassian_jira.client.model.GetCrossProjectReleaseResponse;
import io.kestra.plugin.atlassian_jira.client.model.GetCustomFieldResponse;
import io.kestra.plugin.atlassian_jira.client.model.GetExclusionRulesResponse;
import io.kestra.plugin.atlassian_jira.client.model.GetIssueSourceResponse;
import io.kestra.plugin.atlassian_jira.client.model.GetPermissionResponse;
import io.kestra.plugin.atlassian_jira.client.model.GetSchedulingResponse;
...
public class GetPlanResponse {
  ...
  /**
   * The plan status. This is \&quot;Active\&quot;, \&quot;Trashed\&quot; or
   * \&quot;Archived\&quot;.
   */
  ...
  public GetPlanResponse crossProjectReleases(
      @javax.annotation.Nullable List<GetCrossProjectReleaseResponse> crossProjectReleases) {
  ...
  public void setCrossProjectReleases(
      @javax.annotation.Nullable List<GetCrossProjectReleaseResponse> crossProjectReleases) {
    this.crossProjectReleases = crossProjectReleases;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(crossProjectReleases, customFields, exclusionRules, id, issueSources, lastSaved, leadAccountId,
        name, permissions, scheduling, status);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("crossProjectReleases", "customFields", "exclusionRules", "id",
        "issueSources", "lastSaved", "leadAccountId", "name", "permissions", "scheduling", "status"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!GetPlanResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in GetPlanResponse is not found in the empty JSON string",
            GetPlanResponse.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!GetPlanResponse.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `GetPlanResponse` properties. JSON: %s",
    ...
    if (jsonObj.get("crossProjectReleases") != null && !jsonObj.get("crossProjectReleases").isJsonNull()) {
      ...
      if (jsonArraycrossProjectReleases != null) {
        ...
        if (!jsonObj.get("crossProjectReleases").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `crossProjectReleases` to be an array in the JSON string but got `%s`",
              jsonObj.get("crossProjectReleases").toString()));
        }
    ...
    if (jsonObj.get("customFields") != null && !jsonObj.get("customFields").isJsonNull()) {
      ...
      if (jsonArraycustomFields != null) {
        ...
        if (!jsonObj.get("customFields").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `customFields` to be an array in the JSON string but got `%s`",
              jsonObj.get("customFields").toString()));
        }
    ...
    if (jsonObj.get("issueSources") != null && !jsonObj.get("issueSources").isJsonNull()) {
      ...
      if (jsonArrayissueSources != null) {
        ...
        if (!jsonObj.get("issueSources").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `issueSources` to be an array in the JSON string but got `%s`",
              jsonObj.get("issueSources").toString()));
        }
    ...
    if ((jsonObj.get("lastSaved") != null && !jsonObj.get("lastSaved").isJsonNull())
        && !jsonObj.get("lastSaved").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `lastSaved` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("lastSaved").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<GetPlanResponse> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(GetPlanResponse.class));

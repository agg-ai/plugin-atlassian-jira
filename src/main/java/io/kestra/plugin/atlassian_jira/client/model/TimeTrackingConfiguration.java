...
public class TimeTrackingConfiguration {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("defaultUnit", "timeFormat", "workingDaysPerWeek", "workingHoursPerDay"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!TimeTrackingConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in TimeTrackingConfiguration is not found in the empty JSON string",
            TimeTrackingConfiguration.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!TimeTrackingConfiguration.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `TimeTrackingConfiguration` properties. JSON: %s",
    ...
    if (!jsonObj.get("defaultUnit").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `defaultUnit` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("defaultUnit").toString()));
    }
    ...
    if (!jsonObj.get("timeFormat").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `timeFormat` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("timeFormat").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<TimeTrackingConfiguration> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(TimeTrackingConfiguration.class));

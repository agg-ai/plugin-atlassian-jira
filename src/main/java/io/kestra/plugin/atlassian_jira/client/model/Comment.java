...
public class Comment {
  ...
  /**
   * Whether the comment was added from an email sent by a person who is not part
   * of the issue. See [Allow external emails to be added as comments on
   ...
   * doesn&#39;t use Jira Service Desk or the project isn&#39;t a Jira Service
   * Desk project and, therefore, there is no Jira Service Desk for the issue to
   * be visible on. To create a comment with its visibility in Jira Service Desk
  ...
  @Override
  public int hashCode() {
    return Objects.hash(author, body, created, id, jsdAuthorCanSeeRequest, jsdPublic, properties, renderedBody, self,
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("author", "body", "created", "id", "jsdAuthorCanSeeRequest",
        "jsdPublic", "properties", "renderedBody", "self", "updateAuthor", "updated", "visibility"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!Comment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in Comment is not found in the empty JSON string",
                Comment.openapiRequiredFields.toString()));
      }
    }
    ...
    if ((jsonObj.get("renderedBody") != null && !jsonObj.get("renderedBody").isJsonNull())
        && !jsonObj.get("renderedBody").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `renderedBody` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("renderedBody").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<Comment> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(Comment.class));

...
public class WorkflowSchemeIdName {
  ...
  public WorkflowSchemeIdName id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public WorkflowSchemeIdName name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!WorkflowSchemeIdName.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in WorkflowSchemeIdName is not found in the empty JSON string",
            WorkflowSchemeIdName.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!WorkflowSchemeIdName.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `WorkflowSchemeIdName` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<WorkflowSchemeIdName> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(WorkflowSchemeIdName.class));

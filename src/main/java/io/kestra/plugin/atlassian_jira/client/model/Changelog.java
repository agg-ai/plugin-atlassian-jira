...
import io.kestra.plugin.atlassian_jira.client.model.ChangeDetails;
...
public class Changelog {
    ...
    if (jsonElement == null) {
      if (!Changelog.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in Changelog is not found in the empty JSON string",
                Changelog.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!Changelog.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `Changelog` properties. JSON: %s", entry.getKey(),
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<Changelog> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(Changelog.class));

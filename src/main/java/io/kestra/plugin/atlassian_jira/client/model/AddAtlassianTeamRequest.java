...
public class AddAtlassianTeamRequest {
  ...
  /**
   * The planning style for the Atlassian team. This must be \&quot;Scrum\&quot;
   * or \&quot;Kanban\&quot;.
   */
  ...
  public AddAtlassianTeamRequest id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public AddAtlassianTeamRequest issueSourceId(@javax.annotation.Nullable Long issueSourceId) {
  ...
  public AddAtlassianTeamRequest planningStyle(@javax.annotation.Nonnull PlanningStyleEnum planningStyle) {
  ...
  public AddAtlassianTeamRequest sprintLength(@javax.annotation.Nullable Long sprintLength) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!AddAtlassianTeamRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in AddAtlassianTeamRequest is not found in the empty JSON string",
            AddAtlassianTeamRequest.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!AddAtlassianTeamRequest.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `AddAtlassianTeamRequest` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<AddAtlassianTeamRequest> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(AddAtlassianTeamRequest.class));

...
import io.kestra.plugin.atlassian_jira.client.model.IssueFieldOptionConfiguration;
...
public class IssueFieldOptionCreateBean {
  ...
  /**
   * The properties of the option as arbitrary key-value pairs. These properties
   * can be searched using JQL, if the extractions (see
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("config", "properties", "value"));
    ...
    if (jsonElement == null) {
      if (!IssueFieldOptionCreateBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssueFieldOptionCreateBean is not found in the empty JSON string",
            IssueFieldOptionCreateBean.openapiRequiredFields.toString()));
      }
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssueFieldOptionCreateBean> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssueFieldOptionCreateBean.class));

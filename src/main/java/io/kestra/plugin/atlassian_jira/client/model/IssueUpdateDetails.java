...
import io.kestra.plugin.atlassian_jira.client.model.HistoryMetadata;
...
public class IssueUpdateDetails {
   ...
   * setting a sub-field. When multiple sub-fields or other operations are
   * required, use &#x60;update&#x60;. Fields included in here cannot be included
   * in &#x60;update&#x60;.
   * 
   * @return fields
   */
   ...
   * the issue screen field. Note that fields included in here cannot be included
   * in &#x60;fields&#x60;.
   * 
   * @return update
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("fields", "historyMetadata", "properties", "transition", "update"));
    ...
    if (jsonElement == null) {
      if (!IssueUpdateDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssueUpdateDetails is not found in the empty JSON string",
            IssueUpdateDetails.openapiRequiredFields.toString()));
      }
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssueUpdateDetails> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssueUpdateDetails.class));

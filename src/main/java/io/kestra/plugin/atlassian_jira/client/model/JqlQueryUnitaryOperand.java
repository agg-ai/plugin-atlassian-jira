...
public class JqlQueryUnitaryOperand extends AbstractOpenApiSchema {
            ...
            return (TypeAdapter<T>) new TypeAdapter<JqlQueryUnitaryOperand>() {
                ...
                public void write(JsonWriter out, JqlQueryUnitaryOperand value) throws IOException {
                    ...
                    throw new IOException(
                            "Failed to serialize as the type doesn't match anyOf schemas: FunctionOperand, KeywordOperand, ValueOperand");
                }
                ...
                public JqlQueryUnitaryOperand read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format(Locale.ROOT,
                            "Failed deserialization for JqlQueryUnitaryOperand: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s",
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(Locale.ROOT,
                "The JSON string is invalid for JqlQueryUnitaryOperand with anyOf schemas: FunctionOperand, KeywordOperand, ValueOperand. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s",
                errorMessages, jsonElement.toString()));
    }

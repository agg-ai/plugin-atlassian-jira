...
public class SearchRequestBean {
   ...
   * Supported values: * &#x60;strict&#x60; Returns a 400 response code if any
   * errors are found, along with a list of all errors (and warnings). *
   * &#x60;warn&#x60; Returns all errors as warnings. * &#x60;none&#x60; No
   * validation is performed. * &#x60;true&#x60; *Deprecated* A legacy synonym for
   * &#x60;strict&#x60;. * &#x60;false&#x60; *Deprecated* A legacy synonym for
   * &#x60;warn&#x60;. The default is &#x60;strict&#x60;. Note: If the JQL is not
   * correctly formed a 400 response code is returned, regardless of the
   * &#x60;validateQuery&#x60; value.
   */
  ...
  /**
   * Use [expand](#expansion) to include additional information about issues in
   * the response. Note that, unlike the majority of instances where
   * &#x60;expand&#x60; is specified, &#x60;expand&#x60; is defined as a list of
   * values. The expand options are: * &#x60;renderedFields&#x60; Returns field
   * values rendered in HTML format. * &#x60;names&#x60; Returns the display name
   * of each field. * &#x60;schema&#x60; Returns the schema describing a field
   * type. * &#x60;transitions&#x60; Returns all possible transitions for the
   * issue. * &#x60;operations&#x60; Returns all possible operations for the
   * issue. * &#x60;editmeta&#x60; Returns information about how each field can be
   * edited. * &#x60;changelog&#x60; Returns a list of recent updates to an issue,
   * sorted by date, starting from the most recent. *
   * &#x60;versionedRepresentations&#x60; Instead of &#x60;fields&#x60;, returns
   * &#x60;versionedRepresentations&#x60; a JSON array containing each version of
   * a field&#39;s value, with the highest numbered item representing the most
   * recent version.
   * 
   * @return expand
   */
   ...
   * include: * &#x60;*all&#x60; Returns all fields. * &#x60;*navigable&#x60;
   * Returns navigable fields. * Any issue field, prefixed with a minus to
   * exclude. The default is &#x60;*navigable&#x60;. Examples: *
   * &#x60;summary,comment&#x60; Returns the summary and comments fields only. *
   * &#x60;-description&#x60; Returns all navigable (default) fields except
   * description. * &#x60;*all,-comment&#x60; Returns all fields except comments.
   * Multiple &#x60;fields&#x60; parameters can be included in a request. Note:
   * All navigable fields are returned by default. This differs from [GET
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("expand", "fields", "fieldsByKeys", "jql", "maxResults",
        "properties", "startAt", "validateQuery"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!SearchRequestBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in SearchRequestBean is not found in the empty JSON string",
            SearchRequestBean.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!SearchRequestBean.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `SearchRequestBean` properties. JSON: %s",
    ...
    if (jsonObj.get("expand") != null && !jsonObj.get("expand").isJsonNull() && !jsonObj.get("expand").isJsonArray()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `expand` to be an array in the JSON string but got `%s`",
              jsonObj.get("expand").toString()));
    }
    // ensure the optional json data is an array if present
    if (jsonObj.get("fields") != null && !jsonObj.get("fields").isJsonNull() && !jsonObj.get("fields").isJsonArray()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `fields` to be an array in the JSON string but got `%s`",
              jsonObj.get("fields").toString()));
    }
    if ((jsonObj.get("jql") != null && !jsonObj.get("jql").isJsonNull()) && !jsonObj.get("jql").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `jql` to be a primitive type in the JSON string but got `%s`",
              jsonObj.get("jql").toString()));
    }
    // ensure the optional json data is an array if present
    if (jsonObj.get("properties") != null && !jsonObj.get("properties").isJsonNull()
        && !jsonObj.get("properties").isJsonArray()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `properties` to be an array in the JSON string but got `%s`",
              jsonObj.get("properties").toString()));
    }
    if ((jsonObj.get("validateQuery") != null && !jsonObj.get("validateQuery").isJsonNull())
        && !jsonObj.get("validateQuery").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `validateQuery` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("validateQuery").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<SearchRequestBean> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(SearchRequestBean.class));

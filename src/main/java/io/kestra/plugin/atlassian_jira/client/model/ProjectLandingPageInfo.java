...
public class ProjectLandingPageInfo {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(attributes, boardId, boardName, projectKey, projectType, queueCategory, queueId, queueName,
        simpleBoard, simplified, url);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("attributes", "boardId", "boardName", "projectKey", "projectType",
        "queueCategory", "queueId", "queueName", "simpleBoard", "simplified", "url"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ProjectLandingPageInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in ProjectLandingPageInfo is not found in the empty JSON string",
            ProjectLandingPageInfo.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ProjectLandingPageInfo.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ProjectLandingPageInfo` properties. JSON: %s",
            entry.getKey(), jsonElement.toString()));
      }
    }
    JsonObject jsonObj = jsonElement.getAsJsonObject();
    if ((jsonObj.get("boardName") != null && !jsonObj.get("boardName").isJsonNull())
        && !jsonObj.get("boardName").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `boardName` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("boardName").toString()));
    }
    if ((jsonObj.get("projectKey") != null && !jsonObj.get("projectKey").isJsonNull())
        && !jsonObj.get("projectKey").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `projectKey` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("projectKey").toString()));
    }
    ...
    if ((jsonObj.get("queueCategory") != null && !jsonObj.get("queueCategory").isJsonNull())
        && !jsonObj.get("queueCategory").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `queueCategory` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("queueCategory").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ProjectLandingPageInfo> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(ProjectLandingPageInfo.class));

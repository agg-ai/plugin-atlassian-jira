...
public class RetryingOAuth extends OAuth implements Interceptor {
     ...
     *                     Applicable to the following OAuth2 flows: "password",
     ...
     * @param clientSecret The OAuth2 client secret for the "clientCredentials"
     *                     flow.
    ...
    private Response retryingIntercept(Chain chain, boolean updateTokenAndRetryOnAuthorizationFailure)
        ...
        // If the request already has an authorization (e.g. Basic auth), proceed with
        // the request as is
        ...
        if (getAccessToken() != null) {
            ...
            // 401/403 response codes most likely indicate an expired access token, unless
            // it happens two times in a row
            if (response != null &&
    ...
    public synchronized boolean updateAccessToken(String requestAccessToken) throws IOException {
        if (getAccessToken() == null || getAccessToken().equals(requestAccessToken)) {
            try {
                OAuthJSONAccessTokenResponse accessTokenResponse = oAuthClient
                        .accessToken(tokenRequestBuilder.buildBodyMessage());
    ...
    // Applying authorization to parameters is performed in the retryingIntercept
    // method
    @Override

...
import io.kestra.plugin.atlassian_jira.client.model.NestedResponse;
...
public class CreatedIssue {
    ...
    if (jsonElement == null) {
      if (!CreatedIssue.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in CreatedIssue is not found in the empty JSON string",
                CreatedIssue.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CreatedIssue.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CreatedIssue` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<CreatedIssue> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(CreatedIssue.class));

...
public class Application {
   ...
   * icon title to display a tooltip for the link&#39;s icon. The tooltip takes
   * the format \&quot;\\[application name\\] icon title\&quot;. Blank items are
   * excluded from the tooltip title. If both items are blank, the icon tooltop
   * displays as \&quot;Web Link\&quot;. Grouping and sorting of links may place
   * links without an application name last.
   * 
   * @return name
   */
  @javax.annotation.Nullable
    ...
    if (jsonElement == null) {
      if (!Application.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in Application is not found in the empty JSON string",
                Application.openapiRequiredFields.toString()));
      }
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<Application> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(Application.class));

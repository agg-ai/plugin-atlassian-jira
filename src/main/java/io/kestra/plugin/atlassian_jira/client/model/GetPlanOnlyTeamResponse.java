...
public class GetPlanOnlyTeamResponse {
  ...
  /**
   * The planning style for the plan-only team. This is \&quot;Scrum\&quot; or
   * \&quot;Kanban\&quot;.
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("capacity", "id", "issueSourceId", "memberAccountIds", "name", "planningStyle", "sprintLength"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!GetPlanOnlyTeamResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in GetPlanOnlyTeamResponse is not found in the empty JSON string",
            GetPlanOnlyTeamResponse.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!GetPlanOnlyTeamResponse.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `GetPlanOnlyTeamResponse` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<GetPlanOnlyTeamResponse> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(GetPlanOnlyTeamResponse.class));

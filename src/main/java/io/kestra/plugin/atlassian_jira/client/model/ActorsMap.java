...
public class ActorsMap {
   ...
   * &#x60;groupId&#x60; parameter. As a group&#39;s name can change, use of
    ...
    if (jsonElement == null) {
      if (!ActorsMap.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in ActorsMap is not found in the empty JSON string",
                ActorsMap.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ActorsMap.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ActorsMap` properties. JSON: %s", entry.getKey(),
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ActorsMap> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(ActorsMap.class));

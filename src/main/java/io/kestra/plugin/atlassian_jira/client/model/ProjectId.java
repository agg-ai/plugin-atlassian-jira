...
public class ProjectId {
  ...
  public ProjectId id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
    ...
    if (jsonElement == null) {
      if (!ProjectId.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in ProjectId is not found in the empty JSON string",
                ProjectId.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ProjectId.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ProjectId` properties. JSON: %s", entry.getKey(),
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ProjectId> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(ProjectId.class));

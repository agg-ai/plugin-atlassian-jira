...
public class CustomFieldContextDefaultValueSingleGroupPicker {
  ...
  public CustomFieldContextDefaultValueSingleGroupPicker contextId(@javax.annotation.Nonnull String contextId) {
  ...
  public CustomFieldContextDefaultValueSingleGroupPicker groupId(@javax.annotation.Nonnull String groupId) {
  ...
  public CustomFieldContextDefaultValueSingleGroupPicker type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("contextId", "groupId", "type"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("contextId", "groupId", "type"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CustomFieldContextDefaultValueSingleGroupPicker.openapiRequiredFields.isEmpty()) { // has required fields but
                                                                                              // JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CustomFieldContextDefaultValueSingleGroupPicker is not found in the empty JSON string",
            CustomFieldContextDefaultValueSingleGroupPicker.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CustomFieldContextDefaultValueSingleGroupPicker.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CustomFieldContextDefaultValueSingleGroupPicker` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!CustomFieldContextDefaultValueSingleGroupPicker.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'CustomFieldContextDefaultValueSingleGroupPicker'
                     // and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<CustomFieldContextDefaultValueSingleGroupPicker> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CustomFieldContextDefaultValueSingleGroupPicker.class));
  ...
  /**
   * Create an instance of CustomFieldContextDefaultValueSingleGroupPicker given
   * an JSON string
   *
  ...
  /**
   * Convert an instance of CustomFieldContextDefaultValueSingleGroupPicker to an
   * JSON string
   *
   * @return JSON string
   */

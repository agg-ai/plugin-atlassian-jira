...
public class HistoryMetadataParticipant {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("avatarUrl", "displayName", "displayNameKey", "id", "type", "url"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!HistoryMetadataParticipant.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in HistoryMetadataParticipant is not found in the empty JSON string",
            HistoryMetadataParticipant.openapiRequiredFields.toString()));
      }
    }
    ...
    if ((jsonObj.get("displayNameKey") != null && !jsonObj.get("displayNameKey").isJsonNull())
        && !jsonObj.get("displayNameKey").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `displayNameKey` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("displayNameKey").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<HistoryMetadataParticipant> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(HistoryMetadataParticipant.class));

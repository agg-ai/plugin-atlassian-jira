...
public class IssueBulkDeletePayload {
   ...
   * when the issues are being deleted. If &#x60;true&#x60;, dispatches a bulk
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("selectedIssueIdsOrKeys", "sendBulkNotification"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!IssueBulkDeletePayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssueBulkDeletePayload is not found in the empty JSON string",
            IssueBulkDeletePayload.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!IssueBulkDeletePayload.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `IssueBulkDeletePayload` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssueBulkDeletePayload> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssueBulkDeletePayload.class));

...
import io.kestra.plugin.atlassian_jira.client.model.BulkRedactionResponse;
...
public class RedactionJobStatusResponse {
  ...
  public RedactionJobStatusResponse bulkRedactionResponse(
      @javax.annotation.Nullable BulkRedactionResponse bulkRedactionResponse) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!RedactionJobStatusResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in RedactionJobStatusResponse is not found in the empty JSON string",
            RedactionJobStatusResponse.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!RedactionJobStatusResponse.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `RedactionJobStatusResponse` properties. JSON: %s",
    ...
    if ((jsonObj.get("jobStatus") != null && !jsonObj.get("jobStatus").isJsonNull())
        && !jsonObj.get("jobStatus").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `jobStatus` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("jobStatus").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<RedactionJobStatusResponse> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(RedactionJobStatusResponse.class));

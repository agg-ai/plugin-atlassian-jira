...
public class IssueTypeSchemeProjects {
  ...
  public IssueTypeSchemeProjects issueTypeScheme(@javax.annotation.Nonnull IssueTypeScheme issueTypeScheme) {
  ...
  public void setIssueTypeScheme(@javax.annotation.Nonnull IssueTypeScheme issueTypeScheme) {
    this.issueTypeScheme = issueTypeScheme;
  }

  public IssueTypeSchemeProjects projectIds(@javax.annotation.Nonnull List<String> projectIds) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("issueTypeScheme", "projectIds"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("issueTypeScheme", "projectIds"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!IssueTypeSchemeProjects.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssueTypeSchemeProjects is not found in the empty JSON string",
            IssueTypeSchemeProjects.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!IssueTypeSchemeProjects.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `IssueTypeSchemeProjects` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssueTypeSchemeProjects> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssueTypeSchemeProjects.class));

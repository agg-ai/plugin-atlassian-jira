...
public class CreatePlanOnlyTeamRequest {
  ...
  /**
   * The planning style for the plan-only team. This must be \&quot;Scrum\&quot;
   * or \&quot;Kanban\&quot;.
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("capacity", "issueSourceId", "memberAccountIds", "name", "planningStyle", "sprintLength"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "planningStyle"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CreatePlanOnlyTeamRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CreatePlanOnlyTeamRequest is not found in the empty JSON string",
            CreatePlanOnlyTeamRequest.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CreatePlanOnlyTeamRequest.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CreatePlanOnlyTeamRequest` properties. JSON: %s",
    ...
    if (jsonObj.get("memberAccountIds") != null && !jsonObj.get("memberAccountIds").isJsonNull()
        && !jsonObj.get("memberAccountIds").isJsonArray()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `memberAccountIds` to be an array in the JSON string but got `%s`",
          jsonObj.get("memberAccountIds").toString()));
    }
    ...
    if (!jsonObj.get("planningStyle").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `planningStyle` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("planningStyle").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<CreatePlanOnlyTeamRequest> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CreatePlanOnlyTeamRequest.class));

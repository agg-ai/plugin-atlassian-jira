...
public class CustomFieldDefinitionJsonBean {
   ...
   * *com.atlassian.jira.plugin.system.customfieldtypes:grouppickersearcher*. The
   * search UI (basic search and JQL search) will display different operations and
   * values for the field, based on the field searcher. You must specify a
   * searcher that is valid for the field type, as listed below (abbreviated
   * values shown): * &#x60;cascadingselect&#x60;:
   * &#x60;cascadingselectsearcher&#x60; * &#x60;datepicker&#x60;:
   * &#x60;daterange&#x60; * &#x60;datetime&#x60;: &#x60;datetimerange&#x60; *
   * &#x60;float&#x60;: &#x60;exactnumber&#x60; or &#x60;numberrange&#x60; *
   * &#x60;grouppicker&#x60;: &#x60;grouppickersearcher&#x60; *
   * &#x60;importid&#x60;: &#x60;exactnumber&#x60; or &#x60;numberrange&#x60; *
   * &#x60;labels&#x60;: &#x60;labelsearcher&#x60; * &#x60;multicheckboxes&#x60;:
   * &#x60;multiselectsearcher&#x60; * &#x60;multigrouppicker&#x60;:
   * &#x60;multiselectsearcher&#x60; * &#x60;multiselect&#x60;:
   * &#x60;multiselectsearcher&#x60; * &#x60;multiuserpicker&#x60;:
   * &#x60;userpickergroupsearcher&#x60; * &#x60;multiversion&#x60;:
   * &#x60;versionsearcher&#x60; * &#x60;project&#x60;:
   * &#x60;projectsearcher&#x60; * &#x60;radiobuttons&#x60;:
   * &#x60;multiselectsearcher&#x60; * &#x60;readonlyfield&#x60;:
   * &#x60;textsearcher&#x60; * &#x60;select&#x60;:
   * &#x60;multiselectsearcher&#x60; * &#x60;textarea&#x60;:
   * &#x60;textsearcher&#x60; * &#x60;textfield&#x60;: &#x60;textsearcher&#x60; *
   * &#x60;url&#x60;: &#x60;exacttextsearcher&#x60; * &#x60;userpicker&#x60;:
   * &#x60;userpickergroupsearcher&#x60; * &#x60;version&#x60;:
   * &#x60;versionsearcher&#x60; If no searcher is provided, the field isn&#39;t
   * searchable. However, [Forge custom
   ...
   * available: * &#x60;cascadingselect&#x60;: Enables values to be selected from
   * two levels of select lists (value:
   ...
   * &#x60;importid&#x60;: A read-only field that stores the ID the issue had in
   * the system it was imported from (value:
   ...
   * &#x60;&#x60;) * &#x60;multigrouppicker&#x60;: Stores multiple user groups
   * using a picker control (value: &#x60;&#x60;) * &#x60;multiselect&#x60;:
   * Stores multiple values using a select list (value:
   * &#x60;com.atlassian.jira.plugin.system.customfieldtypes:multicheckboxes&#x60;)
   * * &#x60;multiuserpicker&#x60;: Stores multiple users using a picker control
   * (value:
   * &#x60;com.atlassian.jira.plugin.system.customfieldtypes:multigrouppicker&#x60;)
   * * &#x60;multiversion&#x60;: Stores multiple versions from the versions
   * available in a project using a picker control (value:
   * &#x60;com.atlassian.jira.plugin.system.customfieldtypes:multiversion&#x60;) *
   * &#x60;project&#x60;: Stores a project from a list of projects that the user
   * is permitted to view (value:
   ...
   * &#x60;com.atlassian.jira.plugin.system.customfieldtypes:version&#x60;) To
   * create a field based on a [Forge custom field
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CustomFieldDefinitionJsonBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                            // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CustomFieldDefinitionJsonBean is not found in the empty JSON string",
            CustomFieldDefinitionJsonBean.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CustomFieldDefinitionJsonBean.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CustomFieldDefinitionJsonBean` properties. JSON: %s",
    ...
    if ((jsonObj.get("searcherKey") != null && !jsonObj.get("searcherKey").isJsonNull())
        && !jsonObj.get("searcherKey").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `searcherKey` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("searcherKey").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<CustomFieldDefinitionJsonBean> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CustomFieldDefinitionJsonBean.class));

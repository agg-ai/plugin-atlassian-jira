...
import io.kestra.plugin.atlassian_jira.client.model.MappingsByIssueTypeOverride;
import io.kestra.plugin.atlassian_jira.client.model.MappingsByWorkflow;
import io.kestra.plugin.atlassian_jira.client.model.WorkflowSchemeAssociation;
...
public class WorkflowSchemeUpdateRequest {
   ...
   * &#x60;defaultWorkflowId&#x60; isn&#39;t specified, this is set to *Jira
   * Workflow (jira)*.
   * 
  ...
  public WorkflowSchemeUpdateRequest statusMappingsByIssueTypeOverride(
      @javax.annotation.Nullable List<MappingsByIssueTypeOverride> statusMappingsByIssueTypeOverride) {
    this.statusMappingsByIssueTypeOverride = statusMappingsByIssueTypeOverride;
    return this;
  }

  public WorkflowSchemeUpdateRequest addStatusMappingsByIssueTypeOverrideItem(
      MappingsByIssueTypeOverride statusMappingsByIssueTypeOverrideItem) {
   ...
   * &#x60;statusMappingsByWorkflows&#x60;. Status mappings are required when the
  ...
  public void setStatusMappingsByIssueTypeOverride(
      @javax.annotation.Nullable List<MappingsByIssueTypeOverride> statusMappingsByIssueTypeOverride) {
    this.statusMappingsByIssueTypeOverride = statusMappingsByIssueTypeOverride;
  }

  public WorkflowSchemeUpdateRequest statusMappingsByWorkflows(
      @javax.annotation.Nullable List<MappingsByWorkflow> statusMappingsByWorkflows) {
    this.statusMappingsByWorkflows = statusMappingsByWorkflows;
    return this;
  }

  public WorkflowSchemeUpdateRequest addStatusMappingsByWorkflowsItem(
      MappingsByWorkflow statusMappingsByWorkflowsItem) {
  ...
  public void setStatusMappingsByWorkflows(
      @javax.annotation.Nullable List<MappingsByWorkflow> statusMappingsByWorkflows) {
    this.statusMappingsByWorkflows = statusMappingsByWorkflows;
  }
  ...
  public WorkflowSchemeUpdateRequest workflowsForIssueTypes(
      @javax.annotation.Nullable List<WorkflowSchemeAssociation> workflowsForIssueTypes) {
    this.workflowsForIssueTypes = workflowsForIssueTypes;
    return this;
  }

  public WorkflowSchemeUpdateRequest addWorkflowsForIssueTypesItem(
      WorkflowSchemeAssociation workflowsForIssueTypesItem) {
  ...
  public void setWorkflowsForIssueTypes(
      @javax.annotation.Nullable List<WorkflowSchemeAssociation> workflowsForIssueTypes) {
    this.workflowsForIssueTypes = workflowsForIssueTypes;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.defaultWorkflowId, workflowSchemeUpdateRequest.defaultWorkflowId) &&
        ...
        Objects.equals(this.statusMappingsByIssueTypeOverride,
            workflowSchemeUpdateRequest.statusMappingsByIssueTypeOverride)
        &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(defaultWorkflowId, description, id, name, statusMappingsByIssueTypeOverride,
        statusMappingsByWorkflows, version, workflowsForIssueTypes, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    statusMappingsByIssueTypeOverride: ").append(toIndentedString(statusMappingsByIssueTypeOverride))
        .append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("defaultWorkflowId", "description", "id", "name",
        "statusMappingsByIssueTypeOverride", "statusMappingsByWorkflows", "version", "workflowsForIssueTypes"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!WorkflowSchemeUpdateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                          // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in WorkflowSchemeUpdateRequest is not found in the empty JSON string",
            WorkflowSchemeUpdateRequest.openapiRequiredFields.toString()));
      }
    }
    ...
    if ((jsonObj.get("defaultWorkflowId") != null && !jsonObj.get("defaultWorkflowId").isJsonNull())
        && !jsonObj.get("defaultWorkflowId").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `defaultWorkflowId` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("defaultWorkflowId").toString()));
    }
    ...
    if (jsonObj.get("statusMappingsByIssueTypeOverride") != null
        && !jsonObj.get("statusMappingsByIssueTypeOverride").isJsonNull()) {
      JsonArray jsonArraystatusMappingsByIssueTypeOverride = jsonObj
          .getAsJsonArray("statusMappingsByIssueTypeOverride");
      if (jsonArraystatusMappingsByIssueTypeOverride != null) {
        // ensure the json data is an array
        if (!jsonObj.get("statusMappingsByIssueTypeOverride").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `statusMappingsByIssueTypeOverride` to be an array in the JSON string but got `%s`",
              jsonObj.get("statusMappingsByIssueTypeOverride").toString()));
        }
    ...
    if (jsonObj.get("statusMappingsByWorkflows") != null && !jsonObj.get("statusMappingsByWorkflows").isJsonNull()) {
      ...
      if (jsonArraystatusMappingsByWorkflows != null) {
        ...
        if (!jsonObj.get("statusMappingsByWorkflows").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `statusMappingsByWorkflows` to be an array in the JSON string but got `%s`",
              jsonObj.get("statusMappingsByWorkflows").toString()));
        }
    ...
    if (jsonObj.get("workflowsForIssueTypes") != null && !jsonObj.get("workflowsForIssueTypes").isJsonNull()) {
      ...
      if (jsonArrayworkflowsForIssueTypes != null) {
        ...
        if (!jsonObj.get("workflowsForIssueTypes").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `workflowsForIssueTypes` to be an array in the JSON string but got `%s`",
              jsonObj.get("workflowsForIssueTypes").toString()));
        }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<WorkflowSchemeUpdateRequest> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(WorkflowSchemeUpdateRequest.class));
            ...
            if (!openapiFields.contains(entry.getKey())) {
              if (entry.getValue().isJsonPrimitive()) { // primitive type
                if (entry.getValue().getAsJsonPrimitive().isString())
                  ...
                  throw new IllegalArgumentException(
                      String.format(Locale.ROOT, "The field `%s` has unknown primitive type. Value: %s", entry.getKey(),

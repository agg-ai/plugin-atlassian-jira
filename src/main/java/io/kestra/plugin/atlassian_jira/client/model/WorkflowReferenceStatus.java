...
import io.kestra.plugin.atlassian_jira.client.model.ApprovalConfiguration;
import io.kestra.plugin.atlassian_jira.client.model.WorkflowStatusLayout;
...
public class WorkflowReferenceStatus {
  ...
  public WorkflowReferenceStatus approvalConfiguration(
      @javax.annotation.Nullable ApprovalConfiguration approvalConfiguration) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("approvalConfiguration", "deprecated", "layout", "properties", "statusReference"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!WorkflowReferenceStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in WorkflowReferenceStatus is not found in the empty JSON string",
            WorkflowReferenceStatus.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!WorkflowReferenceStatus.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `WorkflowReferenceStatus` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<WorkflowReferenceStatus> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(WorkflowReferenceStatus.class));

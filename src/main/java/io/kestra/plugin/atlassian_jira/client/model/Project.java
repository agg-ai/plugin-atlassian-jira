...
import io.kestra.plugin.atlassian_jira.client.model.AvatarUrlsBean;
import io.kestra.plugin.atlassian_jira.client.model.Hierarchy;
...
import io.kestra.plugin.atlassian_jira.client.model.ProjectInsight;
import io.kestra.plugin.atlassian_jira.client.model.ProjectLandingPageInfo;
import io.kestra.plugin.atlassian_jira.client.model.ProjectPermissions;
...
public class Project {
  ...
  /**
   * Whether the project is private from the user&#39;s perspective. This means
   * the user can&#39;t see the project or any associated issues.
   * 
   * @return isPrivate
   */
  @javax.annotation.Nullable
  ...
  @Override
  public int hashCode() {
    return Objects.hash(archived, archivedBy, archivedDate, assigneeType, avatarUrls, components, deleted, deletedBy,
        deletedDate, description, email, expand, favourite, id, insight, isPrivate, issueTypeHierarchy, issueTypes, key,
        landingPageInfo, lead, name, permissions, projectCategory, projectTypeKey, properties, retentionTillDate, roles,
        self, simplified, style, url, uuid, versions);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("archived", "archivedBy", "archivedDate", "assigneeType",
        "avatarUrls", "components", "deleted", "deletedBy", "deletedDate", "description", "email", "expand",
        "favourite", "id", "insight", "isPrivate", "issueTypeHierarchy", "issueTypes", "key", "landingPageInfo", "lead",
        "name", "permissions", "projectCategory", "projectTypeKey", "properties", "retentionTillDate", "roles", "self",
        "simplified", "style", "url", "uuid", "versions"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!Project.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in Project is not found in the empty JSON string",
    ...
    if ((jsonObj.get("uuid") != null && !jsonObj.get("uuid").isJsonNull()) && !jsonObj.get("uuid").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `uuid` to be a primitive type in the JSON string but got `%s`",
    ...
    if (jsonObj.get("versions") != null && !jsonObj.get("versions").isJsonNull()) {
      ...
      if (jsonArrayversions != null) {
        ...
        if (!jsonObj.get("versions").isJsonArray()) {
          throw new IllegalArgumentException(
              String.format(Locale.ROOT, "Expected the field `versions` to be an array in the JSON string but got `%s`",

...
import io.kestra.plugin.atlassian_jira.client.model.CustomFieldPayload;
import io.kestra.plugin.atlassian_jira.client.model.FieldLayoutPayload;
import io.kestra.plugin.atlassian_jira.client.model.FieldLayoutSchemePayload;
import io.kestra.plugin.atlassian_jira.client.model.IssueLayoutPayload;
import io.kestra.plugin.atlassian_jira.client.model.IssueTypeScreenSchemePayload;
import io.kestra.plugin.atlassian_jira.client.model.ScreenPayload;
import io.kestra.plugin.atlassian_jira.client.model.ScreenSchemePayload;
...
/**
 * Defines the payload for the fields, screens, screen schemes, issue type
 * screen schemes, field layouts, and field layout schemes
 */
...
public class FieldCapabilityPayload {
  ...
  public FieldCapabilityPayload customFieldDefinitions(
      @javax.annotation.Nullable List<CustomFieldPayload> customFieldDefinitions) {
  ...
  public FieldCapabilityPayload fieldLayoutScheme(
      @javax.annotation.Nullable FieldLayoutSchemePayload fieldLayoutScheme) {
  ...
  public FieldCapabilityPayload issueTypeScreenScheme(
      @javax.annotation.Nullable IssueTypeScreenSchemePayload issueTypeScreenScheme) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(customFieldDefinitions, fieldLayoutScheme, fieldLayouts, issueLayouts, issueTypeScreenScheme,
        screenScheme, screens);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("customFieldDefinitions", "fieldLayoutScheme", "fieldLayouts",
        "issueLayouts", "issueTypeScreenScheme", "screenScheme", "screens"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!FieldCapabilityPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in FieldCapabilityPayload is not found in the empty JSON string",
            FieldCapabilityPayload.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!FieldCapabilityPayload.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `FieldCapabilityPayload` properties. JSON: %s",
    ...
    if (jsonObj.get("customFieldDefinitions") != null && !jsonObj.get("customFieldDefinitions").isJsonNull()) {
      ...
      if (jsonArraycustomFieldDefinitions != null) {
        ...
        if (!jsonObj.get("customFieldDefinitions").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `customFieldDefinitions` to be an array in the JSON string but got `%s`",
              jsonObj.get("customFieldDefinitions").toString()));
        }
    ...
    if (jsonObj.get("fieldLayouts") != null && !jsonObj.get("fieldLayouts").isJsonNull()) {
      ...
      if (jsonArrayfieldLayouts != null) {
        ...
        if (!jsonObj.get("fieldLayouts").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `fieldLayouts` to be an array in the JSON string but got `%s`",
              jsonObj.get("fieldLayouts").toString()));
        }
    ...
    if (jsonObj.get("issueLayouts") != null && !jsonObj.get("issueLayouts").isJsonNull()) {
      ...
      if (jsonArrayissueLayouts != null) {
        ...
        if (!jsonObj.get("issueLayouts").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `issueLayouts` to be an array in the JSON string but got `%s`",
              jsonObj.get("issueLayouts").toString()));
        }
    ...
    if (jsonObj.get("screenScheme") != null && !jsonObj.get("screenScheme").isJsonNull()) {
      ...
      if (jsonArrayscreenScheme != null) {
        ...
        if (!jsonObj.get("screenScheme").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `screenScheme` to be an array in the JSON string but got `%s`",
              jsonObj.get("screenScheme").toString()));
        }
      ...
      if (jsonArrayscreens != null) {
        ...
        if (!jsonObj.get("screens").isJsonArray()) {
          throw new IllegalArgumentException(
              String.format(Locale.ROOT, "Expected the field `screens` to be an array in the JSON string but got `%s`",
                  jsonObj.get("screens").toString()));
        }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<FieldCapabilityPayload> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(FieldCapabilityPayload.class));

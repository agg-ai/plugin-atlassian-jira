...
public class ReorderIssueResolutionsRequest {
  ...
  /**
   * The ID of the resolution. Required if &#x60;position&#x60; isn&#39;t
   * provided.
   * 
   * @return after
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("after", "ids", "position"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ReorderIssueResolutionsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                             // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in ReorderIssueResolutionsRequest is not found in the empty JSON string",
            ReorderIssueResolutionsRequest.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ReorderIssueResolutionsRequest.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ReorderIssueResolutionsRequest` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ReorderIssueResolutionsRequest> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(ReorderIssueResolutionsRequest.class));

...
public class WorkflowElementReference {
  ...
  public WorkflowElementReference statusMappingReference(
      @javax.annotation.Nullable ProjectAndIssueTypePair statusMappingReference) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("propertyKey", "ruleId", "statusMappingReference", "statusReference", "transitionId"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!WorkflowElementReference.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in WorkflowElementReference is not found in the empty JSON string",
            WorkflowElementReference.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!WorkflowElementReference.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `WorkflowElementReference` properties. JSON: %s",
            entry.getKey(), jsonElement.toString()));
      }
    }
    JsonObject jsonObj = jsonElement.getAsJsonObject();
    if ((jsonObj.get("propertyKey") != null && !jsonObj.get("propertyKey").isJsonNull())
        && !jsonObj.get("propertyKey").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `propertyKey` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("propertyKey").toString()));
    }
    ...
    if ((jsonObj.get("transitionId") != null && !jsonObj.get("transitionId").isJsonNull())
        && !jsonObj.get("transitionId").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `transitionId` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("transitionId").toString()));
    }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<WorkflowElementReference> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(WorkflowElementReference.class));

...
public class CustomFieldContextDefaultValueMultiUserPicker {
  ...
  public CustomFieldContextDefaultValueMultiUserPicker accountIds(@javax.annotation.Nonnull List<String> accountIds) {
  ...
  public CustomFieldContextDefaultValueMultiUserPicker contextId(@javax.annotation.Nonnull String contextId) {
  ...
  public CustomFieldContextDefaultValueMultiUserPicker type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CustomFieldContextDefaultValueMultiUserPicker.openapiRequiredFields.isEmpty()) { // has required fields but
                                                                                            // JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CustomFieldContextDefaultValueMultiUserPicker is not found in the empty JSON string",
            CustomFieldContextDefaultValueMultiUserPicker.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CustomFieldContextDefaultValueMultiUserPicker.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CustomFieldContextDefaultValueMultiUserPicker` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!CustomFieldContextDefaultValueMultiUserPicker.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'CustomFieldContextDefaultValueMultiUserPicker'
                     // and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<CustomFieldContextDefaultValueMultiUserPicker> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CustomFieldContextDefaultValueMultiUserPicker.class));
  ...
  /**
   * Create an instance of CustomFieldContextDefaultValueMultiUserPicker given an
   * JSON string
   *
  ...
  /**
   * Convert an instance of CustomFieldContextDefaultValueMultiUserPicker to an
   * JSON string
   *
   * @return JSON string
   */

...
import io.kestra.plugin.atlassian_jira.client.model.CustomFieldReplacement;
...
public class DeleteAndReplaceVersionBean {
  ...
  public DeleteAndReplaceVersionBean customFieldReplacementList(
      @javax.annotation.Nullable List<CustomFieldReplacement> customFieldReplacementList) {
    this.customFieldReplacementList = customFieldReplacementList;
    return this;
  }

  public DeleteAndReplaceVersionBean addCustomFieldReplacementListItem(
      CustomFieldReplacement customFieldReplacementListItem) {
  ...
  public void setCustomFieldReplacementList(
      @javax.annotation.Nullable List<CustomFieldReplacement> customFieldReplacementList) {
    this.customFieldReplacementList = customFieldReplacementList;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("customFieldReplacementList", "moveAffectedIssuesTo", "moveFixIssuesTo"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!DeleteAndReplaceVersionBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                          // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in DeleteAndReplaceVersionBean is not found in the empty JSON string",
            DeleteAndReplaceVersionBean.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!DeleteAndReplaceVersionBean.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `DeleteAndReplaceVersionBean` properties. JSON: %s",
    ...
    if (jsonObj.get("customFieldReplacementList") != null && !jsonObj.get("customFieldReplacementList").isJsonNull()) {
      ...
      if (jsonArraycustomFieldReplacementList != null) {
        ...
        if (!jsonObj.get("customFieldReplacementList").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `customFieldReplacementList` to be an array in the JSON string but got `%s`",
              jsonObj.get("customFieldReplacementList").toString()));
        }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<DeleteAndReplaceVersionBean> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(DeleteAndReplaceVersionBean.class));

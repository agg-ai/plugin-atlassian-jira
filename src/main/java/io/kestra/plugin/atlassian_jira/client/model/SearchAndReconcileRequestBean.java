...
public class SearchAndReconcileRequestBean {
   ...
   * &#x60;expand&#x60; is specified, &#x60;expand&#x60; is defined as a
   * comma-delimited string of values. The expand options are: *
   ...
   * * &#x60;changelog&#x60; Returns a list of recent updates to an issue, sorted
   * by date, starting from the most recent. *
   ...
   * recent version. Examples: &#x60;\&quot;names,changelog\&quot;&#x60; Returns
   * the display name of each field as well as a list of recent updates to an
   * issue.
   * 
   * @return expand
   */
   ...
   * Returns navigable fields. * &#x60;id&#x60; Returns only issue IDs. * Any
   * issue field, prefixed with a dash to exclude. The default is &#x60;id&#x60;.
   * Examples: * &#x60;summary,comment&#x60; Returns the summary and comments
   * fields only. * &#x60;*all,-comment&#x60; Returns all fields except comments.
   * Multiple &#x60;fields&#x60; parameters can be included in a request. Note: By
   * default, this resource returns IDs only. This differs from [GET
   ...
   * performance reasons, this parameter requires a bounded query. A bounded query
   * is a query with a search restriction. * Example of an unbounded query:
   * &#x60;order by key desc&#x60;. * Example of a bounded query: &#x60;assignee
   * &#x3D; currentUser() order by key&#x60;. Additionally, &#x60;orderBy&#x60;
   ...
   * greatest number of items returned per page is achieved when requesting
  ...
  /**
   * The token for a page to fetch that is not the first page. The first page has
   * a &#x60;nextPageToken&#x60; of &#x60;null&#x60;. Use the
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("expand", "fields", "fieldsByKeys", "jql", "maxResults",
        "nextPageToken", "properties", "reconcileIssues"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!SearchAndReconcileRequestBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                            // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in SearchAndReconcileRequestBean is not found in the empty JSON string",
            SearchAndReconcileRequestBean.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!SearchAndReconcileRequestBean.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `SearchAndReconcileRequestBean` properties. JSON: %s",
    ...
    // ensure the optional json data is an array if present
    if (jsonObj.get("reconcileIssues") != null && !jsonObj.get("reconcileIssues").isJsonNull()
        && !jsonObj.get("reconcileIssues").isJsonArray()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `reconcileIssues` to be an array in the JSON string but got `%s`",
          jsonObj.get("reconcileIssues").toString()));
    }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<SearchAndReconcileRequestBean> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(SearchAndReconcileRequestBean.class));

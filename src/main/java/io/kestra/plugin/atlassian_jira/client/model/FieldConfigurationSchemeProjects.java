...
public class FieldConfigurationSchemeProjects {
  ...
  public FieldConfigurationSchemeProjects fieldConfigurationScheme(
      @javax.annotation.Nullable FieldConfigurationScheme fieldConfigurationScheme) {
  ...
  public void setFieldConfigurationScheme(
      @javax.annotation.Nullable FieldConfigurationScheme fieldConfigurationScheme) {
    this.fieldConfigurationScheme = fieldConfigurationScheme;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("fieldConfigurationScheme", "projectIds"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("projectIds"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!FieldConfigurationSchemeProjects.openapiRequiredFields.isEmpty()) { // has required fields but JSON element
                                                                               // is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in FieldConfigurationSchemeProjects is not found in the empty JSON string",
            FieldConfigurationSchemeProjects.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!FieldConfigurationSchemeProjects.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `FieldConfigurationSchemeProjects` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!FieldConfigurationSchemeProjects.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'FieldConfigurationSchemeProjects' and its
                     // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<FieldConfigurationSchemeProjects> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(FieldConfigurationSchemeProjects.class));

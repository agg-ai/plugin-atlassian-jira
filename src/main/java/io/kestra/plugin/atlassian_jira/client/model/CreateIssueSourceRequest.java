...
public class CreateIssueSourceRequest {
  /**
   * The issue source type. This must be \&quot;Board\&quot;,
   * \&quot;Project\&quot; or \&quot;Filter\&quot;.
   */
  ...
  /**
   * The issue source value. This must be a board ID if the type is
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CreateIssueSourceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CreateIssueSourceRequest is not found in the empty JSON string",
            CreateIssueSourceRequest.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CreateIssueSourceRequest.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CreateIssueSourceRequest` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<CreateIssueSourceRequest> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CreateIssueSourceRequest.class));

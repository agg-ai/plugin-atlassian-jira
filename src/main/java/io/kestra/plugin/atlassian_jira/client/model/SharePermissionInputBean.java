...
public class SharePermissionInputBean {
   ...
   * &#x60;user&#x60; Share with a user. * &#x60;group&#x60; Share with a group.
   * Specify &#x60;groupname&#x60; as well. * &#x60;project&#x60; Share with a
   * project. Specify &#x60;projectId&#x60; as well. * &#x60;projectRole&#x60;
   * Share with a project role in a project. Specify &#x60;projectId&#x60; and
   * &#x60;projectRoleId&#x60; as well. * &#x60;global&#x60; Share globally,
   * including anonymous users. If set, this type overrides all existing share
   * permissions and must be deleted before any non-global share permissions is
   * set. * &#x60;authenticated&#x60; Share with all logged-in users. This shows
   * as &#x60;loggedin&#x60; in the response. If set, this type overrides all
   * existing share permissions and must be deleted before any non-global share
   * permissions is set.
   */
   ...
   * &#x60;projectRole&#x60; and the &#x60;projectId&#x60; for the project that
   * the role is in.
   * 
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("accountId", "groupId", "groupname", "projectId", "projectRoleId", "rights", "type"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!SharePermissionInputBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in SharePermissionInputBean is not found in the empty JSON string",
            SharePermissionInputBean.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!SharePermissionInputBean.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `SharePermissionInputBean` properties. JSON: %s",
    ...
    if ((jsonObj.get("projectRoleId") != null && !jsonObj.get("projectRoleId").isJsonNull())
        && !jsonObj.get("projectRoleId").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `projectRoleId` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("projectRoleId").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<SharePermissionInputBean> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(SharePermissionInputBean.class));

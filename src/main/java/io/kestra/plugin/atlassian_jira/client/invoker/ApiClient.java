...
import io.kestra.plugin.atlassian_jira.client.invoker.auth.ApiKeyAuth;
import io.kestra.plugin.atlassian_jira.client.invoker.auth.Authentication;
import io.kestra.plugin.atlassian_jira.client.invoker.auth.HttpBasicAuth;
import io.kestra.plugin.atlassian_jira.client.invoker.auth.HttpBearerAuth;
import io.kestra.plugin.atlassian_jira.client.invoker.auth.OAuth;
import io.kestra.plugin.atlassian_jira.client.invoker.auth.OAuthFlow;
import io.kestra.plugin.atlassian_jira.client.invoker.auth.RetryingOAuth;
...
public class ApiClient {
    ...
    protected String basePath = "https://your-domain.atlassian.net";
    ...
    /**
     * Constructor for ApiClient to support access token retry on 401/403 configured
     * with client ID
     *
    ...
    /**
     * Constructor for ApiClient to support access token retry on 401/403 configured
     * with client ID and additional parameters
     *
     * @param clientId   client ID
    ...
    /**
     * Constructor for ApiClient to support access token retry on 401/403 configured
     * with client ID, secret, and additional parameters
     *
     * @param clientId     client ID
    ...
    /**
     * Constructor for ApiClient to support access token retry on 401/403 configured
     * with base path, client ID, secret, and additional parameters
     *
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        RetryingOAuth retryingOAuth = new RetryingOAuth(tokenUrl, clientId, OAuthFlow.ACCESS_CODE, clientSecret,
                parameters);
        authentications.put(
                "OAuth2",
                retryingOAuth);
    ...
    protected void init() {
        ...
        setUserAgent("OpenAPI-Generator/1001.0.0-SNAPSHOT-1bc87d9c91847a6f215496c203268482a08e6f70/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://your-domain.atlassian.net)
     ...
     * @return a {@link io.kestra.plugin.atlassian_jira.client.invoker.ApiClient}
     *         object
     */
     ...
     * @param service      Service to access to
     */
    public void setAWS4Configuration(String accessKey, String secretKey, String sessionToken, String region,
            String service) {
        throw new RuntimeException("No AWS4 authentication configured!");
    }
    ...
    /**
     * Formats the specified free-form query parameters to a list of {@code Pair}
     * objects.
     *
     ...
     * @throws io.kestra.plugin.atlassian_jira.client.invoker.ApiException If fail
     *                                                                     to
     *                                                                     deserialize
     *                                                                     response
     *                                                                     body,
     ...
     * @param returnType Return type
     * @return Type
     * @throws io.kestra.plugin.atlassian_jira.client.invoker.ApiException If the
     *                                                                     response
     *                                                                     has an
     *                                                                     unsuccessful
     *                                                                     status
    ...
    public Request buildRequest(String baseUrl, String path, String method, List<Pair> queryParams,
        ...
        updateParamsForAuth(authNames, updatedQueryParams, headerParams, cookieParams, requestBodyToString(reqBody),
                method, URI.create(url));
     ...
     * @param uri          URI
     * @throws io.kestra.plugin.atlassian_jira.client.invoker.ApiException If fails
     *                                                                     to update
     *                                                                     the
     *                                                                     parameters
     */
    ...
    /**
     * Add a Content-Disposition Header for the given key and file to the

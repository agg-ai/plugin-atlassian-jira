...
public class CreateCustomFieldContext {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("description", "id", "issueTypeIds", "name", "projectIds"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CreateCustomFieldContext.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CreateCustomFieldContext is not found in the empty JSON string",
            CreateCustomFieldContext.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CreateCustomFieldContext.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CreateCustomFieldContext` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<CreateCustomFieldContext> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CreateCustomFieldContext.class));

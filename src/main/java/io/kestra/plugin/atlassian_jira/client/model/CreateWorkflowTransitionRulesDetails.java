...
import io.kestra.plugin.atlassian_jira.client.model.CreateWorkflowCondition;
import io.kestra.plugin.atlassian_jira.client.model.CreateWorkflowTransitionRule;
...
public class CreateWorkflowTransitionRulesDetails {
  ...
  public CreateWorkflowTransitionRulesDetails conditions(
      @javax.annotation.Nullable CreateWorkflowCondition conditions) {
  ...
  public CreateWorkflowTransitionRulesDetails postFunctions(
      @javax.annotation.Nullable List<CreateWorkflowTransitionRule> postFunctions) {
  ...
  /**
   * The workflow post functions. **Note:** The default post functions are always
   * added to the *initial* transition, as in: \&quot;postFunctions\&quot;: [ {
   * \&quot;type\&quot;: \&quot;IssueCreateFunction\&quot; }, {
   * \&quot;type\&quot;: \&quot;IssueReindexFunction\&quot; }, {
   * \&quot;type\&quot;: \&quot;FireIssueEventFunction\&quot;,
   * \&quot;configuration\&quot;: { \&quot;event\&quot;: { \&quot;id\&quot;:
   * \&quot;1\&quot;, \&quot;name\&quot;: \&quot;issue_created\&quot; } } } ]
   * **Note:** The default post functions are always added to the *global* and
   * *directed* transitions, as in: \&quot;postFunctions\&quot;: [ {
  ...
  public CreateWorkflowTransitionRulesDetails validators(
      @javax.annotation.Nullable List<CreateWorkflowTransitionRule> validators) {
  ...
  /**
   * The workflow validators. **Note:** The default permission validator is always
   * added to the *initial* transition, as in: \&quot;validators\&quot;: [ {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("conditions", "postFunctions", "validators"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CreateWorkflowTransitionRulesDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON
                                                                                   // element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CreateWorkflowTransitionRulesDetails is not found in the empty JSON string",
            CreateWorkflowTransitionRulesDetails.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CreateWorkflowTransitionRulesDetails.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CreateWorkflowTransitionRulesDetails` properties. JSON: %s",
    ...
    if (jsonObj.get("postFunctions") != null && !jsonObj.get("postFunctions").isJsonNull()) {
      ...
      if (jsonArraypostFunctions != null) {
        ...
        if (!jsonObj.get("postFunctions").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `postFunctions` to be an array in the JSON string but got `%s`",
              jsonObj.get("postFunctions").toString()));
        }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!CreateWorkflowTransitionRulesDetails.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'CreateWorkflowTransitionRulesDetails' and its
                     // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<CreateWorkflowTransitionRulesDetails> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CreateWorkflowTransitionRulesDetails.class));
  ...
  /**
   * Create an instance of CreateWorkflowTransitionRulesDetails given an JSON
   * string
   *

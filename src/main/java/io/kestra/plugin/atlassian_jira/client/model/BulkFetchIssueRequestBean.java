...
public class BulkFetchIssueRequestBean {
   ...
   * sorted by date, starting from the most recent. This returns a maximum of 40
   * changelogs. If you require more, please refer to [Bulk fetch
   * changelogs](#api-rest-api-3-changelog-bulkfetch-post). *
  ...
  /**
   * An array of issue IDs or issue keys to fetch. You can mix issue IDs and keys
   * in the same query.
   * 
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("expand", "fields", "fieldsByKeys", "issueIdsOrKeys", "properties"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!BulkFetchIssueRequestBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in BulkFetchIssueRequestBean is not found in the empty JSON string",
            BulkFetchIssueRequestBean.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!BulkFetchIssueRequestBean.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `BulkFetchIssueRequestBean` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<BulkFetchIssueRequestBean> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(BulkFetchIssueRequestBean.class));

...
import io.kestra.plugin.atlassian_jira.client.model.IncludedFields;
import io.kestra.plugin.atlassian_jira.client.model.IssueTransition;
...
import io.kestra.plugin.atlassian_jira.client.model.Operations;
...
public class IssueBean {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(changelog, editmeta, expand, fields, fieldsToInclude, id, key, names, operations, properties,
        renderedFields, schema, self, transitions, versionedRepresentations);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("changelog", "editmeta", "expand", "fields", "fieldsToInclude", "id", "key", "names",
            "operations", "properties", "renderedFields", "schema", "self", "transitions", "versionedRepresentations"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!IssueBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in IssueBean is not found in the empty JSON string",
                IssueBean.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!IssueBean.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `IssueBean` properties. JSON: %s", entry.getKey(),
    ...
    if (jsonObj.get("transitions") != null && !jsonObj.get("transitions").isJsonNull()
        && !jsonObj.get("transitions").isJsonArray()) {
      throw new IllegalArgumentException(
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssueBean> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(IssueBean.class));

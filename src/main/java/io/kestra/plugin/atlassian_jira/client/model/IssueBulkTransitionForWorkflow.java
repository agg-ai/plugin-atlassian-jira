...
import io.kestra.plugin.atlassian_jira.client.model.SimplifiedIssueTransition;
...
public class IssueBulkTransitionForWorkflow {
  ...
  /**
   * List of transitions available for issues from the request which are
   * associated with this workflow. **This list includes only those transitions
   * that are common across the issues in this workflow and do not involve any
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("isTransitionsFiltered", "issues", "transitions"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!IssueBulkTransitionForWorkflow.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                             // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssueBulkTransitionForWorkflow is not found in the empty JSON string",
            IssueBulkTransitionForWorkflow.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!IssueBulkTransitionForWorkflow.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `IssueBulkTransitionForWorkflow` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssueBulkTransitionForWorkflow> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssueBulkTransitionForWorkflow.class));

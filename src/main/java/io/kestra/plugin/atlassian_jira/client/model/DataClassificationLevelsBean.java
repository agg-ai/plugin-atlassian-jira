...
import io.kestra.plugin.atlassian_jira.client.model.DataClassificationTagBean;
...
public class DataClassificationLevelsBean {
  ...
  public DataClassificationLevelsBean classifications(
      @javax.annotation.Nullable List<DataClassificationTagBean> classifications) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!DataClassificationLevelsBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                           // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in DataClassificationLevelsBean is not found in the empty JSON string",
            DataClassificationLevelsBean.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!DataClassificationLevelsBean.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `DataClassificationLevelsBean` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<DataClassificationLevelsBean> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(DataClassificationLevelsBean.class));

...
import io.kestra.plugin.atlassian_jira.client.model.ProjectRoleGroup;
import io.kestra.plugin.atlassian_jira.client.model.ProjectRoleUser;
...
public class RoleActor {
   ...
   * privacy setting, this may return an alternative value for the user&#39;s
   * name.
   * 
   * @return displayName
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("actorGroup", "actorUser", "avatarUrl", "displayName", "id", "name", "type"));
    ...
    if (jsonElement == null) {
      if (!RoleActor.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in RoleActor is not found in the empty JSON string",
                RoleActor.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!RoleActor.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `RoleActor` properties. JSON: %s", entry.getKey(),
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<RoleActor> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(RoleActor.class));

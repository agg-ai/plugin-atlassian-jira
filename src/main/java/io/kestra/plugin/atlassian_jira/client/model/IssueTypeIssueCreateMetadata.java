...
import io.kestra.plugin.atlassian_jira.client.model.FieldMetadata;
...
public class IssueTypeIssueCreateMetadata {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(avatarId, description, entityId, expand, fields, hierarchyLevel, iconUrl, id, name, scope, self,
        subtask);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("avatarId", "description", "entityId", "expand", "fields",
        "hierarchyLevel", "iconUrl", "id", "name", "scope", "self", "subtask"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!IssueTypeIssueCreateMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                           // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssueTypeIssueCreateMetadata is not found in the empty JSON string",
            IssueTypeIssueCreateMetadata.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!IssueTypeIssueCreateMetadata.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `IssueTypeIssueCreateMetadata` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssueTypeIssueCreateMetadata> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssueTypeIssueCreateMetadata.class));

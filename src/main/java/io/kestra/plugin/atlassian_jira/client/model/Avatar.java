...
public class Avatar {
  ...
  /**
   * The owner of the avatar. For a system avatar the owner is null (and nothing
   * is returned). For non-system avatars this is the appropriate identifier, such
   * as the ID for a project or the account ID for a user.
   * 
   * @return owner
   */
  @javax.annotation.Nullable
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("fileName", "id", "isDeletable", "isSelected", "isSystemAvatar", "owner", "urls"));
    ...
    if (jsonElement == null) {
      if (!Avatar.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in Avatar is not found in the empty JSON string",
                Avatar.openapiRequiredFields.toString()));
      }
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<Avatar> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(Avatar.class));

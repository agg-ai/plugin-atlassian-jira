...
public class WorkflowRulesSearch {
   ...
   * accepts &#x60;transition&#x60; which, for each rule, returns information
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("expand", "ruleIds", "workflowEntityId"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("ruleIds", "workflowEntityId"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!WorkflowRulesSearch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in WorkflowRulesSearch is not found in the empty JSON string",
            WorkflowRulesSearch.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!WorkflowRulesSearch.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `WorkflowRulesSearch` properties. JSON: %s",
    ...
    if (jsonObj.get("ruleIds") == null) {
      ...
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `ruleIds` to be an array in the JSON string but got `%s`",
              jsonObj.get("ruleIds").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<WorkflowRulesSearch> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(WorkflowRulesSearch.class));

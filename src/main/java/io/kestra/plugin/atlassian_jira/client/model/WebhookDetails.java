...
public class WebhookDetails {
   ...
   * subset of JQL can be used. The supported elements are: * Fields:
   * &#x60;issueKey&#x60;, &#x60;project&#x60;, &#x60;issuetype&#x60;,
   * &#x60;status&#x60;, &#x60;assignee&#x60;, &#x60;reporter&#x60;,
   * &#x60;issue.property&#x60;, and &#x60;cf[id]&#x60;. For custom fields
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("events", "fieldIdsFilter", "issuePropertyKeysFilter", "jqlFilter"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!WebhookDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in WebhookDetails is not found in the empty JSON string",
            WebhookDetails.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!WebhookDetails.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `WebhookDetails` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<WebhookDetails> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(WebhookDetails.class));

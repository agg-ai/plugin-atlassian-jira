...
import io.kestra.plugin.atlassian_jira.client.model.CreateCrossProjectReleaseRequest;
import io.kestra.plugin.atlassian_jira.client.model.CreateCustomFieldRequest;
import io.kestra.plugin.atlassian_jira.client.model.CreateExclusionRulesRequest;
import io.kestra.plugin.atlassian_jira.client.model.CreateIssueSourceRequest;
import io.kestra.plugin.atlassian_jira.client.model.CreatePermissionRequest;
import io.kestra.plugin.atlassian_jira.client.model.CreateSchedulingRequest;
...
public class CreatePlanRequest {
  ...
  public CreatePlanRequest crossProjectReleases(
      @javax.annotation.Nullable Set<CreateCrossProjectReleaseRequest> crossProjectReleases) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(crossProjectReleases, customFields, exclusionRules, issueSources, leadAccountId, name,
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("crossProjectReleases", "customFields", "exclusionRules",
        "issueSources", "leadAccountId", "name", "permissions", "scheduling"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CreatePlanRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CreatePlanRequest is not found in the empty JSON string",
            CreatePlanRequest.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CreatePlanRequest.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CreatePlanRequest` properties. JSON: %s",
    ...
    if (!jsonObj.get("issueSources").isJsonArray()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `issueSources` to be an array in the JSON string but got `%s`",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<CreatePlanRequest> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CreatePlanRequest.class));

...
public class IssueLinkTypes {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!IssueLinkTypes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssueLinkTypes is not found in the empty JSON string",
            IssueLinkTypes.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!IssueLinkTypes.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `IssueLinkTypes` properties. JSON: %s",
    ...
    if (jsonObj.get("issueLinkTypes") != null && !jsonObj.get("issueLinkTypes").isJsonNull()) {
      ...
      if (jsonArrayissueLinkTypes != null) {
        ...
        if (!jsonObj.get("issueLinkTypes").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `issueLinkTypes` to be an array in the JSON string but got `%s`",
              jsonObj.get("issueLinkTypes").toString()));
        }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssueLinkTypes> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssueLinkTypes.class));

...
public class UpdateProjectDetails {
   ...
   * categories](#api-rest-api-3-projectCategory-get) operation. To remove the
   * project category from the project, set the value to &#x60;-1.&#x60;
   * 
   * @return categoryId
   */
  @javax.annotation.Nullable
  ...
  @Override
  public int hashCode() {
    return Objects.hash(assigneeType, avatarId, categoryId, description, issueSecurityScheme, key, lead, leadAccountId,
        name, notificationScheme, permissionScheme, releasedProjectKeys, url);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("assigneeType", "avatarId", "categoryId", "description", "issueSecurityScheme", "key", "lead",
            "leadAccountId", "name", "notificationScheme", "permissionScheme", "releasedProjectKeys", "url"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!UpdateProjectDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in UpdateProjectDetails is not found in the empty JSON string",
            UpdateProjectDetails.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!UpdateProjectDetails.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `UpdateProjectDetails` properties. JSON: %s",
    ...
    if (jsonObj.get("releasedProjectKeys") != null && !jsonObj.get("releasedProjectKeys").isJsonNull()
        && !jsonObj.get("releasedProjectKeys").isJsonArray()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `releasedProjectKeys` to be an array in the JSON string but got `%s`",
          jsonObj.get("releasedProjectKeys").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<UpdateProjectDetails> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(UpdateProjectDetails.class));

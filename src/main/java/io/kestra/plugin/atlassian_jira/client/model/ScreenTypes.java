...
public class ScreenTypes {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("create", "default", "edit", "view"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("default"));
  }
    ...
    if (jsonElement == null) {
      if (!ScreenTypes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in ScreenTypes is not found in the empty JSON string",
                ScreenTypes.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ScreenTypes.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ScreenTypes` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ScreenTypes> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(ScreenTypes.class));

...
public class BulkOperationProgress {
  ...
  public BulkOperationProgress failedAccessibleIssues(
      @javax.annotation.Nullable Map<String, List<String>> failedAccessibleIssues) {
   ...
   * permission to view, to their one or more reasons for failure. These reasons
   * are open-ended text descriptions of the error and are not selected from a
  ...
  public BulkOperationProgress invalidOrInaccessibleIssueCount(
      @javax.annotation.Nullable Integer invalidOrInaccessibleIssueCount) {
  ...
  public BulkOperationProgress processedAccessibleIssues(
      @javax.annotation.Nullable List<Long> processedAccessibleIssues) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(created, failedAccessibleIssues, invalidOrInaccessibleIssueCount, processedAccessibleIssues,
        progressPercent, started, status, submittedBy, taskId, totalIssueCount, updated);
  }
  ...
  public String toString() {
    ...
    sb.append("    invalidOrInaccessibleIssueCount: ").append(toIndentedString(invalidOrInaccessibleIssueCount))
        .append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("created", "failedAccessibleIssues",
        "invalidOrInaccessibleIssueCount", "processedAccessibleIssues", "progressPercent", "started", "status",
        "submittedBy", "taskId", "totalIssueCount", "updated"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!BulkOperationProgress.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in BulkOperationProgress is not found in the empty JSON string",
            BulkOperationProgress.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!BulkOperationProgress.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `BulkOperationProgress` properties. JSON: %s",
            entry.getKey(), jsonElement.toString()));
      }
    }
    JsonObject jsonObj = jsonElement.getAsJsonObject();
    // ensure the optional json data is an array if present
    if (jsonObj.get("processedAccessibleIssues") != null && !jsonObj.get("processedAccessibleIssues").isJsonNull()
        && !jsonObj.get("processedAccessibleIssues").isJsonArray()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `processedAccessibleIssues` to be an array in the JSON string but got `%s`",
          jsonObj.get("processedAccessibleIssues").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<BulkOperationProgress> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(BulkOperationProgress.class));

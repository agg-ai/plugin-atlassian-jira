...
import io.kestra.plugin.atlassian_jira.client.model.ServiceRegistryTier;
...
public class ServiceRegistry {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("description", "id", "name", "organizationId", "revision", "serviceTier"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ServiceRegistry.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in ServiceRegistry is not found in the empty JSON string",
            ServiceRegistry.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ServiceRegistry.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ServiceRegistry` properties. JSON: %s",
    ...
    if ((jsonObj.get("revision") != null && !jsonObj.get("revision").isJsonNull())
        && !jsonObj.get("revision").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ServiceRegistry> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(ServiceRegistry.class));

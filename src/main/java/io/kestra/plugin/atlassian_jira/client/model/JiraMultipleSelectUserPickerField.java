...
import io.kestra.plugin.atlassian_jira.client.model.JiraUserField;
...
public class JiraMultipleSelectUserPickerField {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("fieldId", "users"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!JiraMultipleSelectUserPickerField.openapiRequiredFields.isEmpty()) { // has required fields but JSON element
                                                                                // is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in JiraMultipleSelectUserPickerField is not found in the empty JSON string",
            JiraMultipleSelectUserPickerField.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!JiraMultipleSelectUserPickerField.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `JiraMultipleSelectUserPickerField` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!JiraMultipleSelectUserPickerField.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'JiraMultipleSelectUserPickerField' and its
                     // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<JiraMultipleSelectUserPickerField> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(JiraMultipleSelectUserPickerField.class));

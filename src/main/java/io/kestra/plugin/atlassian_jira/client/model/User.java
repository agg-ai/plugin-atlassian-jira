...
import io.kestra.plugin.atlassian_jira.client.model.SimpleListWrapperApplicationRole;
import io.kestra.plugin.atlassian_jira.client.model.SimpleListWrapperGroupName;
 ...
 * settings. However, be aware of these exceptions: * User record deleted from
 * Atlassian: This occurs as the result of a right to be forgotten request. In
 * this case, &#x60;displayName&#x60; provides an indication and other
 ...
 * import and can only happen to deleted users. In this case,
 * &#x60;accountId&#x60; returns *unknown* and all other parameters have
 * fallback values. * User record unavailable: This usually occurs due to an
 * internal service outage. In this case, all parameters have fallback values.
 */
...
public class User {
   ...
   * regular Atlassian user account * &#x60;app&#x60; system account used for
   * Connect applications and OAuth to represent external systems *
   * &#x60;customer&#x60; Jira Service Desk account representing an external
   * service desk
   */
  ...
  /**
   * The display name of the user. Depending on the user’s privacy setting, this
  ...
  /**
   * The time zone specified in the user&#39;s profile. If the user&#39;s time
   * zone is not visible to the current user (due to user&#39;s profile setting),
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, accountType, active, applicationRoles, avatarUrls, displayName, emailAddress, expand,
        groups, key, locale, name, self, timeZone);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("accountId", "accountType", "active", "applicationRoles",
        "avatarUrls", "displayName", "emailAddress", "expand", "groups", "key", "locale", "name", "self", "timeZone"));
    ...
    if (jsonElement == null) {
      if (!User.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in User is not found in the empty JSON string",
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!User.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `User` properties. JSON: %s", entry.getKey(),

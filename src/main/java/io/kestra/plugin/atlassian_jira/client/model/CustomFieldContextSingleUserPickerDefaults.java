...
public class CustomFieldContextSingleUserPickerDefaults {
  ...
  public CustomFieldContextSingleUserPickerDefaults accountId(@javax.annotation.Nonnull String accountId) {
  ...
  public CustomFieldContextSingleUserPickerDefaults contextId(@javax.annotation.Nonnull String contextId) {
  ...
  public CustomFieldContextSingleUserPickerDefaults type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public CustomFieldContextSingleUserPickerDefaults userFilter(@javax.annotation.Nonnull UserFilter userFilter) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CustomFieldContextSingleUserPickerDefaults.openapiRequiredFields.isEmpty()) { // has required fields but JSON
                                                                                         // element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CustomFieldContextSingleUserPickerDefaults is not found in the empty JSON string",
            CustomFieldContextSingleUserPickerDefaults.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CustomFieldContextSingleUserPickerDefaults.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CustomFieldContextSingleUserPickerDefaults` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!CustomFieldContextSingleUserPickerDefaults.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'CustomFieldContextSingleUserPickerDefaults' and
                     // its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<CustomFieldContextSingleUserPickerDefaults> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CustomFieldContextSingleUserPickerDefaults.class));
  ...
  /**
   * Create an instance of CustomFieldContextSingleUserPickerDefaults given an
   * JSON string
   *
  ...
  /**
   * Convert an instance of CustomFieldContextSingleUserPickerDefaults to an JSON
   * string
   *
   * @return JSON string
   */

...
import io.kestra.plugin.atlassian_jira.client.model.AttachmentArchiveEntry;
...
public class AttachmentArchive {
  ...
  public AttachmentArchive totalNumberOfEntriesAvailable(
      @javax.annotation.Nullable Integer totalNumberOfEntriesAvailable) {
  ...
  public String toString() {
    ...
    sb.append("    totalNumberOfEntriesAvailable: ").append(toIndentedString(totalNumberOfEntriesAvailable))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("entries", "moreAvailable", "totalEntryCount", "totalNumberOfEntriesAvailable"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!AttachmentArchive.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in AttachmentArchive is not found in the empty JSON string",
            AttachmentArchive.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!AttachmentArchive.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `AttachmentArchive` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<AttachmentArchive> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(AttachmentArchive.class));

...
public class NotificationSchemeAndProjectMappingJsonBean {
  ...
  public NotificationSchemeAndProjectMappingJsonBean notificationSchemeId(
      @javax.annotation.Nullable String notificationSchemeId) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("notificationSchemeId", "projectId"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!NotificationSchemeAndProjectMappingJsonBean.openapiRequiredFields.isEmpty()) { // has required fields but
                                                                                          // JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in NotificationSchemeAndProjectMappingJsonBean is not found in the empty JSON string",
            NotificationSchemeAndProjectMappingJsonBean.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!NotificationSchemeAndProjectMappingJsonBean.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `NotificationSchemeAndProjectMappingJsonBean` properties. JSON: %s",
            entry.getKey(), jsonElement.toString()));
      }
    }
    JsonObject jsonObj = jsonElement.getAsJsonObject();
    if ((jsonObj.get("notificationSchemeId") != null && !jsonObj.get("notificationSchemeId").isJsonNull())
        && !jsonObj.get("notificationSchemeId").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `notificationSchemeId` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("notificationSchemeId").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!NotificationSchemeAndProjectMappingJsonBean.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'NotificationSchemeAndProjectMappingJsonBean' and
                     // its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<NotificationSchemeAndProjectMappingJsonBean> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(NotificationSchemeAndProjectMappingJsonBean.class));
  ...
  /**
   * Create an instance of NotificationSchemeAndProjectMappingJsonBean given an
   * JSON string
   *
  ...
  /**
   * Convert an instance of NotificationSchemeAndProjectMappingJsonBean to an JSON
   * string
   *
   * @return JSON string
   */

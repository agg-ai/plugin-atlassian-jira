...
import io.kestra.plugin.atlassian_jira.client.model.SimpleLink;
import io.kestra.plugin.atlassian_jira.client.model.VersionApprover;
import io.kestra.plugin.atlassian_jira.client.model.VersionIssuesStatus;
...
public class Version {
  ...
  /**
   * If the expand option &#x60;driver&#x60; is used, returns the Atlassian
   ...
   * Expand options include: * &#x60;operations&#x60; Returns the list of
   * operations available for this version. * &#x60;issuesstatus&#x60; Returns the
   * count of issues in this version for each of the status categories *to do*,
   * *in progress*, *done*, and *unmapped*. The *unmapped* property contains a
   ...
   * issues in this version for each of the status categories *to do*, *in
   * progress*, *done*, and *unmapped*. The *unmapped* property contains a count
  ...
  /**
   * Indicates that the version is released. If the version is released a request
   * to release again is ignored. Not applicable when creating a version. Optional
   * when updating a version.
   * 
   * @return released
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(approvers, archived, description, driver, expand, id, issuesStatusForFixVersion,
        moveUnfixedIssuesTo, name, operations, overdue, project, projectId, releaseDate, released, self, startDate,
        userReleaseDate, userStartDate);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("approvers", "archived", "description", "driver", "expand", "id",
        "issuesStatusForFixVersion", "moveUnfixedIssuesTo", "name", "operations", "overdue", "project", "projectId",
        "releaseDate", "released", "self", "startDate", "userReleaseDate", "userStartDate"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!Version.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in Version is not found in the empty JSON string",
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!Version.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `Version` properties. JSON: %s", entry.getKey(),
    ...
    if (jsonObj.get("approvers") != null && !jsonObj.get("approvers").isJsonNull()
        && !jsonObj.get("approvers").isJsonArray()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `approvers` to be an array in the JSON string but got `%s`",
              jsonObj.get("approvers").toString()));
    }
    ...
    if ((jsonObj.get("driver") != null && !jsonObj.get("driver").isJsonNull())
      ...
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `driver` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("driver").toString()));
    }
    if ((jsonObj.get("expand") != null && !jsonObj.get("expand").isJsonNull())
        && !jsonObj.get("expand").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `expand` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("expand").toString()));
    }
    ...
    if ((jsonObj.get("moveUnfixedIssuesTo") != null && !jsonObj.get("moveUnfixedIssuesTo").isJsonNull())
        && !jsonObj.get("moveUnfixedIssuesTo").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `moveUnfixedIssuesTo` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("moveUnfixedIssuesTo").toString()));
    }
    ...
    if (jsonObj.get("operations") != null && !jsonObj.get("operations").isJsonNull()) {
      ...
      if (jsonArrayoperations != null) {
        ...
        if (!jsonObj.get("operations").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `operations` to be an array in the JSON string but got `%s`",
              jsonObj.get("operations").toString()));
        }
    ...
    if ((jsonObj.get("userReleaseDate") != null && !jsonObj.get("userReleaseDate").isJsonNull())
        && !jsonObj.get("userReleaseDate").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `userReleaseDate` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("userReleaseDate").toString()));
    }
    if ((jsonObj.get("userStartDate") != null && !jsonObj.get("userStartDate").isJsonNull())
        && !jsonObj.get("userStartDate").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `userStartDate` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("userStartDate").toString()));
    }
  }

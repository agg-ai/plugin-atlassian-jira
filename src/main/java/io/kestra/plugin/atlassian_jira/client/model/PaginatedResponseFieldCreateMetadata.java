...
import io.kestra.plugin.atlassian_jira.client.model.FieldCreateMetadata;
...
public class PaginatedResponseFieldCreateMetadata {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PaginatedResponseFieldCreateMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON
                                                                                   // element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in PaginatedResponseFieldCreateMetadata is not found in the empty JSON string",
            PaginatedResponseFieldCreateMetadata.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PaginatedResponseFieldCreateMetadata.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `PaginatedResponseFieldCreateMetadata` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!PaginatedResponseFieldCreateMetadata.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'PaginatedResponseFieldCreateMetadata' and its
                     // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<PaginatedResponseFieldCreateMetadata> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(PaginatedResponseFieldCreateMetadata.class));
  ...
  /**
   * Create an instance of PaginatedResponseFieldCreateMetadata given an JSON
   * string
   *

...
public class OrderOfCustomFieldOptions {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!OrderOfCustomFieldOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in OrderOfCustomFieldOptions is not found in the empty JSON string",
            OrderOfCustomFieldOptions.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!OrderOfCustomFieldOptions.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `OrderOfCustomFieldOptions` properties. JSON: %s",
    ...
    if (jsonObj.get("customFieldOptionIds") == null) {
      ...
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `customFieldOptionIds` to be an array in the JSON string but got `%s`",
          jsonObj.get("customFieldOptionIds").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<OrderOfCustomFieldOptions> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(OrderOfCustomFieldOptions.class));

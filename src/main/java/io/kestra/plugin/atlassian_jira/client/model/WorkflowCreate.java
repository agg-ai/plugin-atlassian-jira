...
public class WorkflowCreate {
  ...
  public WorkflowCreate loopedTransitionContainerLayout(
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("description", "loopedTransitionContainerLayout", "name",
        "startPointLayout", "statuses", "transitions"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!WorkflowCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in WorkflowCreate is not found in the empty JSON string",
            WorkflowCreate.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!WorkflowCreate.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `WorkflowCreate` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<WorkflowCreate> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(WorkflowCreate.class));

...
import io.kestra.plugin.atlassian_jira.client.model.ConditionGroupConfiguration;
import io.kestra.plugin.atlassian_jira.client.model.WorkflowRuleConfiguration;
import io.kestra.plugin.atlassian_jira.client.model.WorkflowTransitionLinks;
import io.kestra.plugin.atlassian_jira.client.model.WorkflowTrigger;
...
public class WorkflowTransitions {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(actions, conditions, customIssueEventId, description, id, links, name, properties,
        toStatusReference, transitionScreen, triggers, type, validators);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("actions", "conditions", "customIssueEventId", "description", "id", "links", "name", "properties",
            "toStatusReference", "transitionScreen", "triggers", "type", "validators"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!WorkflowTransitions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in WorkflowTransitions is not found in the empty JSON string",
            WorkflowTransitions.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!WorkflowTransitions.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `WorkflowTransitions` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<WorkflowTransitions> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(WorkflowTransitions.class));

...
public class NewUserDetails {
  ...
  /**
   * This property is no longer available. If the user has an Atlassian account,
   * their password is not changed. If the user does not have an Atlassian
   * account, they are sent an email asking them set up an account.
   * 
   * @return password
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(applicationKeys, displayName, emailAddress, key, name, password, products, self,
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("applicationKeys", "displayName", "emailAddress", "key", "name", "password", "products", "self"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("emailAddress", "products"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!NewUserDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in NewUserDetails is not found in the empty JSON string",
            NewUserDetails.openapiRequiredFields.toString()));
      }
    }
    ...
    if (jsonObj.get("applicationKeys") != null && !jsonObj.get("applicationKeys").isJsonNull()
        && !jsonObj.get("applicationKeys").isJsonArray()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `applicationKeys` to be an array in the JSON string but got `%s`",
          jsonObj.get("applicationKeys").toString()));
    }
    ...
    if (jsonObj.get("products") == null) {
      ...
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `products` to be an array in the JSON string but got `%s`",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<NewUserDetails> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(NewUserDetails.class));

...
public class IssueSecurityLevelMember {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("holder", "id", "issueSecurityLevelId"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("holder", "id", "issueSecurityLevelId"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!IssueSecurityLevelMember.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssueSecurityLevelMember is not found in the empty JSON string",
            IssueSecurityLevelMember.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!IssueSecurityLevelMember.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `IssueSecurityLevelMember` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssueSecurityLevelMember> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssueSecurityLevelMember.class));

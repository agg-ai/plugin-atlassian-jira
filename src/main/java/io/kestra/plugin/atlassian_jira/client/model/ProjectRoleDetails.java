...
public class ProjectRoleDetails {
  ...
  public ProjectRoleDetails name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ProjectRoleDetails translatedName(@javax.annotation.Nullable String translatedName) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("admin", "default", "description", "id", "name",
        "roleConfigurable", "scope", "self", "translatedName"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ProjectRoleDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in ProjectRoleDetails is not found in the empty JSON string",
            ProjectRoleDetails.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ProjectRoleDetails.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ProjectRoleDetails` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ProjectRoleDetails> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(ProjectRoleDetails.class));

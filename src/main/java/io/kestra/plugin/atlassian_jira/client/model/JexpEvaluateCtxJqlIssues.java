 ...
 * JQL query are loaded, only those described by the &#x60;nextPageToken&#x60;
 * and &#x60;maxResults&#x60; properties. This bean will be replacing
 * JexpJqlIssues bean as part of new &#x60;evaluate&#x60; endpoint
 */
...
public class JexpEvaluateCtxJqlIssues {
  ...
  /**
   * The JQL query, required to be bounded. Additionally, &#x60;orderBy&#x60;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!JexpEvaluateCtxJqlIssues.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in JexpEvaluateCtxJqlIssues is not found in the empty JSON string",
            JexpEvaluateCtxJqlIssues.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!JexpEvaluateCtxJqlIssues.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `JexpEvaluateCtxJqlIssues` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<JexpEvaluateCtxJqlIssues> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(JexpEvaluateCtxJqlIssues.class));

...
public class StatusLayoutUpdate {
  ...
  public StatusLayoutUpdate approvalConfiguration(
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("approvalConfiguration", "layout", "properties", "statusReference"));
    ...
    if (jsonElement == null) {
      if (!StatusLayoutUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in StatusLayoutUpdate is not found in the empty JSON string",
            StatusLayoutUpdate.openapiRequiredFields.toString()));
      }
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<StatusLayoutUpdate> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(StatusLayoutUpdate.class));

...
import io.kestra.plugin.atlassian_jira.client.model.DashboardGadgetPosition;
...
public class DashboardGadgetSettings {
  ...
  /**
   * The color of the gadget. Should be one of &#x60;blue&#x60;, &#x60;red&#x60;,
  ...
  public DashboardGadgetSettings ignoreUriAndModuleKeyValidation(
      @javax.annotation.Nullable Boolean ignoreUriAndModuleKeyValidation) {
  ...
  public String toString() {
    ...
    sb.append("    ignoreUriAndModuleKeyValidation: ").append(toIndentedString(ignoreUriAndModuleKeyValidation))
        .append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("color", "ignoreUriAndModuleKeyValidation", "moduleKey", "position", "title", "uri"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!DashboardGadgetSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in DashboardGadgetSettings is not found in the empty JSON string",
            DashboardGadgetSettings.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!DashboardGadgetSettings.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `DashboardGadgetSettings` properties. JSON: %s",
    ...
    if ((jsonObj.get("uri") != null && !jsonObj.get("uri").isJsonNull()) && !jsonObj.get("uri").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `uri` to be a primitive type in the JSON string but got `%s`",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<DashboardGadgetSettings> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(DashboardGadgetSettings.class));

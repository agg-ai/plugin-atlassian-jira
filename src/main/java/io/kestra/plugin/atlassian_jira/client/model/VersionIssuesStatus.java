...
public class VersionIssuesStatus {
    ...
    if (jsonElement == null) {
      if (!VersionIssuesStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in VersionIssuesStatus is not found in the empty JSON string",
            VersionIssuesStatus.openapiRequiredFields.toString()));
      }
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<VersionIssuesStatus> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(VersionIssuesStatus.class));

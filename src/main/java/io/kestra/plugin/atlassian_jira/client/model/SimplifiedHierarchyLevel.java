...
public class SimplifiedHierarchyLevel {
  ...
  /**
   * The ID of the hierarchy level. This property is deprecated, see [Change
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aboveLevelId, belowLevelId, externalUuid, hierarchyLevelNumber, id, issueTypeIds, level, name,
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("aboveLevelId", "belowLevelId", "externalUuid",
        "hierarchyLevelNumber", "id", "issueTypeIds", "level", "name", "projectConfigurationId"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!SimplifiedHierarchyLevel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in SimplifiedHierarchyLevel is not found in the empty JSON string",
            SimplifiedHierarchyLevel.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!SimplifiedHierarchyLevel.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `SimplifiedHierarchyLevel` properties. JSON: %s",
            entry.getKey(), jsonElement.toString()));
      }
    }
    JsonObject jsonObj = jsonElement.getAsJsonObject();
    if ((jsonObj.get("externalUuid") != null && !jsonObj.get("externalUuid").isJsonNull())
        && !jsonObj.get("externalUuid").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `externalUuid` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("externalUuid").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<SimplifiedHierarchyLevel> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(SimplifiedHierarchyLevel.class));

...
import io.kestra.plugin.atlassian_jira.client.model.JsonNode;
...
public class IssueEntityPropertiesForMultiUpdate {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("issueID", "properties"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!IssueEntityPropertiesForMultiUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON
                                                                                  // element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssueEntityPropertiesForMultiUpdate is not found in the empty JSON string",
            IssueEntityPropertiesForMultiUpdate.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!IssueEntityPropertiesForMultiUpdate.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `IssueEntityPropertiesForMultiUpdate` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!IssueEntityPropertiesForMultiUpdate.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'IssueEntityPropertiesForMultiUpdate' and its
                     // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<IssueEntityPropertiesForMultiUpdate> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssueEntityPropertiesForMultiUpdate.class));
  ...
  /**
   * Create an instance of IssueEntityPropertiesForMultiUpdate given an JSON
   * string
   *

...
public class UpdateCustomFieldDetails {
   ...
   * set to &#x60;null&#x60;, otherwise you must specify the valid searcher for
   * the field type, as listed below (abbreviated values shown): *
   * &#x60;cascadingselect&#x60;: &#x60;cascadingselectsearcher&#x60; *
   * &#x60;datepicker&#x60;: &#x60;daterange&#x60; * &#x60;datetime&#x60;:
   * &#x60;datetimerange&#x60; * &#x60;float&#x60;: &#x60;exactnumber&#x60; or
   * &#x60;numberrange&#x60; * &#x60;grouppicker&#x60;:
   * &#x60;grouppickersearcher&#x60; * &#x60;importid&#x60;:
   * &#x60;exactnumber&#x60; or &#x60;numberrange&#x60; * &#x60;labels&#x60;:
   * &#x60;labelsearcher&#x60; * &#x60;multicheckboxes&#x60;:
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("description", "name", "searcherKey"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!UpdateCustomFieldDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in UpdateCustomFieldDetails is not found in the empty JSON string",
            UpdateCustomFieldDetails.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!UpdateCustomFieldDetails.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `UpdateCustomFieldDetails` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<UpdateCustomFieldDetails> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(UpdateCustomFieldDetails.class));

...
public class SecuritySchemes {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("issueSecuritySchemes"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!SecuritySchemes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in SecuritySchemes is not found in the empty JSON string",
            SecuritySchemes.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!SecuritySchemes.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `SecuritySchemes` properties. JSON: %s",
    ...
    if (jsonObj.get("issueSecuritySchemes") != null && !jsonObj.get("issueSecuritySchemes").isJsonNull()) {
      ...
      if (jsonArrayissueSecuritySchemes != null) {
        ...
        if (!jsonObj.get("issueSecuritySchemes").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `issueSecuritySchemes` to be an array in the JSON string but got `%s`",
              jsonObj.get("issueSecuritySchemes").toString()));
        }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<SecuritySchemes> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(SecuritySchemes.class));

...
public class IssueTransition {
   ...
   * information to populate &#x60;fields&#x60; and &#x60;update&#x60; in a
   * transition request.
   * 
   * @return fields
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(expand, fields, hasScreen, id, isAvailable, isConditional, isGlobal, isInitial, looped, name,
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("expand", "fields", "hasScreen", "id", "isAvailable",
        "isConditional", "isGlobal", "isInitial", "looped", "name", "to"));
    ...
    if (jsonElement == null) {
      if (!IssueTransition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssueTransition is not found in the empty JSON string",
            IssueTransition.openapiRequiredFields.toString()));
      }
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssueTransition> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssueTransition.class));

...
public class ProjectComponent {
   ...
   * this component. See &#x60;realAssigneeType&#x60; for details on how the type
   * of the user, and hence the user, assigned to issues is determined. Can take
   * the following values: * &#x60;PROJECT_LEAD&#x60; the assignee to any issues
   * created with this component is nominally the lead for the project the
   * component is in. * &#x60;COMPONENT_LEAD&#x60; the assignee to any issues
   * created with this component is nominally the lead for the component. *
   * &#x60;UNASSIGNED&#x60; an assignee is not set for issues created with this
   * component. * &#x60;PROJECT_DEFAULT&#x60; the assignee to any issues created
   * with this component is nominally the default assignee for the project that
   * the component is in. Default value: &#x60;PROJECT_DEFAULT&#x60;. Optional
   ...
   * component, when an assignee cannot be set from the &#x60;assigneeType&#x60;.
   * For example, &#x60;assigneeType&#x60; is set to &#x60;COMPONENT_LEAD&#x60;
   * but no component lead is set. This property is set to one of the following
   * values: * &#x60;PROJECT_LEAD&#x60; when &#x60;assigneeType&#x60; is
   * &#x60;PROJECT_LEAD&#x60; and the project lead has permission to be assigned
   * issues in the project that the component is in. * &#x60;COMPONENT_LEAD&#x60;
   * when &#x60;assignee&#x60;Type is &#x60;COMPONENT_LEAD&#x60; and the component
   * lead has permission to be assigned issues in the project that the component
   * is in. * &#x60;UNASSIGNED&#x60; when &#x60;assigneeType&#x60; is
   * &#x60;UNASSIGNED&#x60; and Jira is configured to allow unassigned issues. *
   ...
   * the &#x60;assigneeType&#x60; is set to &#x60;COMPONENT_LEAD&#x60; but the
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ari, assignee, assigneeType, description, id, isAssigneeTypeValid, lead, leadAccountId,
        leadUserName, metadata, name, project, projectId, realAssignee, realAssigneeType, self);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ari", "assignee", "assigneeType", "description", "id",
        "isAssigneeTypeValid", "lead", "leadAccountId", "leadUserName", "metadata", "name", "project", "projectId",
        "realAssignee", "realAssigneeType", "self"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ProjectComponent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in ProjectComponent is not found in the empty JSON string",
            ProjectComponent.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ProjectComponent.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ProjectComponent` properties. JSON: %s",
    ...
    if ((jsonObj.get("ari") != null && !jsonObj.get("ari").isJsonNull()) && !jsonObj.get("ari").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `ari` to be a primitive type in the JSON string but got `%s`",
              jsonObj.get("ari").toString()));
    }
    ...
    if ((jsonObj.get("leadUserName") != null && !jsonObj.get("leadUserName").isJsonNull())
        && !jsonObj.get("leadUserName").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `leadUserName` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("leadUserName").toString()));
    }
    ...
    if ((jsonObj.get("realAssigneeType") != null && !jsonObj.get("realAssigneeType").isJsonNull())
        && !jsonObj.get("realAssigneeType").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `realAssigneeType` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("realAssigneeType").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ProjectComponent> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(ProjectComponent.class));

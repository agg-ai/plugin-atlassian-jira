...
public class GroupDetails {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("groupId", "name"));
    ...
    if (jsonElement == null) {
      if (!GroupDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in GroupDetails is not found in the empty JSON string",
                GroupDetails.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!GroupDetails.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `GroupDetails` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<GroupDetails> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(GroupDetails.class));

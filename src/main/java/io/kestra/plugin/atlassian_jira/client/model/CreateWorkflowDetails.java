...
import io.kestra.plugin.atlassian_jira.client.model.CreateWorkflowStatusDetails;
import io.kestra.plugin.atlassian_jira.client.model.CreateWorkflowTransitionDetails;
...
public class CreateWorkflowDetails {
  ...
  /**
   * The statuses of the workflow. Any status that does not include a transition
   * is added to the workflow without a transition.
   * 
   * @return statuses
   */
  @javax.annotation.Nonnull
  ...
  public CreateWorkflowDetails transitions(
      @javax.annotation.Nonnull List<CreateWorkflowTransitionDetails> transitions) {
   ...
   * transitions must: * include one *initial* transition. * not use the same name
   * for a *global* and *directed* transition. * have a unique name for each
   * *global* transition. * have a unique &#39;to&#39; status for each *global*
   * transition. * have unique names for each transition from a status. * not have
   * a &#39;from&#39; status on *initial* and *global* transitions. * have a
   * &#39;from&#39; status on *directed* transitions. All the transition statuses
   * must be included in &#x60;statuses&#x60;.
   * 
   * @return transitions
   */
  @javax.annotation.Nonnull
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("description", "name", "statuses", "transitions"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "statuses", "transitions"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CreateWorkflowDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CreateWorkflowDetails is not found in the empty JSON string",
            CreateWorkflowDetails.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CreateWorkflowDetails.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CreateWorkflowDetails` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<CreateWorkflowDetails> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CreateWorkflowDetails.class));

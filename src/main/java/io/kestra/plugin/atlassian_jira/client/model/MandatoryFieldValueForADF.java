...
public class MandatoryFieldValueForADF {
  ...
  /**
   * Will treat as &#x60;MandatoryFieldValueForADF&#x60; if type is
   * &#x60;adf&#x60;
   */
  ...
  /**
   * If &#x60;true&#x60;, will try to retain original non-null issue field values
   * on move.
   * 
   * @return retain
   */
   ...
   * fields like &#x60;description&#x60;, &#x60;environments&#x60;. For ADF format
   * details, refer to: [Atlassian Document
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!MandatoryFieldValueForADF.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in MandatoryFieldValueForADF is not found in the empty JSON string",
            MandatoryFieldValueForADF.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!MandatoryFieldValueForADF.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `MandatoryFieldValueForADF` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<MandatoryFieldValueForADF> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(MandatoryFieldValueForADF.class));

...
public class UiModificationIdentifiers {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "self"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "self"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!UiModificationIdentifiers.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in UiModificationIdentifiers is not found in the empty JSON string",
            UiModificationIdentifiers.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!UiModificationIdentifiers.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `UiModificationIdentifiers` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<UiModificationIdentifiers> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(UiModificationIdentifiers.class));

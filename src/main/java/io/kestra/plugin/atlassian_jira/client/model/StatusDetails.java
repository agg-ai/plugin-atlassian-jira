...
public class StatusDetails {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("description", "iconUrl", "id", "name", "scope", "self", "statusCategory"));
    ...
    if (jsonElement == null) {
      if (!StatusDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in StatusDetails is not found in the empty JSON string",
            StatusDetails.openapiRequiredFields.toString()));
      }
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<StatusDetails> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(StatusDetails.class));

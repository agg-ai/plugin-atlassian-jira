...
public class UserPermission {
   ...
   * cannot be used in the &#x60;permissions parameter of Get my permissions.
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("deprecatedKey", "description", "havePermission", "id", "key", "name", "type"));
    ...
    if (jsonElement == null) {
      if (!UserPermission.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in UserPermission is not found in the empty JSON string",
            UserPermission.openapiRequiredFields.toString()));
      }
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<UserPermission> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(UserPermission.class));

...
public class IssuesAndJQLQueries {
  ...
  public IssuesAndJQLQueries issueIds(@javax.annotation.Nonnull Set<Long> issueIds) {
  ...
  public void setIssueIds(@javax.annotation.Nonnull Set<Long> issueIds) {
    this.issueIds = issueIds;
  }

  public IssuesAndJQLQueries jqls(@javax.annotation.Nonnull List<String> jqls) {
    this.jqls = jqls;
    return this;
  }
  ...
  public void setJqls(@javax.annotation.Nonnull List<String> jqls) {
    this.jqls = jqls;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("issueIds", "jqls"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("issueIds", "jqls"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!IssuesAndJQLQueries.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssuesAndJQLQueries is not found in the empty JSON string",
            IssuesAndJQLQueries.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!IssuesAndJQLQueries.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `IssuesAndJQLQueries` properties. JSON: %s",
    ...
    if (jsonObj.get("jqls") == null) {
      ...
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `jqls` to be an array in the JSON string but got `%s`", jsonObj.get("jqls").toString()));
    }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssuesAndJQLQueries> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssuesAndJQLQueries.class));

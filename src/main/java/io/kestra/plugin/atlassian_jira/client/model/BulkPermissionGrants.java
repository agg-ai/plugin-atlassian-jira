...
import io.kestra.plugin.atlassian_jira.client.model.BulkProjectPermissionGrants;
...
public class BulkPermissionGrants {
  ...
  public BulkPermissionGrants projectPermissions(
      @javax.annotation.Nonnull Set<BulkProjectPermissionGrants> projectPermissions) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!BulkPermissionGrants.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in BulkPermissionGrants is not found in the empty JSON string",
            BulkPermissionGrants.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!BulkPermissionGrants.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `BulkPermissionGrants` properties. JSON: %s",
    ...
    if (jsonObj.get("globalPermissions") == null) {
      ...
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `globalPermissions` to be an array in the JSON string but got `%s`",
          jsonObj.get("globalPermissions").toString()));
    }
    // ensure the json data is an array
    if (!jsonObj.get("projectPermissions").isJsonArray()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `projectPermissions` to be an array in the JSON string but got `%s`",
          jsonObj.get("projectPermissions").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<BulkPermissionGrants> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(BulkPermissionGrants.class));

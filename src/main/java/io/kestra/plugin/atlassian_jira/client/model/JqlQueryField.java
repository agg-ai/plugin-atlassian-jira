...
import io.kestra.plugin.atlassian_jira.client.model.JqlQueryFieldEntityProperty;
...
public class JqlQueryField {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("encodedName", "name", "property"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!JqlQueryField.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in JqlQueryField is not found in the empty JSON string",
            JqlQueryField.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!JqlQueryField.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `JqlQueryField` properties. JSON: %s",
    ...
    if ((jsonObj.get("encodedName") != null && !jsonObj.get("encodedName").isJsonNull())
        && !jsonObj.get("encodedName").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `encodedName` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("encodedName").toString()));
    }
    ...
    if (jsonObj.get("property") != null && !jsonObj.get("property").isJsonNull()) {
      ...
      if (jsonArrayproperty != null) {
        ...
        if (!jsonObj.get("property").isJsonArray()) {
          throw new IllegalArgumentException(
              String.format(Locale.ROOT, "Expected the field `property` to be an array in the JSON string but got `%s`",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<JqlQueryField> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(JqlQueryField.class));

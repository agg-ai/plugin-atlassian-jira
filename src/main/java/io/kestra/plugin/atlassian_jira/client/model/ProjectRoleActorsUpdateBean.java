...
public class ProjectRoleActorsUpdateBean {
  ...
  public ProjectRoleActorsUpdateBean categorisedActors(
      @javax.annotation.Nullable Map<String, List<String>> categorisedActors) {
   ...
   * &#x60;atlassian-group-role-actor-id&#x60; and a list of group IDs. As a
   * group&#39;s name can change, use of &#x60;atlassian-group-role-actor-id&#x60;
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("categorisedActors", "id"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ProjectRoleActorsUpdateBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                          // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in ProjectRoleActorsUpdateBean is not found in the empty JSON string",
            ProjectRoleActorsUpdateBean.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ProjectRoleActorsUpdateBean.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ProjectRoleActorsUpdateBean` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ProjectRoleActorsUpdateBean> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(ProjectRoleActorsUpdateBean.class));

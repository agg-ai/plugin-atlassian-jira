...
import io.kestra.plugin.atlassian_jira.client.model.CustomFieldOptionCreate;
...
public class BulkCustomFieldOptionCreateRequest {
  ...
  public BulkCustomFieldOptionCreateRequest options(@javax.annotation.Nullable List<CustomFieldOptionCreate> options) {
  ...
  public void setOptions(@javax.annotation.Nullable List<CustomFieldOptionCreate> options) {
    this.options = options;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!BulkCustomFieldOptionCreateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element
                                                                                 // is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in BulkCustomFieldOptionCreateRequest is not found in the empty JSON string",
            BulkCustomFieldOptionCreateRequest.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!BulkCustomFieldOptionCreateRequest.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `BulkCustomFieldOptionCreateRequest` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!BulkCustomFieldOptionCreateRequest.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'BulkCustomFieldOptionCreateRequest' and its
                     // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<BulkCustomFieldOptionCreateRequest> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(BulkCustomFieldOptionCreateRequest.class));

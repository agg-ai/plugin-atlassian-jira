 ...
 * WAS \&quot;Resolved\&quot; BY currentUser() BEFORE
 * \&quot;2019/02/02\&quot;&#x60;. See
...
public class FieldWasClause {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("field", "operand", "operator", "predicates"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("field", "operand", "operator", "predicates"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!FieldWasClause.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in FieldWasClause is not found in the empty JSON string",
            FieldWasClause.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!FieldWasClause.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `FieldWasClause` properties. JSON: %s",
    ...
    if (!jsonObj.get("predicates").isJsonArray()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `predicates` to be an array in the JSON string but got `%s`",
              jsonObj.get("predicates").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<FieldWasClause> thisAdapter = gson.getDelegateAdapter(this,

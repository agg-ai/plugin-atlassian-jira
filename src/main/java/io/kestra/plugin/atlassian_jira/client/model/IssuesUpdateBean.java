...
public class IssuesUpdateBean {
  ...
  public IssuesUpdateBean issueUpdates(@javax.annotation.Nullable List<IssueUpdateDetails> issueUpdates) {
  ...
  public void setIssueUpdates(@javax.annotation.Nullable List<IssueUpdateDetails> issueUpdates) {
    this.issueUpdates = issueUpdates;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("issueUpdates"));
    ...
    if (jsonElement == null) {
      if (!IssuesUpdateBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssuesUpdateBean is not found in the empty JSON string",
            IssuesUpdateBean.openapiRequiredFields.toString()));
      }
    }
    JsonObject jsonObj = jsonElement.getAsJsonObject();
    // ensure the optional json data is an array if present
    if (jsonObj.get("issueUpdates") != null && !jsonObj.get("issueUpdates").isJsonNull()
        && !jsonObj.get("issueUpdates").isJsonArray()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `issueUpdates` to be an array in the JSON string but got `%s`",
              jsonObj.get("issueUpdates").toString()));
    }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssuesUpdateBean> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssuesUpdateBean.class));

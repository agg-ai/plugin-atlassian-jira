...
import io.kestra.plugin.atlassian_jira.client.model.NotificationSchemeEventPayload;
 ...
 * payload and should be left empty, for TMP it&#39;s provided using this
 * payload
 */
...
public class NotificationSchemePayload {
  ...
  public NotificationSchemePayload notificationSchemeEvents(
      @javax.annotation.Nullable List<NotificationSchemeEventPayload> notificationSchemeEvents) {
    this.notificationSchemeEvents = notificationSchemeEvents;
    return this;
  }

  public NotificationSchemePayload addNotificationSchemeEventsItem(
      NotificationSchemeEventPayload notificationSchemeEventsItem) {
  ...
  public void setNotificationSchemeEvents(
      @javax.annotation.Nullable List<NotificationSchemeEventPayload> notificationSchemeEvents) {
    this.notificationSchemeEvents = notificationSchemeEvents;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("description", "name", "notificationSchemeEvents", "onConflict", "pcri"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!NotificationSchemePayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in NotificationSchemePayload is not found in the empty JSON string",
            NotificationSchemePayload.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!NotificationSchemePayload.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `NotificationSchemePayload` properties. JSON: %s",
    ...
    if (jsonObj.get("notificationSchemeEvents") != null && !jsonObj.get("notificationSchemeEvents").isJsonNull()) {
      ...
      if (jsonArraynotificationSchemeEvents != null) {
        ...
        if (!jsonObj.get("notificationSchemeEvents").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `notificationSchemeEvents` to be an array in the JSON string but got `%s`",
              jsonObj.get("notificationSchemeEvents").toString()));
        }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<NotificationSchemePayload> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(NotificationSchemePayload.class));

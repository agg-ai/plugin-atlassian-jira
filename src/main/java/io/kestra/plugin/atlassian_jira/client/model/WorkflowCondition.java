...
import io.kestra.plugin.atlassian_jira.client.model.WorkflowCompoundCondition;
import io.kestra.plugin.atlassian_jira.client.model.WorkflowSimpleCondition;
...
public class WorkflowCondition extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<WorkflowSimpleCondition> adapterWorkflowSimpleCondition = gson.getDelegateAdapter(this,
                    TypeToken.get(WorkflowSimpleCondition.class));
            final TypeAdapter<WorkflowCompoundCondition> adapterWorkflowCompoundCondition = gson
                    .getDelegateAdapter(this, TypeToken.get(WorkflowCompoundCondition.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<WorkflowCondition>() {
                ...
                public void write(JsonWriter out, WorkflowCondition value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof WorkflowSimpleCondition) {
                        JsonElement element = adapterWorkflowSimpleCondition
                                .toJsonTree((WorkflowSimpleCondition) value.getActualInstance());
                    ...
                    if (value.getActualInstance() instanceof WorkflowCompoundCondition) {
                        JsonElement element = adapterWorkflowCompoundCondition
                                .toJsonTree((WorkflowCompoundCondition) value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    throw new IOException(
                            "Failed to serialize as the type doesn't match oneOf schemas: WorkflowCompoundCondition, WorkflowSimpleCondition");
                }
                ...
                public WorkflowCondition read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        errorMessages.add(String.format(Locale.ROOT,
                                "Deserialization for WorkflowSimpleCondition failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(Locale.ROOT,
                                "Deserialization for WorkflowCompoundCondition failed with `%s`.", e.getMessage()));
                    ...
                    throw new IOException(String.format(Locale.ROOT,
                            "Failed deserialization for WorkflowCondition: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s",
     ...
     * WorkflowCompoundCondition, WorkflowSimpleCondition
     *
     * @return The actual instance (WorkflowCompoundCondition,
    ...
    /**
     * Get the actual instance of `WorkflowSimpleCondition`. If the actual instance
     * is not `WorkflowSimpleCondition`,
    ...
    /**
     * Get the actual instance of `WorkflowCompoundCondition`. If the actual
     * instance is not `WorkflowCompoundCondition`,
     * the ClassCastException will be thrown.
     *
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(Locale.ROOT,
                    "The JSON string is invalid for WorkflowCondition with oneOf schemas: WorkflowCompoundCondition, WorkflowSimpleCondition. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s",

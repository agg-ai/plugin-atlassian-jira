...
public class PrioritySchemeWithPaginatedPrioritiesAndProjects {
  ...
  public PrioritySchemeWithPaginatedPrioritiesAndProjects defaultPriorityId(
      @javax.annotation.Nullable String defaultPriorityId) {
  ...
  public PrioritySchemeWithPaginatedPrioritiesAndProjects priorities(
      @javax.annotation.Nullable PageBeanPriorityWithSequence priorities) {
  ...
  public PrioritySchemeWithPaginatedPrioritiesAndProjects projects(
      @javax.annotation.Nullable PageBeanProjectDetails projects) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._default, prioritySchemeWithPaginatedPrioritiesAndProjects._default) &&
        ...
        Objects.equals(this.additionalProperties,
            prioritySchemeWithPaginatedPrioritiesAndProjects.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_default, defaultPriorityId, description, id, isDefault, name, priorities, projects, self,
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("default", "defaultPriorityId", "description", "id", "isDefault",
        "name", "priorities", "projects", "self"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PrioritySchemeWithPaginatedPrioritiesAndProjects.openapiRequiredFields.isEmpty()) { // has required fields
                                                                                               // but JSON element is
                                                                                               // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in PrioritySchemeWithPaginatedPrioritiesAndProjects is not found in the empty JSON string",
            PrioritySchemeWithPaginatedPrioritiesAndProjects.openapiRequiredFields.toString()));
      }
    }
    ...
    if ((jsonObj.get("defaultPriorityId") != null && !jsonObj.get("defaultPriorityId").isJsonNull())
        && !jsonObj.get("defaultPriorityId").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `defaultPriorityId` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("defaultPriorityId").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!PrioritySchemeWithPaginatedPrioritiesAndProjects.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'PrioritySchemeWithPaginatedPrioritiesAndProjects'
                     // and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<PrioritySchemeWithPaginatedPrioritiesAndProjects> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(PrioritySchemeWithPaginatedPrioritiesAndProjects.class));
  ...
  /**
   * Create an instance of PrioritySchemeWithPaginatedPrioritiesAndProjects given
   * an JSON string
   *
  ...
  /**
   * Convert an instance of PrioritySchemeWithPaginatedPrioritiesAndProjects to an
   * JSON string
   *
   * @return JSON string
   */

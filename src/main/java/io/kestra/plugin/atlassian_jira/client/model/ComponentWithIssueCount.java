...
public class ComponentWithIssueCount {
   ...
   * of the user, and hence the user, assigned to issues is determined. Takes the
   * following values: * &#x60;PROJECT_LEAD&#x60; the assignee to any issues
  ...
  @Override
  public int hashCode() {
    return Objects.hash(assignee, assigneeType, description, id, isAssigneeTypeValid, issueCount, lead, name, project,
        projectId, realAssignee, realAssigneeType, self);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("assignee", "assigneeType", "description", "id", "isAssigneeTypeValid", "issueCount", "lead",
            "name", "project", "projectId", "realAssignee", "realAssigneeType", "self"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ComponentWithIssueCount.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in ComponentWithIssueCount is not found in the empty JSON string",
            ComponentWithIssueCount.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ComponentWithIssueCount.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ComponentWithIssueCount` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ComponentWithIssueCount> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(ComponentWithIssueCount.class));

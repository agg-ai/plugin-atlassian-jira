...
public class StatusMappingDTO {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!StatusMappingDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in StatusMappingDTO is not found in the empty JSON string",
            StatusMappingDTO.openapiRequiredFields.toString()));
      }
    }
    ...
    if (jsonObj.get("statusMigrations") == null) {
      ...
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `statusMigrations` to be an array in the JSON string but got `%s`",
          jsonObj.get("statusMigrations").toString()));
    }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<StatusMappingDTO> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(StatusMappingDTO.class));

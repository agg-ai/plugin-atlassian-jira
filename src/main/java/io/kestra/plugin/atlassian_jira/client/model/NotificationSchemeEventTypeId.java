...
public class NotificationSchemeEventTypeId {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!NotificationSchemeEventTypeId.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                            // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in NotificationSchemeEventTypeId is not found in the empty JSON string",
            NotificationSchemeEventTypeId.openapiRequiredFields.toString()));
      }
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<NotificationSchemeEventTypeId> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(NotificationSchemeEventTypeId.class));

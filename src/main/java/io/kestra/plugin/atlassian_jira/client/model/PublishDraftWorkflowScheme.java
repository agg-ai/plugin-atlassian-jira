...
import io.kestra.plugin.atlassian_jira.client.model.StatusMapping;
...
public class PublishDraftWorkflowScheme {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("statusMappings"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PublishDraftWorkflowScheme.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in PublishDraftWorkflowScheme is not found in the empty JSON string",
            PublishDraftWorkflowScheme.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PublishDraftWorkflowScheme.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `PublishDraftWorkflowScheme` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<PublishDraftWorkflowScheme> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(PublishDraftWorkflowScheme.class));

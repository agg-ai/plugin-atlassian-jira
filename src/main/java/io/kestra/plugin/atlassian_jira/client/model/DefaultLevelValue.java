...
public class DefaultLevelValue {
  ...
  public DefaultLevelValue defaultLevelId(@javax.annotation.Nonnull String defaultLevelId) {
  ...
  public void setDefaultLevelId(@javax.annotation.Nonnull String defaultLevelId) {
    this.defaultLevelId = defaultLevelId;
  }

  public DefaultLevelValue issueSecuritySchemeId(@javax.annotation.Nonnull String issueSecuritySchemeId) {
  ...
  public void setIssueSecuritySchemeId(@javax.annotation.Nonnull String issueSecuritySchemeId) {
    this.issueSecuritySchemeId = issueSecuritySchemeId;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("defaultLevelId", "issueSecuritySchemeId"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("defaultLevelId", "issueSecuritySchemeId"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!DefaultLevelValue.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in DefaultLevelValue is not found in the empty JSON string",
            DefaultLevelValue.openapiRequiredFields.toString()));
      }
    }
    ...
    if (!jsonObj.get("defaultLevelId").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `defaultLevelId` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("defaultLevelId").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<DefaultLevelValue> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(DefaultLevelValue.class));

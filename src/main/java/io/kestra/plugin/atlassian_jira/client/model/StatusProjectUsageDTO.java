...
import io.kestra.plugin.atlassian_jira.client.model.StatusProjectUsagePage;
...
public class StatusProjectUsageDTO {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!StatusProjectUsageDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in StatusProjectUsageDTO is not found in the empty JSON string",
            StatusProjectUsageDTO.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!StatusProjectUsageDTO.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `StatusProjectUsageDTO` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<StatusProjectUsageDTO> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(StatusProjectUsageDTO.class));

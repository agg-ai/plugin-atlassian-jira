...
import io.kestra.plugin.atlassian_jira.client.model.RemoveOptionFromIssuesResult;
...
public class TaskProgressBeanRemoveOptionFromIssuesResult {
  ...
  public TaskProgressBeanRemoveOptionFromIssuesResult result(
      @javax.annotation.Nullable RemoveOptionFromIssuesResult result) {
    this.result = result;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, elapsedRuntime, finished, id, lastUpdate, message, progress, result, self, started,
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("description", "elapsedRuntime", "finished", "id", "lastUpdate",
        "message", "progress", "result", "self", "started", "status", "submitted", "submittedBy"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(
        Arrays.asList("elapsedRuntime", "id", "lastUpdate", "progress", "self", "status", "submitted", "submittedBy"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!TaskProgressBeanRemoveOptionFromIssuesResult.openapiRequiredFields.isEmpty()) { // has required fields but
                                                                                           // JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in TaskProgressBeanRemoveOptionFromIssuesResult is not found in the empty JSON string",
            TaskProgressBeanRemoveOptionFromIssuesResult.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!TaskProgressBeanRemoveOptionFromIssuesResult.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `TaskProgressBeanRemoveOptionFromIssuesResult` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!TaskProgressBeanRemoveOptionFromIssuesResult.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'TaskProgressBeanRemoveOptionFromIssuesResult' and
                     // its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<TaskProgressBeanRemoveOptionFromIssuesResult> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(TaskProgressBeanRemoveOptionFromIssuesResult.class));
  ...
  /**
   * Create an instance of TaskProgressBeanRemoveOptionFromIssuesResult given an
   * JSON string
   *
  ...
  /**
   * Convert an instance of TaskProgressBeanRemoveOptionFromIssuesResult to an
   * JSON string
   *
   * @return JSON string
   */

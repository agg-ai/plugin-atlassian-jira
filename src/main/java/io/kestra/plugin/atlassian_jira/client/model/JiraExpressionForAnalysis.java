...
public class JiraExpressionForAnalysis {
   ...
   * such as &#x60;issue&#x60; or &#x60;project&#x60;, are available in context
   * and sets their type. Use this property to override the default types or
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("contextVariables", "expressions"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("expressions"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!JiraExpressionForAnalysis.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in JiraExpressionForAnalysis is not found in the empty JSON string",
            JiraExpressionForAnalysis.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!JiraExpressionForAnalysis.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `JiraExpressionForAnalysis` properties. JSON: %s",
    ...
    if (jsonObj.get("expressions") == null) {
      ...
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `expressions` to be an array in the JSON string but got `%s`",
              jsonObj.get("expressions").toString()));
    }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<JiraExpressionForAnalysis> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(JiraExpressionForAnalysis.class));

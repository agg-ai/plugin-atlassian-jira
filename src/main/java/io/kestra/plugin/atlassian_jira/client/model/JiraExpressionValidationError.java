 ...
 * expression, unless the object includes: * &#x60;line&#x60; and
 * &#x60;column&#x60; * &#x60;expression&#x60;
 */
...
public class JiraExpressionValidationError {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!JiraExpressionValidationError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                            // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in JiraExpressionValidationError is not found in the empty JSON string",
            JiraExpressionValidationError.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!JiraExpressionValidationError.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `JiraExpressionValidationError` properties. JSON: %s",
    ...
    if ((jsonObj.get("expression") != null && !jsonObj.get("expression").isJsonNull())
        && !jsonObj.get("expression").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<JiraExpressionValidationError> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(JiraExpressionValidationError.class));

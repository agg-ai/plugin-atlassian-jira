...
import io.kestra.plugin.atlassian_jira.client.model.HistoryMetadataParticipant;
...
public class HistoryMetadata {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(activityDescription, activityDescriptionKey, actor, cause, description, descriptionKey,
        emailDescription, emailDescriptionKey, extraData, generator, type, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("activityDescription", "activityDescriptionKey", "actor", "cause",
        "description", "descriptionKey", "emailDescription", "emailDescriptionKey", "extraData", "generator", "type"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!HistoryMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in HistoryMetadata is not found in the empty JSON string",
            HistoryMetadata.openapiRequiredFields.toString()));
      }
    }
    JsonObject jsonObj = jsonElement.getAsJsonObject();
    if ((jsonObj.get("activityDescription") != null && !jsonObj.get("activityDescription").isJsonNull())
        && !jsonObj.get("activityDescription").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `activityDescription` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("activityDescription").toString()));
    }
    if ((jsonObj.get("activityDescriptionKey") != null && !jsonObj.get("activityDescriptionKey").isJsonNull())
        && !jsonObj.get("activityDescriptionKey").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `activityDescriptionKey` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("activityDescriptionKey").toString()));
    }
    ...
    if ((jsonObj.get("descriptionKey") != null && !jsonObj.get("descriptionKey").isJsonNull())
        && !jsonObj.get("descriptionKey").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `descriptionKey` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("descriptionKey").toString()));
    }
    if ((jsonObj.get("emailDescription") != null && !jsonObj.get("emailDescription").isJsonNull())
        && !jsonObj.get("emailDescription").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `emailDescription` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("emailDescription").toString()));
    }
    if ((jsonObj.get("emailDescriptionKey") != null && !jsonObj.get("emailDescriptionKey").isJsonNull())
        && !jsonObj.get("emailDescriptionKey").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `emailDescriptionKey` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("emailDescriptionKey").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<HistoryMetadata> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(HistoryMetadata.class));

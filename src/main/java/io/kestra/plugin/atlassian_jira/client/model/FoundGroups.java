...
import io.kestra.plugin.atlassian_jira.client.model.FoundGroup;
...
public class FoundGroups {
    ...
    if (jsonElement == null) {
      if (!FoundGroups.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in FoundGroups is not found in the empty JSON string",
                FoundGroups.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!FoundGroups.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `FoundGroups` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<FoundGroups> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(FoundGroups.class));

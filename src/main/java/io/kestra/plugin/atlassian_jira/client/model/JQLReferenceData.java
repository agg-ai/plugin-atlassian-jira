...
import io.kestra.plugin.atlassian_jira.client.model.FieldReferenceData;
import io.kestra.plugin.atlassian_jira.client.model.FunctionReferenceData;
...
public class JQLReferenceData {
  ...
  public JQLReferenceData visibleFunctionNames(
      @javax.annotation.Nullable List<FunctionReferenceData> visibleFunctionNames) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!JQLReferenceData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in JQLReferenceData is not found in the empty JSON string",
            JQLReferenceData.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!JQLReferenceData.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `JQLReferenceData` properties. JSON: %s",
            entry.getKey(), jsonElement.toString()));
      }
    }
    JsonObject jsonObj = jsonElement.getAsJsonObject();
    // ensure the optional json data is an array if present
    if (jsonObj.get("jqlReservedWords") != null && !jsonObj.get("jqlReservedWords").isJsonNull()
        && !jsonObj.get("jqlReservedWords").isJsonArray()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `jqlReservedWords` to be an array in the JSON string but got `%s`",
          jsonObj.get("jqlReservedWords").toString()));
    }
    if (jsonObj.get("visibleFieldNames") != null && !jsonObj.get("visibleFieldNames").isJsonNull()) {
      ...
      if (jsonArrayvisibleFieldNames != null) {
        ...
        if (!jsonObj.get("visibleFieldNames").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `visibleFieldNames` to be an array in the JSON string but got `%s`",
              jsonObj.get("visibleFieldNames").toString()));
        }
    ...
    if (jsonObj.get("visibleFunctionNames") != null && !jsonObj.get("visibleFunctionNames").isJsonNull()) {
      ...
      if (jsonArrayvisibleFunctionNames != null) {
        ...
        if (!jsonObj.get("visibleFunctionNames").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `visibleFunctionNames` to be an array in the JSON string but got `%s`",
              jsonObj.get("visibleFunctionNames").toString()));
        }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<JQLReferenceData> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(JQLReferenceData.class));

...
public class IssueTypeScreenSchemeProjectAssociation {
  ...
  public IssueTypeScreenSchemeProjectAssociation issueTypeScreenSchemeId(
      @javax.annotation.Nullable String issueTypeScreenSchemeId) {
  ...
  public void setIssueTypeScreenSchemeId(@javax.annotation.Nullable String issueTypeScreenSchemeId) {
    this.issueTypeScreenSchemeId = issueTypeScreenSchemeId;
  }

  public IssueTypeScreenSchemeProjectAssociation projectId(@javax.annotation.Nullable String projectId) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("issueTypeScreenSchemeId", "projectId"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!IssueTypeScreenSchemeProjectAssociation.openapiRequiredFields.isEmpty()) { // has required fields but JSON
                                                                                      // element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssueTypeScreenSchemeProjectAssociation is not found in the empty JSON string",
            IssueTypeScreenSchemeProjectAssociation.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!IssueTypeScreenSchemeProjectAssociation.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `IssueTypeScreenSchemeProjectAssociation` properties. JSON: %s",
            entry.getKey(), jsonElement.toString()));
      }
    }
    JsonObject jsonObj = jsonElement.getAsJsonObject();
    if ((jsonObj.get("issueTypeScreenSchemeId") != null && !jsonObj.get("issueTypeScreenSchemeId").isJsonNull())
        && !jsonObj.get("issueTypeScreenSchemeId").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!IssueTypeScreenSchemeProjectAssociation.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'IssueTypeScreenSchemeProjectAssociation' and its
                     // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<IssueTypeScreenSchemeProjectAssociation> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssueTypeScreenSchemeProjectAssociation.class));
  ...
  /**
   * Create an instance of IssueTypeScreenSchemeProjectAssociation given an JSON
   * string
   *
  ...
  /**
   * Convert an instance of IssueTypeScreenSchemeProjectAssociation to an JSON
   * string
   *
   * @return JSON string
   */

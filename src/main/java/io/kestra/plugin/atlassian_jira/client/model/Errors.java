...
import io.kestra.plugin.atlassian_jira.client.model.Error;
...
public class Errors {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("issueIsSubtask", "issuesInArchivedProjects",
        "issuesInUnlicensedProjects", "issuesNotFound", "userDoesNotHavePermission"));
    ...
    if (jsonElement == null) {
      if (!Errors.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in Errors is not found in the empty JSON string",
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!Errors.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `Errors` properties. JSON: %s", entry.getKey(),
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<Errors> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(Errors.class));

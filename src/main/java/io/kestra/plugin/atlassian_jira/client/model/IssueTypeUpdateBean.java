...
public class IssueTypeUpdateBean {
  ...
  public IssueTypeUpdateBean avatarId(@javax.annotation.Nullable Long avatarId) {
   ...
   * following endpoints: * [System issue type avatar IDs
  ...
  public IssueTypeUpdateBean description(@javax.annotation.Nullable String description) {
  ...
  public IssueTypeUpdateBean name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("avatarId", "description", "name"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!IssueTypeUpdateBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssueTypeUpdateBean is not found in the empty JSON string",
            IssueTypeUpdateBean.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!IssueTypeUpdateBean.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `IssueTypeUpdateBean` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssueTypeUpdateBean> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssueTypeUpdateBean.class));

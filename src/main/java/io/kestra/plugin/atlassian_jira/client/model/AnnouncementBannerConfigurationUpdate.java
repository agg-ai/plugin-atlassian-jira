...
public class AnnouncementBannerConfigurationUpdate {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!AnnouncementBannerConfigurationUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON
                                                                                    // element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in AnnouncementBannerConfigurationUpdate is not found in the empty JSON string",
            AnnouncementBannerConfigurationUpdate.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!AnnouncementBannerConfigurationUpdate.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `AnnouncementBannerConfigurationUpdate` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!AnnouncementBannerConfigurationUpdate.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'AnnouncementBannerConfigurationUpdate' and its
                     // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<AnnouncementBannerConfigurationUpdate> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(AnnouncementBannerConfigurationUpdate.class));
  ...
  /**
   * Create an instance of AnnouncementBannerConfigurationUpdate given an JSON
   * string
   *
  ...
  /**
   * Convert an instance of AnnouncementBannerConfigurationUpdate to an JSON
   * string
   *
   * @return JSON string
   */

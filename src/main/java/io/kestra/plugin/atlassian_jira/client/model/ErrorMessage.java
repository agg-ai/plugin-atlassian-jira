...
public class ErrorMessage {
    ...
    if (jsonElement == null) {
      if (!ErrorMessage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in ErrorMessage is not found in the empty JSON string",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ErrorMessage> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(ErrorMessage.class));

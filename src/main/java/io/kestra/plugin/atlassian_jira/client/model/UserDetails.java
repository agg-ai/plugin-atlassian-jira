 ...
 * However, be aware of these exceptions: * User record deleted from Atlassian:
 * This occurs as the result of a right to be forgotten request. In this case,
 * &#x60;displayName&#x60; provides an indication and other parameters have
 * default values or are blank (for example, email is blank). * User record
 * corrupted: This occurs as a results of events such as a server import and can
 * only happen to deleted users. In this case, &#x60;accountId&#x60; returns
 * *unknown* and all other parameters have fallback values. * User record
...
public class UserDetails {
   ...
   * &#39;atlassian&#39; (normal users), &#39;app&#39; (application user) or
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, accountType, active, avatarUrls, displayName, emailAddress, key, name, self,
        timeZone);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("accountId", "accountType", "active", "avatarUrls", "displayName",
        "emailAddress", "key", "name", "self", "timeZone"));
    ...
    if (jsonElement == null) {
      if (!UserDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in UserDetails is not found in the empty JSON string",
                UserDetails.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!UserDetails.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `UserDetails` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<UserDetails> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(UserDetails.class));

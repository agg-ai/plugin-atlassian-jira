...
public class CustomFieldContextDefaultValueMultipleGroupPicker {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CustomFieldContextDefaultValueMultipleGroupPicker.openapiRequiredFields.isEmpty()) { // has required fields
                                                                                                // but JSON element is
                                                                                                // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CustomFieldContextDefaultValueMultipleGroupPicker is not found in the empty JSON string",
            CustomFieldContextDefaultValueMultipleGroupPicker.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CustomFieldContextDefaultValueMultipleGroupPicker.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CustomFieldContextDefaultValueMultipleGroupPicker` properties. JSON: %s",
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!CustomFieldContextDefaultValueMultipleGroupPicker.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes
                     // 'CustomFieldContextDefaultValueMultipleGroupPicker' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<CustomFieldContextDefaultValueMultipleGroupPicker> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CustomFieldContextDefaultValueMultipleGroupPicker.class));
  ...
  /**
   * Create an instance of CustomFieldContextDefaultValueMultipleGroupPicker given
   * an JSON string
   *
  ...
  /**
   * Convert an instance of CustomFieldContextDefaultValueMultipleGroupPicker to
   * an JSON string
   *
   * @return JSON string
   */

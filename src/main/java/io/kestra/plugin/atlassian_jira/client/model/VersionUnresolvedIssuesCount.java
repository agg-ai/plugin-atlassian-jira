...
public class VersionUnresolvedIssuesCount {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!VersionUnresolvedIssuesCount.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                           // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in VersionUnresolvedIssuesCount is not found in the empty JSON string",
            VersionUnresolvedIssuesCount.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!VersionUnresolvedIssuesCount.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `VersionUnresolvedIssuesCount` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<VersionUnresolvedIssuesCount> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(VersionUnresolvedIssuesCount.class));

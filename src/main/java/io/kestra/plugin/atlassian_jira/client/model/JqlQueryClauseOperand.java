...
import io.kestra.plugin.atlassian_jira.client.model.FunctionOperand;
import io.kestra.plugin.atlassian_jira.client.model.JqlQueryUnitaryOperand;
import io.kestra.plugin.atlassian_jira.client.model.KeywordOperand;
import io.kestra.plugin.atlassian_jira.client.model.ListOperand;
import io.kestra.plugin.atlassian_jira.client.model.ValueOperand;
...
public class JqlQueryClauseOperand extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<ListOperand> adapterListOperand = gson.getDelegateAdapter(this,
                    TypeToken.get(ListOperand.class));
            final TypeAdapter<ValueOperand> adapterValueOperand = gson.getDelegateAdapter(this,
                    TypeToken.get(ValueOperand.class));
            final TypeAdapter<FunctionOperand> adapterFunctionOperand = gson.getDelegateAdapter(this,
                    TypeToken.get(FunctionOperand.class));
            final TypeAdapter<KeywordOperand> adapterKeywordOperand = gson.getDelegateAdapter(this,
                    TypeToken.get(KeywordOperand.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<JqlQueryClauseOperand>() {
                ...
                public void write(JsonWriter out, JqlQueryClauseOperand value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof FunctionOperand) {
                        JsonElement element = adapterFunctionOperand
                                .toJsonTree((FunctionOperand) value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    // check if the actual instance is of the type `KeywordOperand`
                    if (value.getActualInstance() instanceof KeywordOperand) {
                        JsonElement element = adapterKeywordOperand
                                .toJsonTree((KeywordOperand) value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    throw new IOException(
                            "Failed to serialize as the type doesn't match anyOf schemas: FunctionOperand, KeywordOperand, ListOperand, ValueOperand");
                }
                ...
                public JqlQueryClauseOperand read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        errorMessages.add(String.format(Locale.ROOT,
                                "Deserialization for ListOperand failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(Locale.ROOT,
                                "Deserialization for ValueOperand failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(Locale.ROOT,
                                "Deserialization for FunctionOperand failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(Locale.ROOT,
                                "Deserialization for KeywordOperand failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'KeywordOperand'", e);
                    }

                    throw new IOException(String.format(Locale.ROOT,
                            "Failed deserialization for JqlQueryClauseOperand: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s",
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException(
                "Invalid instance type. Must be FunctionOperand, KeywordOperand, ListOperand, ValueOperand");
    }
     ...
     * FunctionOperand, KeywordOperand, ListOperand, ValueOperand
     *
     * @return The actual instance (FunctionOperand, KeywordOperand, ListOperand,
     *         ValueOperand)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * Get the actual instance of `ListOperand`. If the actual instance is not
     * `ListOperand`,
    ...
    /**
     * Get the actual instance of `ValueOperand`. If the actual instance is not
     * `ValueOperand`,
     * the ClassCastException will be thrown.
     *
    ...
    /**
     * Get the actual instance of `FunctionOperand`. If the actual instance is not
     * `FunctionOperand`,
     * the ClassCastException will be thrown.
     *
    ...
    /**
     * Get the actual instance of `KeywordOperand`. If the actual instance is not
     * `KeywordOperand`,
     * the ClassCastException will be thrown.
     *
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        try {
            ...
            errorMessages.add(
                    String.format(Locale.ROOT, "Deserialization for ListOperand failed with `%s`.", e.getMessage()));
        ...
        try {
            ...
            errorMessages.add(
                    String.format(Locale.ROOT, "Deserialization for ValueOperand failed with `%s`.", e.getMessage()));
            // continue to the next one
        }
        ...
        try {
            ...
            errorMessages.add(String.format(Locale.ROOT, "Deserialization for FunctionOperand failed with `%s`.",
                    e.getMessage()));
            // continue to the next one
        }
        ...
        try {
            ...
            errorMessages.add(
                    String.format(Locale.ROOT, "Deserialization for KeywordOperand failed with `%s`.", e.getMessage()));
            // continue to the next one
        }
        throw new IOException(String.format(Locale.ROOT,
                "The JSON string is invalid for JqlQueryClauseOperand with anyOf schemas: FunctionOperand, KeywordOperand, ListOperand, ValueOperand. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s",
                errorMessages, jsonElement.toString()));
    }

...
import io.kestra.plugin.atlassian_jira.client.model.ConditionGroupUpdate;
...
public class TransitionUpdateDTO {
  ...
  public int hashCode() {
    return Objects.hash(actions, conditions, customIssueEventId, description, id, links, name, properties,
        toStatusReference, transitionScreen, triggers, type, validators, additionalProperties);
  }
    ...
    if (jsonElement == null) {
      if (!TransitionUpdateDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in TransitionUpdateDTO is not found in the empty JSON string",
            TransitionUpdateDTO.openapiRequiredFields.toString()));
      }
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<TransitionUpdateDTO> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(TransitionUpdateDTO.class));

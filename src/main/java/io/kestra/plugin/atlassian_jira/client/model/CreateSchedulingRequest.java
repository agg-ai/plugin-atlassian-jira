...
import io.kestra.plugin.atlassian_jira.client.model.CreateDateFieldRequest;
...
public class CreateSchedulingRequest {
  /**
   * The dependencies for the plan. This must be \&quot;Sequential\&quot; or
   * \&quot;Concurrent\&quot;.
   */
  ...
  /**
   * The estimation unit for the plan. This must be \&quot;StoryPoints\&quot;,
   * \&quot;Days\&quot; or \&quot;Hours\&quot;.
   */
  ...
  /**
   * The inferred dates for the plan. This must be \&quot;None\&quot;,
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("estimation"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CreateSchedulingRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CreateSchedulingRequest is not found in the empty JSON string",
            CreateSchedulingRequest.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CreateSchedulingRequest.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CreateSchedulingRequest` properties. JSON: %s",
    ...
    if ((jsonObj.get("dependencies") != null && !jsonObj.get("dependencies").isJsonNull())
        && !jsonObj.get("dependencies").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
    ...
    if ((jsonObj.get("inferredDates") != null && !jsonObj.get("inferredDates").isJsonNull())
        && !jsonObj.get("inferredDates").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<CreateSchedulingRequest> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CreateSchedulingRequest.class));

...
public class PriorityWithSequence {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("description", "iconUrl", "id", "isDefault", "name", "self", "sequence", "statusColor"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PriorityWithSequence.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in PriorityWithSequence is not found in the empty JSON string",
            PriorityWithSequence.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PriorityWithSequence.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `PriorityWithSequence` properties. JSON: %s",
    ...
    if ((jsonObj.get("sequence") != null && !jsonObj.get("sequence").isJsonNull())
        && !jsonObj.get("sequence").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `sequence` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("sequence").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<PriorityWithSequence> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(PriorityWithSequence.class));

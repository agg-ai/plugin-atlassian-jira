...
public class Votes {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("hasVoted", "self", "voters", "votes"));
    ...
    if (jsonElement == null) {
      if (!Votes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in Votes is not found in the empty JSON string",
                Votes.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!Votes.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `Votes` properties. JSON: %s", entry.getKey(),
    ...
    if (jsonObj.get("voters") != null && !jsonObj.get("voters").isJsonNull()) {
      ...
      if (jsonArrayvoters != null) {
        ...
        if (!jsonObj.get("voters").isJsonArray()) {
          throw new IllegalArgumentException(
              String.format(Locale.ROOT, "Expected the field `voters` to be an array in the JSON string but got `%s`",
                  jsonObj.get("voters").toString()));
        }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<Votes> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(Votes.class));

...
public class AttachmentMetadata {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("author", "content", "created", "filename", "id", "mimeType",
        "properties", "self", "size", "thumbnail"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!AttachmentMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in AttachmentMetadata is not found in the empty JSON string",
            AttachmentMetadata.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!AttachmentMetadata.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `AttachmentMetadata` properties. JSON: %s",
    ...
    if ((jsonObj.get("mimeType") != null && !jsonObj.get("mimeType").isJsonNull())
      ...
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `mimeType` to be a primitive type in the JSON string but got `%s`",
    ...
    if ((jsonObj.get("thumbnail") != null && !jsonObj.get("thumbnail").isJsonNull())
        && !jsonObj.get("thumbnail").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `thumbnail` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("thumbnail").toString()));
    }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<AttachmentMetadata> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(AttachmentMetadata.class));

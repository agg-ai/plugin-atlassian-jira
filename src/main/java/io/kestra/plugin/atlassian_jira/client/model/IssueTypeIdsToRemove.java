...
public class IssueTypeIdsToRemove {
  ...
  public IssueTypeIdsToRemove issueTypeIds(@javax.annotation.Nonnull List<String> issueTypeIds) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!IssueTypeIdsToRemove.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssueTypeIdsToRemove is not found in the empty JSON string",
            IssueTypeIdsToRemove.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!IssueTypeIdsToRemove.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `IssueTypeIdsToRemove` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssueTypeIdsToRemove> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssueTypeIdsToRemove.class));

...
public class ExportArchivedIssuesTaskProgressResponse {
  ...
  public ExportArchivedIssuesTaskProgressResponse submittedTime(
      @javax.annotation.Nullable OffsetDateTime submittedTime) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("fileUrl", "payload", "progress", "status", "submittedTime", "taskId"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ExportArchivedIssuesTaskProgressResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON
                                                                                       // element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in ExportArchivedIssuesTaskProgressResponse is not found in the empty JSON string",
            ExportArchivedIssuesTaskProgressResponse.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ExportArchivedIssuesTaskProgressResponse.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ExportArchivedIssuesTaskProgressResponse` properties. JSON: %s",
            entry.getKey(), jsonElement.toString()));
      }
    }
    JsonObject jsonObj = jsonElement.getAsJsonObject();
    if ((jsonObj.get("fileUrl") != null && !jsonObj.get("fileUrl").isJsonNull())
        && !jsonObj.get("fileUrl").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `fileUrl` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("fileUrl").toString()));
    }
    if ((jsonObj.get("payload") != null && !jsonObj.get("payload").isJsonNull())
        && !jsonObj.get("payload").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `payload` to be a primitive type in the JSON string but got `%s`",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!ExportArchivedIssuesTaskProgressResponse.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'ExportArchivedIssuesTaskProgressResponse' and its
                     // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<ExportArchivedIssuesTaskProgressResponse> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(ExportArchivedIssuesTaskProgressResponse.class));
  ...
  /**
   * Create an instance of ExportArchivedIssuesTaskProgressResponse given an JSON
   * string
   *
  ...
  /**
   * Convert an instance of ExportArchivedIssuesTaskProgressResponse to an JSON
   * string
   *
   * @return JSON string
   */

...
public class CustomTemplatesProjectDetails {
  ...
  public CustomTemplatesProjectDetails additionalProperties(
      @javax.annotation.Nullable Map<String, String> additionalProperties) {
   ...
   * avatars\\](\\#api-rest-api-3-project-projectIdOrKey-avatar-get) operation to
   * list the available avatars in a project.
   * 
   * @return avatarId
   */
  @javax.annotation.Nullable
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessLevel, additionalProperties, assigneeType, avatarId, categoryId, description,
        enableComponents, key, language, leadAccountId, name, url);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("accessLevel", "additionalProperties", "assigneeType", "avatarId",
        "categoryId", "description", "enableComponents", "key", "language", "leadAccountId", "name", "url"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CustomTemplatesProjectDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                            // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in CustomTemplatesProjectDetails is not found in the empty JSON string",
            CustomTemplatesProjectDetails.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CustomTemplatesProjectDetails.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `CustomTemplatesProjectDetails` properties. JSON: %s",
            entry.getKey(), jsonElement.toString()));
      }
    }
    JsonObject jsonObj = jsonElement.getAsJsonObject();
    if ((jsonObj.get("accessLevel") != null && !jsonObj.get("accessLevel").isJsonNull())
        && !jsonObj.get("accessLevel").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `accessLevel` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("accessLevel").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<CustomTemplatesProjectDetails> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(CustomTemplatesProjectDetails.class));

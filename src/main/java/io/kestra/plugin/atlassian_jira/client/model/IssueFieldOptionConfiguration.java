...
import io.kestra.plugin.atlassian_jira.client.model.IssueFieldOptionScopeBean;
...
public class IssueFieldOptionConfiguration {
  ...
  public IssueFieldOptionConfiguration scope(@javax.annotation.Nullable IssueFieldOptionScopeBean scope) {
    this.scope = scope;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!IssueFieldOptionConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                            // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in IssueFieldOptionConfiguration is not found in the empty JSON string",
            IssueFieldOptionConfiguration.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!IssueFieldOptionConfiguration.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `IssueFieldOptionConfiguration` properties. JSON: %s",
    ...
    if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()
      ...
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `attributes` to be an array in the JSON string but got `%s`",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IssueFieldOptionConfiguration> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(IssueFieldOptionConfiguration.class));

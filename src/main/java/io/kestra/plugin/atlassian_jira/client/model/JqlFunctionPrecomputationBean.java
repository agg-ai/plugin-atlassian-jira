...
public class JqlFunctionPrecomputationBean {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(arguments, created, error, field, functionKey, functionName, id, operator, updated, used,
        value);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("arguments", "created", "error", "field", "functionKey",
        "functionName", "id", "operator", "updated", "used", "value"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!JqlFunctionPrecomputationBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                            // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in JqlFunctionPrecomputationBean is not found in the empty JSON string",
            JqlFunctionPrecomputationBean.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!JqlFunctionPrecomputationBean.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `JqlFunctionPrecomputationBean` properties. JSON: %s",
    ...
    if (jsonObj.get("arguments") != null && !jsonObj.get("arguments").isJsonNull()
        && !jsonObj.get("arguments").isJsonArray()) {
    ...
    if ((jsonObj.get("functionKey") != null && !jsonObj.get("functionKey").isJsonNull())
        && !jsonObj.get("functionKey").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `functionKey` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("functionKey").toString()));
    }
    if ((jsonObj.get("functionName") != null && !jsonObj.get("functionName").isJsonNull())
        && !jsonObj.get("functionName").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `functionName` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("functionName").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<JqlFunctionPrecomputationBean> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(JqlFunctionPrecomputationBean.class));

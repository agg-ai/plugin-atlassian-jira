...
import io.kestra.plugin.atlassian_jira.client.model.ProjectType;
...
public class ProjectTypesApi {
     ...
     *                        <tr>
     *                        <td>404</td>
     *                        <td>Returned if the project type is not accessible to
     *                        the user.</td>
     *                        <td>-</td>
     *                        </tr>
     *                        </table>
     */
    public okhttp3.Call getAccessibleProjectTypeByKeyCall(@javax.annotation.Nonnull String projectTypeKey,
    ...
    private okhttp3.Call getAccessibleProjectTypeByKeyValidateBeforeCall(
            @javax.annotation.Nonnull String projectTypeKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectTypeKey' is set
        if (projectTypeKey == null) {
            throw new ApiException(
                    "Missing the required parameter 'projectTypeKey' when calling getAccessibleProjectTypeByKey(Async)");
        }
     ...
     * accessible to the user. **[Permissions](#permissions) required:** Permission
     * to access Jira.
     * 
     * @param projectTypeKey The key of the project type. (required)
     * @return ProjectType
     ...
     *                        </table>
     */
    public ProjectType getAccessibleProjectTypeByKey(@javax.annotation.Nonnull String projectTypeKey)
            throws ApiException {
     ...
     *                        </table>
     */
    public ApiResponse<ProjectType> getAccessibleProjectTypeByKeyWithHttpInfo(
            @javax.annotation.Nonnull String projectTypeKey) throws ApiException {
        okhttp3.Call localVarCall = getAccessibleProjectTypeByKeyValidateBeforeCall(projectTypeKey, null);
        Type localVarReturnType = new TypeToken<ProjectType>() {
        }.getType();
     ...
     *                        </table>
     */
    public okhttp3.Call getAccessibleProjectTypeByKeyAsync(@javax.annotation.Nonnull String projectTypeKey,
            final ApiCallback<ProjectType> _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAllAccessibleProjectTypesValidateBeforeCall(final ApiCallback _callback)
            throws ApiException {
    ...
    public ApiResponse<List<ProjectType>> getAllAccessibleProjectTypesWithHttpInfo() throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<ProjectType>>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     *                        </table>
     */
    public okhttp3.Call getAllAccessibleProjectTypesAsync(final ApiCallback<List<ProjectType>> _callback)
            throws ApiException {
     ...
     * whether or not the instance has a valid license for each type. This operation
     ...
     *                        <tr>
     *                        <td>404</td>
     *                        <td>Returned if the project type is not found.</td>
     *                        <td>-</td>
     *                        </tr>
     *                        </table>
     */
    public okhttp3.Call getProjectTypeByKeyCall(@javax.annotation.Nonnull String projectTypeKey,
            final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {};
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getProjectTypeByKeyValidateBeforeCall(@javax.annotation.Nonnull String projectTypeKey,
            final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectTypeKey' is set
        if (projectTypeKey == null) {
            throw new ApiException(
                    "Missing the required parameter 'projectTypeKey' when calling getProjectTypeByKey(Async)");
        }
     ...
     * Returns a [project type](https://confluence.atlassian.com/x/Var1Nw). This
     ...
     *                        </table>
     */
    public ApiResponse<ProjectType> getProjectTypeByKeyWithHttpInfo(@javax.annotation.Nonnull String projectTypeKey)
            throws ApiException {
     ...
     *                        </table>
     */
    public okhttp3.Call getProjectTypeByKeyAsync(@javax.annotation.Nonnull String projectTypeKey,
            final ApiCallback<ProjectType> _callback) throws ApiException {

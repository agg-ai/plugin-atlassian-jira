...
import io.kestra.plugin.atlassian_jira.client.model.JqlQueryToSanitize;
...
public class JqlQueriesToSanitize {
  ...
  public JqlQueriesToSanitize queries(@javax.annotation.Nonnull List<JqlQueryToSanitize> queries) {
  ...
  /**
   * The list of JQL queries to sanitize. Must contain unique values. Maximum of
   * 20 queries.
   * 
   * @return queries
   */
  ...
  public void setQueries(@javax.annotation.Nonnull List<JqlQueryToSanitize> queries) {
    this.queries = queries;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!JqlQueriesToSanitize.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in JqlQueriesToSanitize is not found in the empty JSON string",
            JqlQueriesToSanitize.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!JqlQueriesToSanitize.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `JqlQueriesToSanitize` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<JqlQueriesToSanitize> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(JqlQueriesToSanitize.class));

 ...
 * the default would return &#x60;WARNING&#x60; and &#x60;ERROR&#x60; level
 * validation results.
 */
...
public class ValidationOptionsForUpdate {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ValidationOptionsForUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in ValidationOptionsForUpdate is not found in the empty JSON string",
            ValidationOptionsForUpdate.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ValidationOptionsForUpdate.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ValidationOptionsForUpdate` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ValidationOptionsForUpdate> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(ValidationOptionsForUpdate.class));

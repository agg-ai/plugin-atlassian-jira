...
import io.kestra.plugin.atlassian_jira.client.model.RequiredMappingByIssueType;
import io.kestra.plugin.atlassian_jira.client.model.RequiredMappingByWorkflows;
import io.kestra.plugin.atlassian_jira.client.model.StatusMetadata;
import io.kestra.plugin.atlassian_jira.client.model.StatusesPerWorkflow;
...
public class WorkflowSchemeUpdateRequiredMappingsResponse {
  ...
  public WorkflowSchemeUpdateRequiredMappingsResponse statusMappingsByIssueTypes(
      @javax.annotation.Nullable Set<RequiredMappingByIssueType> statusMappingsByIssueTypes) {
    this.statusMappingsByIssueTypes = statusMappingsByIssueTypes;
    return this;
  }

  public WorkflowSchemeUpdateRequiredMappingsResponse addStatusMappingsByIssueTypesItem(
      RequiredMappingByIssueType statusMappingsByIssueTypesItem) {
  ...
  public void setStatusMappingsByIssueTypes(
      @javax.annotation.Nullable Set<RequiredMappingByIssueType> statusMappingsByIssueTypes) {
    this.statusMappingsByIssueTypes = statusMappingsByIssueTypes;
  }

  public WorkflowSchemeUpdateRequiredMappingsResponse statusMappingsByWorkflows(
      @javax.annotation.Nullable Set<RequiredMappingByWorkflows> statusMappingsByWorkflows) {
    this.statusMappingsByWorkflows = statusMappingsByWorkflows;
    return this;
  }

  public WorkflowSchemeUpdateRequiredMappingsResponse addStatusMappingsByWorkflowsItem(
      RequiredMappingByWorkflows statusMappingsByWorkflowsItem) {
  ...
  public WorkflowSchemeUpdateRequiredMappingsResponse statuses(
      @javax.annotation.Nullable Set<StatusMetadata> statuses) {
  ...
  public WorkflowSchemeUpdateRequiredMappingsResponse statusesPerWorkflow(
      @javax.annotation.Nullable Set<StatusesPerWorkflow> statusesPerWorkflow) {
    this.statusesPerWorkflow = statusesPerWorkflow;
    return this;
  }

  public WorkflowSchemeUpdateRequiredMappingsResponse addStatusesPerWorkflowItem(
      StatusesPerWorkflow statusesPerWorkflowItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.statusMappingsByIssueTypes,
        workflowSchemeUpdateRequiredMappingsResponse.statusMappingsByIssueTypes) &&
        Objects.equals(this.statusMappingsByWorkflows,
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("statusMappingsByIssueTypes", "statusMappingsByWorkflows", "statuses", "statusesPerWorkflow"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!WorkflowSchemeUpdateRequiredMappingsResponse.openapiRequiredFields.isEmpty()) { // has required fields but
                                                                                           // JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in WorkflowSchemeUpdateRequiredMappingsResponse is not found in the empty JSON string",
            WorkflowSchemeUpdateRequiredMappingsResponse.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!WorkflowSchemeUpdateRequiredMappingsResponse.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `WorkflowSchemeUpdateRequiredMappingsResponse` properties. JSON: %s",
    ...
    if (jsonObj.get("statusMappingsByIssueTypes") != null && !jsonObj.get("statusMappingsByIssueTypes").isJsonNull()) {
      ...
      if (jsonArraystatusMappingsByIssueTypes != null) {
        ...
        if (!jsonObj.get("statusMappingsByIssueTypes").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `statusMappingsByIssueTypes` to be an array in the JSON string but got `%s`",
              jsonObj.get("statusMappingsByIssueTypes").toString()));
        }
    ...
    if (jsonObj.get("statusesPerWorkflow") != null && !jsonObj.get("statusesPerWorkflow").isJsonNull()) {
      ...
      if (jsonArraystatusesPerWorkflow != null) {
        ...
        if (!jsonObj.get("statusesPerWorkflow").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `statusesPerWorkflow` to be an array in the JSON string but got `%s`",
              jsonObj.get("statusesPerWorkflow").toString()));
        }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!WorkflowSchemeUpdateRequiredMappingsResponse.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'WorkflowSchemeUpdateRequiredMappingsResponse' and
                     // its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<WorkflowSchemeUpdateRequiredMappingsResponse> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(WorkflowSchemeUpdateRequiredMappingsResponse.class));
  ...
  /**
   * Create an instance of WorkflowSchemeUpdateRequiredMappingsResponse given an
   * JSON string
   *
  ...
  /**
   * Convert an instance of WorkflowSchemeUpdateRequiredMappingsResponse to an
   * JSON string
   *
   * @return JSON string
   */

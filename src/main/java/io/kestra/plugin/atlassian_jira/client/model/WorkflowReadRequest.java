...
import io.kestra.plugin.atlassian_jira.client.model.ProjectAndIssueTypePair;
...
public class WorkflowReadRequest {
  ...
  public WorkflowReadRequest projectAndIssueTypes(
      @javax.annotation.Nullable List<ProjectAndIssueTypePair> projectAndIssueTypes) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!WorkflowReadRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in WorkflowReadRequest is not found in the empty JSON string",
            WorkflowReadRequest.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!WorkflowReadRequest.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `WorkflowReadRequest` properties. JSON: %s",
    ...
    if (jsonObj.get("projectAndIssueTypes") != null && !jsonObj.get("projectAndIssueTypes").isJsonNull()) {
      ...
      if (jsonArrayprojectAndIssueTypes != null) {
        ...
        if (!jsonObj.get("projectAndIssueTypes").isJsonArray()) {
          throw new IllegalArgumentException(String.format(Locale.ROOT,
              "Expected the field `projectAndIssueTypes` to be an array in the JSON string but got `%s`",
              jsonObj.get("projectAndIssueTypes").toString()));
        }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<WorkflowReadRequest> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(WorkflowReadRequest.class));

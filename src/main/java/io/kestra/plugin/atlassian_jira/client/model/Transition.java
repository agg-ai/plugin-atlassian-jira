...
import io.kestra.plugin.atlassian_jira.client.model.TransitionScreenDetails;
import io.kestra.plugin.atlassian_jira.client.model.WorkflowRules;
...
public class Transition {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("description", "from", "id", "name", "properties", "rules", "screen", "to", "type"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("description", "from", "id", "name", "to", "type"));
  }
    ...
    if (jsonElement == null) {
      if (!Transition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in Transition is not found in the empty JSON string",
                Transition.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!Transition.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `Transition` properties. JSON: %s", entry.getKey(),
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<Transition> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(Transition.class));

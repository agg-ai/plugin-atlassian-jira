...
public class Attachment {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("author", "content", "created", "filename", "id", "mimeType", "self", "size", "thumbnail"));
    ...
    if (jsonElement == null) {
      if (!Attachment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(Locale.ROOT, "The required field(s) %s in Attachment is not found in the empty JSON string",

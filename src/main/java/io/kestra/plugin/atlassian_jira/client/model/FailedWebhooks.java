...
import io.kestra.plugin.atlassian_jira.client.model.FailedWebhook;
...
public class FailedWebhooks {
   ...
   * the next page and query for new results periodically (for example, every
   * hour).
   * 
   * @return next
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("maxResults", "next", "values"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("maxResults", "values"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!FailedWebhooks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in FailedWebhooks is not found in the empty JSON string",
            FailedWebhooks.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!FailedWebhooks.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `FailedWebhooks` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<FailedWebhooks> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(FailedWebhooks.class));

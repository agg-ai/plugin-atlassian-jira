...
public class SuggestedMappingsForProjectsRequestBean {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("add"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!SuggestedMappingsForProjectsRequestBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON
                                                                                      // element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in SuggestedMappingsForProjectsRequestBean is not found in the empty JSON string",
            SuggestedMappingsForProjectsRequestBean.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!SuggestedMappingsForProjectsRequestBean.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `SuggestedMappingsForProjectsRequestBean` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!SuggestedMappingsForProjectsRequestBean.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'SuggestedMappingsForProjectsRequestBean' and its
                     // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<SuggestedMappingsForProjectsRequestBean> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(SuggestedMappingsForProjectsRequestBean.class));
  ...
  /**
   * Create an instance of SuggestedMappingsForProjectsRequestBean given an JSON
   * string
   *
  ...
  /**
   * Convert an instance of SuggestedMappingsForProjectsRequestBean to an JSON
   * string
   *
   * @return JSON string
   */

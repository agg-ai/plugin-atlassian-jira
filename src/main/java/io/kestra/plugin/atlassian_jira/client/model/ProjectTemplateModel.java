...
import io.kestra.plugin.atlassian_jira.client.model.ProjectArchetype;
import io.kestra.plugin.atlassian_jira.client.model.ProjectTemplateKey;
...
public class ProjectTemplateModel {
  ...
  public ProjectTemplateModel liveTemplateProjectIdReference(
      @javax.annotation.Nullable Long liveTemplateProjectIdReference) {
  ...
  public ProjectTemplateModel templateGenerationOptions(
  ...
  @Override
  public int hashCode() {
    return Objects.hash(archetype, defaultBoardView, description, liveTemplateProjectIdReference, name,
        projectTemplateKey, snapshotTemplate, templateGenerationOptions, type);
  }
  ...
  public String toString() {
    ...
    sb.append("    liveTemplateProjectIdReference: ").append(toIndentedString(liveTemplateProjectIdReference))
        .append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("archetype", "defaultBoardView", "description", "liveTemplateProjectIdReference", "name",
            "projectTemplateKey", "snapshotTemplate", "templateGenerationOptions", "type"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ProjectTemplateModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in ProjectTemplateModel is not found in the empty JSON string",
            ProjectTemplateModel.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ProjectTemplateModel.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `ProjectTemplateModel` properties. JSON: %s",
    ...
    if ((jsonObj.get("defaultBoardView") != null && !jsonObj.get("defaultBoardView").isJsonNull())
        && !jsonObj.get("defaultBoardView").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `defaultBoardView` to be a primitive type in the JSON string but got `%s`",
          jsonObj.get("defaultBoardView").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ProjectTemplateModel> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(ProjectTemplateModel.class));

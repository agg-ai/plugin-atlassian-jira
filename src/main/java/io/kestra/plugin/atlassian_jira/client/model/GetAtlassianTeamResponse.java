...
public class GetAtlassianTeamResponse {
  ...
  /**
   * The planning style for the Atlassian team. This is \&quot;Scrum\&quot; or
   * \&quot;Kanban\&quot;.
   */
  ...
  static {
    ...
    openapiFields = new HashSet<String>(
        Arrays.asList("capacity", "id", "issueSourceId", "planningStyle", "sprintLength"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!GetAtlassianTeamResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in GetAtlassianTeamResponse is not found in the empty JSON string",
            GetAtlassianTeamResponse.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!GetAtlassianTeamResponse.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `GetAtlassianTeamResponse` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<GetAtlassianTeamResponse> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(GetAtlassianTeamResponse.class));

...
public class JqlQueryFieldEntityProperty {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!JqlQueryFieldEntityProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                                          // null
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The required field(s) %s in JqlQueryFieldEntityProperty is not found in the empty JSON string",
            JqlQueryFieldEntityProperty.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!JqlQueryFieldEntityProperty.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "The field `%s` in the JSON string is not defined in the `JqlQueryFieldEntityProperty` properties. JSON: %s",
    ...
    if (!jsonObj.get("entity").isJsonPrimitive()) {
      throw new IllegalArgumentException(String.format(Locale.ROOT,
          "Expected the field `entity` to be a primitive type in the JSON string but got `%s`",
    ...
    if (!jsonObj.get("path").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(Locale.ROOT, "Expected the field `path` to be a primitive type in the JSON string but got `%s`",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<JqlQueryFieldEntityProperty> thisAdapter = gson.getDelegateAdapter(this,
          TypeToken.get(JqlQueryFieldEntityProperty.class));

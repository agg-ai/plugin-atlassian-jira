...
public class PageOfChangelogs {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("histories", "maxResults", "startAt", "total"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PageOfChangelogs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in PageOfChangelogs is not found in the empty JSON string", PageOfChangelogs.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageOfChangelogs.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PageOfChangelogs` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("histories") != null && !jsonObj.get("histories").isJsonNull()) {
        ...
        if (jsonArrayhistories != null) {
          ...
          if (!jsonObj.get("histories").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `histories` to be an array in the JSON string but got `%s`", jsonObj.get("histories").toString()));
          }

...
public class DashboardGadgetPosition {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("The column position of the gadget.", "The row position of the gadget."));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("The column position of the gadget.", "The row position of the gadget."));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DashboardGadgetPosition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DashboardGadgetPosition is not found in the empty JSON string", DashboardGadgetPosition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DashboardGadgetPosition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DashboardGadgetPosition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

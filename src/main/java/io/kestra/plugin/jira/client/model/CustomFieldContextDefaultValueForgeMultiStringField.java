...
public class CustomFieldContextDefaultValueForgeMultiStringField {
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomFieldContextDefaultValueForgeMultiStringField
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomFieldContextDefaultValueForgeMultiStringField.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CustomFieldContextDefaultValueForgeMultiStringField is not found in the empty JSON string", CustomFieldContextDefaultValueForgeMultiStringField.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomFieldContextDefaultValueForgeMultiStringField.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CustomFieldContextDefaultValueForgeMultiStringField` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

 ...
 */
@JsonPropertyOrder({
  CustomFieldContextDefaultValueForgeObjectField.JSON_PROPERTY_OBJECT,
  CustomFieldContextDefaultValueForgeObjectField.JSON_PROPERTY_TYPE
})
...
public class CustomFieldContextDefaultValueForgeObjectField {
  ...
  /**
   * Return true if this CustomFieldContextDefaultValueForgeObjectField object is equal to o.
   */
  @Override

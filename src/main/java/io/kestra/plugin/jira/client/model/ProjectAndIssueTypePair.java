 ...
 */
@JsonPropertyOrder({
  ProjectAndIssueTypePair.JSON_PROPERTY_ISSUE_TYPE_ID,
  ProjectAndIssueTypePair.JSON_PROPERTY_PROJECT_ID
})
...
public class ProjectAndIssueTypePair {
  ...
  /**
   * Return true if this ProjectAndIssueTypePair object is equal to o.
   */
  @Override

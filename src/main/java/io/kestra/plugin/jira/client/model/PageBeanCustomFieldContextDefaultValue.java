 ...
 */
@JsonPropertyOrder({
  PageBeanCustomFieldContextDefaultValue.JSON_PROPERTY_IS_LAST,
  PageBeanCustomFieldContextDefaultValue.JSON_PROPERTY_MAX_RESULTS,
  PageBeanCustomFieldContextDefaultValue.JSON_PROPERTY_NEXT_PAGE,
  PageBeanCustomFieldContextDefaultValue.JSON_PROPERTY_SELF,
  PageBeanCustomFieldContextDefaultValue.JSON_PROPERTY_START_AT,
  PageBeanCustomFieldContextDefaultValue.JSON_PROPERTY_TOTAL,
  PageBeanCustomFieldContextDefaultValue.JSON_PROPERTY_VALUES
})
...
public class PageBeanCustomFieldContextDefaultValue {
  ...
  public PageBeanCustomFieldContextDefaultValue(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<CustomFieldContextDefaultValue> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanCustomFieldContextDefaultValue object is equal to o.
   */
  @Override

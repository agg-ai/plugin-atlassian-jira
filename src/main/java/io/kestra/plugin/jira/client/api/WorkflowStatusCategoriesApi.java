...
public class WorkflowStatusCategoriesApi {
     ...
     */
    public okhttp3.Call getStatusCategoryCall(@javax.annotation.Nonnull String idOrKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getStatusCategoryValidateBeforeCall(@javax.annotation.Nonnull String idOrKey, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getStatusCategoryAsync(@javax.annotation.Nonnull String idOrKey, final ApiCallback<StatusCategory> _callback) throws ApiException {

...
public class IssuesJqlMetaDataBean {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("count", "maxResults", "startAt", "totalCount", "validationWarnings"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("count", "maxResults", "startAt", "totalCount"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to IssuesJqlMetaDataBean
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IssuesJqlMetaDataBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in IssuesJqlMetaDataBean is not found in the empty JSON string", IssuesJqlMetaDataBean.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IssuesJqlMetaDataBean.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `IssuesJqlMetaDataBean` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("validationWarnings") != null && !jsonObj.get("validationWarnings").isJsonNull() && !jsonObj.get("validationWarnings").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `validationWarnings` to be an array in the JSON string but got `%s`", jsonObj.get("validationWarnings").toString()));
      }
  }

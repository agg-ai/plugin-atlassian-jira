 ...
 */
@JsonPropertyOrder({
  PageBeanPriorityWithSequence.JSON_PROPERTY_IS_LAST,
  PageBeanPriorityWithSequence.JSON_PROPERTY_MAX_RESULTS,
  PageBeanPriorityWithSequence.JSON_PROPERTY_NEXT_PAGE,
  PageBeanPriorityWithSequence.JSON_PROPERTY_SELF,
  PageBeanPriorityWithSequence.JSON_PROPERTY_START_AT,
  PageBeanPriorityWithSequence.JSON_PROPERTY_TOTAL,
  PageBeanPriorityWithSequence.JSON_PROPERTY_VALUES
})
...
public class PageBeanPriorityWithSequence {
  ...
  public PageBeanPriorityWithSequence(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<PriorityWithSequence> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanPriorityWithSequence object is equal to o.
   */
  @Override

...
public class JiraSettingsApi {
     ...
     */
    public okhttp3.Call getApplicationPropertyCall(@javax.annotation.Nullable String key, @javax.annotation.Nullable String permissionLevel, @javax.annotation.Nullable String keyFilter, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getApplicationPropertyValidateBeforeCall(@javax.annotation.Nullable String key, @javax.annotation.Nullable String permissionLevel, @javax.annotation.Nullable String keyFilter, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getApplicationPropertyAsync(@javax.annotation.Nullable String key, @javax.annotation.Nullable String permissionLevel, @javax.annotation.Nullable String keyFilter, final ApiCallback<List<ApplicationProperty>> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call setApplicationPropertyCall(@javax.annotation.Nonnull String id, @javax.annotation.Nonnull SimpleApplicationPropertyBean simpleApplicationPropertyBean, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call setApplicationPropertyValidateBeforeCall(@javax.annotation.Nonnull String id, @javax.annotation.Nonnull SimpleApplicationPropertyBean simpleApplicationPropertyBean, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call setApplicationPropertyAsync(@javax.annotation.Nonnull String id, @javax.annotation.Nonnull SimpleApplicationPropertyBean simpleApplicationPropertyBean, final ApiCallback<ApplicationProperty> _callback) throws ApiException {

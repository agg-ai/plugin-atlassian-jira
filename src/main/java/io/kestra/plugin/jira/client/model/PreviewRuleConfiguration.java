 ...
 */
@JsonPropertyOrder({
  PreviewRuleConfiguration.JSON_PROPERTY_ID,
  PreviewRuleConfiguration.JSON_PROPERTY_PARAMETERS,
  PreviewRuleConfiguration.JSON_PROPERTY_RULE_KEY
})
...
public class PreviewRuleConfiguration {
  ...
  /**
   * Return true if this PreviewRuleConfiguration object is equal to o.
   */
  @Override

 ...
 */
@JsonPropertyOrder({
  PageBeanResolutionJsonBean.JSON_PROPERTY_IS_LAST,
  PageBeanResolutionJsonBean.JSON_PROPERTY_MAX_RESULTS,
  PageBeanResolutionJsonBean.JSON_PROPERTY_NEXT_PAGE,
  PageBeanResolutionJsonBean.JSON_PROPERTY_SELF,
  PageBeanResolutionJsonBean.JSON_PROPERTY_START_AT,
  PageBeanResolutionJsonBean.JSON_PROPERTY_TOTAL,
  PageBeanResolutionJsonBean.JSON_PROPERTY_VALUES
})
...
public class PageBeanResolutionJsonBean {
  ...
  public PageBeanResolutionJsonBean(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<ResolutionJsonBean> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanResolutionJsonBean object is equal to o.
   */
  @Override

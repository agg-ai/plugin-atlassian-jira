 ...
 */
@JsonPropertyOrder({
  PageBeanIssueSecuritySchemeToProjectMapping.JSON_PROPERTY_IS_LAST,
  PageBeanIssueSecuritySchemeToProjectMapping.JSON_PROPERTY_MAX_RESULTS,
  PageBeanIssueSecuritySchemeToProjectMapping.JSON_PROPERTY_NEXT_PAGE,
  PageBeanIssueSecuritySchemeToProjectMapping.JSON_PROPERTY_SELF,
  PageBeanIssueSecuritySchemeToProjectMapping.JSON_PROPERTY_START_AT,
  PageBeanIssueSecuritySchemeToProjectMapping.JSON_PROPERTY_TOTAL,
  PageBeanIssueSecuritySchemeToProjectMapping.JSON_PROPERTY_VALUES
})
...
public class PageBeanIssueSecuritySchemeToProjectMapping {
  ...
  public PageBeanIssueSecuritySchemeToProjectMapping(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<IssueSecuritySchemeToProjectMapping> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanIssueSecuritySchemeToProjectMapping object is equal to o.
   */
  @Override

 ...
 */
@JsonPropertyOrder({
  CustomFieldContextDefaultValueMultiUserPicker.JSON_PROPERTY_ACCOUNT_IDS,
  CustomFieldContextDefaultValueMultiUserPicker.JSON_PROPERTY_CONTEXT_ID,
  CustomFieldContextDefaultValueMultiUserPicker.JSON_PROPERTY_TYPE
})
...
public class CustomFieldContextDefaultValueMultiUserPicker {
  ...
  /**
   * Return true if this CustomFieldContextDefaultValueMultiUserPicker object is equal to o.
   */
  @Override

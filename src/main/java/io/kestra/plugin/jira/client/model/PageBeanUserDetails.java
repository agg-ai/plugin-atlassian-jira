 ...
 */
@JsonPropertyOrder({
  PageBeanUserDetails.JSON_PROPERTY_IS_LAST,
  PageBeanUserDetails.JSON_PROPERTY_MAX_RESULTS,
  PageBeanUserDetails.JSON_PROPERTY_NEXT_PAGE,
  PageBeanUserDetails.JSON_PROPERTY_SELF,
  PageBeanUserDetails.JSON_PROPERTY_START_AT,
  PageBeanUserDetails.JSON_PROPERTY_TOTAL,
  PageBeanUserDetails.JSON_PROPERTY_VALUES
})
...
public class PageBeanUserDetails {
  ...
  public PageBeanUserDetails(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<UserDetails> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanUserDetails object is equal to o.
   */
  @Override

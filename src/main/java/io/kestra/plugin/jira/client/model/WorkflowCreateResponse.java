 ...
 */
@JsonPropertyOrder({
  WorkflowCreateResponse.JSON_PROPERTY_STATUSES,
  WorkflowCreateResponse.JSON_PROPERTY_WORKFLOWS
})
...
public class WorkflowCreateResponse {
  ...
  /**
   * Return true if this WorkflowCreateResponse object is equal to o.
   */
  @Override

 ...
 */
@JsonPropertyOrder({
  PageBeanFieldConfigurationDetails.JSON_PROPERTY_IS_LAST,
  PageBeanFieldConfigurationDetails.JSON_PROPERTY_MAX_RESULTS,
  PageBeanFieldConfigurationDetails.JSON_PROPERTY_NEXT_PAGE,
  PageBeanFieldConfigurationDetails.JSON_PROPERTY_SELF,
  PageBeanFieldConfigurationDetails.JSON_PROPERTY_START_AT,
  PageBeanFieldConfigurationDetails.JSON_PROPERTY_TOTAL,
  PageBeanFieldConfigurationDetails.JSON_PROPERTY_VALUES
})
...
public class PageBeanFieldConfigurationDetails {
  ...
  public PageBeanFieldConfigurationDetails(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<FieldConfigurationDetails> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanFieldConfigurationDetails object is equal to o.
   */
  @Override

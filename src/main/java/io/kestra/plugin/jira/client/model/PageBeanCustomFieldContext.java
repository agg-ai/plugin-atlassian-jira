 ...
 */
@JsonPropertyOrder({
  PageBeanCustomFieldContext.JSON_PROPERTY_IS_LAST,
  PageBeanCustomFieldContext.JSON_PROPERTY_MAX_RESULTS,
  PageBeanCustomFieldContext.JSON_PROPERTY_NEXT_PAGE,
  PageBeanCustomFieldContext.JSON_PROPERTY_SELF,
  PageBeanCustomFieldContext.JSON_PROPERTY_START_AT,
  PageBeanCustomFieldContext.JSON_PROPERTY_TOTAL,
  PageBeanCustomFieldContext.JSON_PROPERTY_VALUES
})
...
public class PageBeanCustomFieldContext {
  ...
  public PageBeanCustomFieldContext(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<CustomFieldContext> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanCustomFieldContext object is equal to o.
   */
  @Override

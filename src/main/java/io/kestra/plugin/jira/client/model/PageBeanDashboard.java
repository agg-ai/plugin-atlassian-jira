 ...
 */
@JsonPropertyOrder({
  PageBeanDashboard.JSON_PROPERTY_IS_LAST,
  PageBeanDashboard.JSON_PROPERTY_MAX_RESULTS,
  PageBeanDashboard.JSON_PROPERTY_NEXT_PAGE,
  PageBeanDashboard.JSON_PROPERTY_SELF,
  PageBeanDashboard.JSON_PROPERTY_START_AT,
  PageBeanDashboard.JSON_PROPERTY_TOTAL,
  PageBeanDashboard.JSON_PROPERTY_VALUES
})
...
public class PageBeanDashboard {
  ...
  public PageBeanDashboard(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<Dashboard> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanDashboard object is equal to o.
   */
  @Override

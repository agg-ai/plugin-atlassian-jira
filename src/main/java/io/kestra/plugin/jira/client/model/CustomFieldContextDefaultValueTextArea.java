 ...
 */
@JsonPropertyOrder({
  CustomFieldContextDefaultValueTextArea.JSON_PROPERTY_TEXT,
  CustomFieldContextDefaultValueTextArea.JSON_PROPERTY_TYPE
})
...
public class CustomFieldContextDefaultValueTextArea {
  ...
  /**
   * Return true if this CustomFieldContextDefaultValueTextArea object is equal to o.
   */
  @Override

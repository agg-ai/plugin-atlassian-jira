 ...
 */
@JsonPropertyOrder({
  UpdateIssueSecurityLevelDetails.JSON_PROPERTY_DESCRIPTION,
  UpdateIssueSecurityLevelDetails.JSON_PROPERTY_NAME
})
...
public class UpdateIssueSecurityLevelDetails {
  ...
  /**
   * Return true if this UpdateIssueSecurityLevelDetails object is equal to o.
   */
  @Override

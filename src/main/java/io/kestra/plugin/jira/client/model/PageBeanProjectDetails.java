 ...
 */
@JsonPropertyOrder({
  PageBeanProjectDetails.JSON_PROPERTY_IS_LAST,
  PageBeanProjectDetails.JSON_PROPERTY_MAX_RESULTS,
  PageBeanProjectDetails.JSON_PROPERTY_NEXT_PAGE,
  PageBeanProjectDetails.JSON_PROPERTY_SELF,
  PageBeanProjectDetails.JSON_PROPERTY_START_AT,
  PageBeanProjectDetails.JSON_PROPERTY_TOTAL,
  PageBeanProjectDetails.JSON_PROPERTY_VALUES
})
...
public class PageBeanProjectDetails {
  ...
  public PageBeanProjectDetails(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<ProjectDetails> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanProjectDetails object is equal to o.
   */
  @Override

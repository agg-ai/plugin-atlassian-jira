 ...
 */
@JsonPropertyOrder({
  PageBeanString.JSON_PROPERTY_IS_LAST,
  PageBeanString.JSON_PROPERTY_MAX_RESULTS,
  PageBeanString.JSON_PROPERTY_NEXT_PAGE,
  PageBeanString.JSON_PROPERTY_SELF,
  PageBeanString.JSON_PROPERTY_START_AT,
  PageBeanString.JSON_PROPERTY_TOTAL,
  PageBeanString.JSON_PROPERTY_VALUES
})
...
public class PageBeanString {
  ...
  public PageBeanString(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<String> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanString object is equal to o.
   */
  @Override

...
public class PageBeanFieldConfigurationIssueTypeItem {
  ...
  public PageBeanFieldConfigurationIssueTypeItem(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<FieldConfigurationIssueTypeItem> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanFieldConfigurationIssueTypeItem object is equal to o.
   */
  @Override

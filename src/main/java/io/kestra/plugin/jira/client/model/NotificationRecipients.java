...
public class NotificationRecipients {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("assignee", "groupIds", "groups", "reporter", "users", "voters", "watchers"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NotificationRecipients.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in NotificationRecipients is not found in the empty JSON string", NotificationRecipients.openapiRequiredFields.toString()));
        }
      }

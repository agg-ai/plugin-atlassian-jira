 ...
 */
@JsonPropertyOrder({
  PageBeanComponentWithIssueCount.JSON_PROPERTY_IS_LAST,
  PageBeanComponentWithIssueCount.JSON_PROPERTY_MAX_RESULTS,
  PageBeanComponentWithIssueCount.JSON_PROPERTY_NEXT_PAGE,
  PageBeanComponentWithIssueCount.JSON_PROPERTY_SELF,
  PageBeanComponentWithIssueCount.JSON_PROPERTY_START_AT,
  PageBeanComponentWithIssueCount.JSON_PROPERTY_TOTAL,
  PageBeanComponentWithIssueCount.JSON_PROPERTY_VALUES
})
...
public class PageBeanComponentWithIssueCount {
  ...
  public PageBeanComponentWithIssueCount(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<ComponentWithIssueCount> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanComponentWithIssueCount object is equal to o.
   */
  @Override

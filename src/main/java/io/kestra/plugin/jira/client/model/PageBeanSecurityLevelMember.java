 ...
 */
@JsonPropertyOrder({
  PageBeanSecurityLevelMember.JSON_PROPERTY_IS_LAST,
  PageBeanSecurityLevelMember.JSON_PROPERTY_MAX_RESULTS,
  PageBeanSecurityLevelMember.JSON_PROPERTY_NEXT_PAGE,
  PageBeanSecurityLevelMember.JSON_PROPERTY_SELF,
  PageBeanSecurityLevelMember.JSON_PROPERTY_START_AT,
  PageBeanSecurityLevelMember.JSON_PROPERTY_TOTAL,
  PageBeanSecurityLevelMember.JSON_PROPERTY_VALUES
})
...
public class PageBeanSecurityLevelMember {
  ...
  public PageBeanSecurityLevelMember(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<SecurityLevelMember> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanSecurityLevelMember object is equal to o.
   */
  @Override

 ...
 */
@JsonPropertyOrder({
  PageBean2ComponentJsonBean.JSON_PROPERTY_IS_LAST,
  PageBean2ComponentJsonBean.JSON_PROPERTY_MAX_RESULTS,
  PageBean2ComponentJsonBean.JSON_PROPERTY_NEXT_PAGE,
  PageBean2ComponentJsonBean.JSON_PROPERTY_SELF,
  PageBean2ComponentJsonBean.JSON_PROPERTY_START_AT,
  PageBean2ComponentJsonBean.JSON_PROPERTY_TOTAL,
  PageBean2ComponentJsonBean.JSON_PROPERTY_VALUES
})
...
public class PageBean2ComponentJsonBean {
  ...
  public PageBean2ComponentJsonBean(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<ComponentJsonBean> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBean2ComponentJsonBean object is equal to o.
   */
  @Override

 ...
 */
@JsonPropertyOrder({
  PageBeanIssueTypeSchemeMapping.JSON_PROPERTY_IS_LAST,
  PageBeanIssueTypeSchemeMapping.JSON_PROPERTY_MAX_RESULTS,
  PageBeanIssueTypeSchemeMapping.JSON_PROPERTY_NEXT_PAGE,
  PageBeanIssueTypeSchemeMapping.JSON_PROPERTY_SELF,
  PageBeanIssueTypeSchemeMapping.JSON_PROPERTY_START_AT,
  PageBeanIssueTypeSchemeMapping.JSON_PROPERTY_TOTAL,
  PageBeanIssueTypeSchemeMapping.JSON_PROPERTY_VALUES
})
...
public class PageBeanIssueTypeSchemeMapping {
  ...
  public PageBeanIssueTypeSchemeMapping(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<IssueTypeSchemeMapping> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanIssueTypeSchemeMapping object is equal to o.
   */
  @Override

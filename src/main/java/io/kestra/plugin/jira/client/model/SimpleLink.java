...
public class SimpleLink {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("href", "iconClass", "id", "label", "styleClass", "title", "weight"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SimpleLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SimpleLink is not found in the empty JSON string", SimpleLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SimpleLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SimpleLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("iconClass") != null && !jsonObj.get("iconClass").isJsonNull()) && !jsonObj.get("iconClass").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `iconClass` to be a primitive type in the JSON string but got `%s`", jsonObj.get("iconClass").toString()));
      }

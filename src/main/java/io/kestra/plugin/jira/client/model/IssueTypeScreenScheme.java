...
public class IssueTypeScreenScheme {
   ...
   * @throws IOException if the JSON Element is invalid with respect to IssueTypeScreenScheme
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IssueTypeScreenScheme.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in IssueTypeScreenScheme is not found in the empty JSON string", IssueTypeScreenScheme.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IssueTypeScreenScheme.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `IssueTypeScreenScheme` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

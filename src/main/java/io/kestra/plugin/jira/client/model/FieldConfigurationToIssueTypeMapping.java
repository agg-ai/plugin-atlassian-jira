 ...
 */
@JsonPropertyOrder({
  FieldConfigurationToIssueTypeMapping.JSON_PROPERTY_FIELD_CONFIGURATION_ID,
  FieldConfigurationToIssueTypeMapping.JSON_PROPERTY_ISSUE_TYPE_ID
})
...
public class FieldConfigurationToIssueTypeMapping {
  ...
  /**
   * Return true if this FieldConfigurationToIssueTypeMapping object is equal to o.
   */
  @Override

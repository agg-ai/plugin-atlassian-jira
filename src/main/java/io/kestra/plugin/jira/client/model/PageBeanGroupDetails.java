...
import io.kestra.plugin.jira.client.model.GroupDetails;
import java.net.URI;
 ...
 */
@JsonPropertyOrder({
  PageBeanGroupDetails.JSON_PROPERTY_IS_LAST,
  PageBeanGroupDetails.JSON_PROPERTY_MAX_RESULTS,
  PageBeanGroupDetails.JSON_PROPERTY_NEXT_PAGE,
  PageBeanGroupDetails.JSON_PROPERTY_SELF,
  PageBeanGroupDetails.JSON_PROPERTY_START_AT,
  PageBeanGroupDetails.JSON_PROPERTY_TOTAL,
  PageBeanGroupDetails.JSON_PROPERTY_VALUES
})
...
public class PageBeanGroupDetails {
  ...
  public PageBeanGroupDetails(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<GroupDetails> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanGroupDetails object is equal to o.
   */
  @Override

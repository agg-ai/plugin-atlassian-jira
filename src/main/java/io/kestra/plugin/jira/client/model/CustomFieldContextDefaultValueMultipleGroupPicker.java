...
public class CustomFieldContextDefaultValueMultipleGroupPicker {
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomFieldContextDefaultValueMultipleGroupPicker
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomFieldContextDefaultValueMultipleGroupPicker.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CustomFieldContextDefaultValueMultipleGroupPicker is not found in the empty JSON string", CustomFieldContextDefaultValueMultipleGroupPicker.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomFieldContextDefaultValueMultipleGroupPicker.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CustomFieldContextDefaultValueMultipleGroupPicker` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

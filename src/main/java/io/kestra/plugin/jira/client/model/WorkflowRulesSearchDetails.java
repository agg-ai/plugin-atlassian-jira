  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WorkflowRulesSearchDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WorkflowRulesSearchDetails is not found in the empty JSON string", WorkflowRulesSearchDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WorkflowRulesSearchDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WorkflowRulesSearchDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("invalidRules") != null && !jsonObj.get("invalidRules").isJsonNull() && !jsonObj.get("invalidRules").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `invalidRules` to be an array in the JSON string but got `%s`", jsonObj.get("invalidRules").toString()));
      }
      if (jsonObj.get("validRules") != null && !jsonObj.get("validRules").isJsonNull()) {
        ...
        if (jsonArrayvalidRules != null) {
          ...
          if (!jsonObj.get("validRules").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `validRules` to be an array in the JSON string but got `%s`", jsonObj.get("validRules").toString()));
          }
      ...
      if ((jsonObj.get("workflowEntityId") != null && !jsonObj.get("workflowEntityId").isJsonNull()) && !jsonObj.get("workflowEntityId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `workflowEntityId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("workflowEntityId").toString()));
      }
  }

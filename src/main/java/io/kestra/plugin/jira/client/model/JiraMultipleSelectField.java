 ...
 */
@JsonPropertyOrder({
  JiraMultipleSelectField.JSON_PROPERTY_FIELD_ID,
  JiraMultipleSelectField.JSON_PROPERTY_OPTIONS
})
...
public class JiraMultipleSelectField {
  ...
  /**
   * Return true if this JiraMultipleSelectField object is equal to o.
   */
  @Override

 ...
 */
@JsonPropertyOrder({
  FieldConfigurationDetails.JSON_PROPERTY_DESCRIPTION,
  FieldConfigurationDetails.JSON_PROPERTY_NAME
})
...
public class FieldConfigurationDetails {
  ...
  /**
   * Return true if this FieldConfigurationDetails object is equal to o.
   */
  @Override

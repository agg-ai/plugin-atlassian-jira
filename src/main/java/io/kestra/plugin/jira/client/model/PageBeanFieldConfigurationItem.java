 ...
 */
@JsonPropertyOrder({
  PageBeanFieldConfigurationItem.JSON_PROPERTY_IS_LAST,
  PageBeanFieldConfigurationItem.JSON_PROPERTY_MAX_RESULTS,
  PageBeanFieldConfigurationItem.JSON_PROPERTY_NEXT_PAGE,
  PageBeanFieldConfigurationItem.JSON_PROPERTY_SELF,
  PageBeanFieldConfigurationItem.JSON_PROPERTY_START_AT,
  PageBeanFieldConfigurationItem.JSON_PROPERTY_TOTAL,
  PageBeanFieldConfigurationItem.JSON_PROPERTY_VALUES
})
...
public class PageBeanFieldConfigurationItem {
  ...
  public PageBeanFieldConfigurationItem(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<FieldConfigurationItem> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanFieldConfigurationItem object is equal to o.
   */
  @Override

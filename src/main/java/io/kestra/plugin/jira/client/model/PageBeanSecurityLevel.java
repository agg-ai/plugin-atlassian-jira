 ...
 */
@JsonPropertyOrder({
  PageBeanSecurityLevel.JSON_PROPERTY_IS_LAST,
  PageBeanSecurityLevel.JSON_PROPERTY_MAX_RESULTS,
  PageBeanSecurityLevel.JSON_PROPERTY_NEXT_PAGE,
  PageBeanSecurityLevel.JSON_PROPERTY_SELF,
  PageBeanSecurityLevel.JSON_PROPERTY_START_AT,
  PageBeanSecurityLevel.JSON_PROPERTY_TOTAL,
  PageBeanSecurityLevel.JSON_PROPERTY_VALUES
})
...
public class PageBeanSecurityLevel {
  ...
  public PageBeanSecurityLevel(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<SecurityLevel> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanSecurityLevel object is equal to o.
   */
  @Override

 ...
 */
@JsonPropertyOrder({
  PageBeanUser.JSON_PROPERTY_IS_LAST,
  PageBeanUser.JSON_PROPERTY_MAX_RESULTS,
  PageBeanUser.JSON_PROPERTY_NEXT_PAGE,
  PageBeanUser.JSON_PROPERTY_SELF,
  PageBeanUser.JSON_PROPERTY_START_AT,
  PageBeanUser.JSON_PROPERTY_TOTAL,
  PageBeanUser.JSON_PROPERTY_VALUES
})
...
public class PageBeanUser {
  ...
  public PageBeanUser(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<User> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanUser object is equal to o.
   */
  @Override

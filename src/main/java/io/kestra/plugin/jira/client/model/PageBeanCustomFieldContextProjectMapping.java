 ...
 */
@JsonPropertyOrder({
  PageBeanCustomFieldContextProjectMapping.JSON_PROPERTY_IS_LAST,
  PageBeanCustomFieldContextProjectMapping.JSON_PROPERTY_MAX_RESULTS,
  PageBeanCustomFieldContextProjectMapping.JSON_PROPERTY_NEXT_PAGE,
  PageBeanCustomFieldContextProjectMapping.JSON_PROPERTY_SELF,
  PageBeanCustomFieldContextProjectMapping.JSON_PROPERTY_START_AT,
  PageBeanCustomFieldContextProjectMapping.JSON_PROPERTY_TOTAL,
  PageBeanCustomFieldContextProjectMapping.JSON_PROPERTY_VALUES
})
...
public class PageBeanCustomFieldContextProjectMapping {
  ...
  public PageBeanCustomFieldContextProjectMapping(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<CustomFieldContextProjectMapping> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanCustomFieldContextProjectMapping object is equal to o.
   */
  @Override

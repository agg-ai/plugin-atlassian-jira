...
import io.kestra.plugin.jira.client.model.FilterDetails;
import java.net.URI;
 ...
 */
@JsonPropertyOrder({
  PageBeanFilterDetails.JSON_PROPERTY_IS_LAST,
  PageBeanFilterDetails.JSON_PROPERTY_MAX_RESULTS,
  PageBeanFilterDetails.JSON_PROPERTY_NEXT_PAGE,
  PageBeanFilterDetails.JSON_PROPERTY_SELF,
  PageBeanFilterDetails.JSON_PROPERTY_START_AT,
  PageBeanFilterDetails.JSON_PROPERTY_TOTAL,
  PageBeanFilterDetails.JSON_PROPERTY_VALUES
})
...
public class PageBeanFilterDetails {
  ...
  public PageBeanFilterDetails(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<FilterDetails> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanFilterDetails object is equal to o.
   */
  @Override

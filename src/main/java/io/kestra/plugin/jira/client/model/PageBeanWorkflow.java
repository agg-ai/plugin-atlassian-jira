 ...
 */
@JsonPropertyOrder({
  PageBeanWorkflow.JSON_PROPERTY_IS_LAST,
  PageBeanWorkflow.JSON_PROPERTY_MAX_RESULTS,
  PageBeanWorkflow.JSON_PROPERTY_NEXT_PAGE,
  PageBeanWorkflow.JSON_PROPERTY_SELF,
  PageBeanWorkflow.JSON_PROPERTY_START_AT,
  PageBeanWorkflow.JSON_PROPERTY_TOTAL,
  PageBeanWorkflow.JSON_PROPERTY_VALUES
})
...
public class PageBeanWorkflow {
  ...
  public PageBeanWorkflow(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<Workflow> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanWorkflow object is equal to o.
   */
  @Override

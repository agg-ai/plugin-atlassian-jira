...
public class WorkflowStatusesApi {
     ...
     */
    public okhttp3.Call getStatusCall(@javax.annotation.Nonnull String idOrName, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getStatusValidateBeforeCall(@javax.annotation.Nonnull String idOrName, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getStatusAsync(@javax.annotation.Nonnull String idOrName, final ApiCallback<StatusDetails> _callback) throws ApiException {

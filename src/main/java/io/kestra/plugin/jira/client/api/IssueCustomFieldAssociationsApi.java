...
public class IssueCustomFieldAssociationsApi {
     ...
     */
    public okhttp3.Call createAssociationsCall(@javax.annotation.Nonnull FieldAssociationsRequest fieldAssociationsRequest, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createAssociationsValidateBeforeCall(@javax.annotation.Nonnull FieldAssociationsRequest fieldAssociationsRequest, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call createAssociationsAsync(@javax.annotation.Nonnull FieldAssociationsRequest fieldAssociationsRequest, final ApiCallback<Object> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call removeAssociationsCall(@javax.annotation.Nonnull FieldAssociationsRequest fieldAssociationsRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call removeAssociationsValidateBeforeCall(@javax.annotation.Nonnull FieldAssociationsRequest fieldAssociationsRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'fieldAssociationsRequest' is set
        if (fieldAssociationsRequest == null) {
     ...
     */
    public okhttp3.Call removeAssociationsAsync(@javax.annotation.Nonnull FieldAssociationsRequest fieldAssociationsRequest, final ApiCallback<Object> _callback) throws ApiException {

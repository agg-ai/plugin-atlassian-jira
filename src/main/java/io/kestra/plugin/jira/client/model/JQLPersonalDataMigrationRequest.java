...
public class JQLPersonalDataMigrationRequest {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("queryStrings"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to JQLPersonalDataMigrationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JQLPersonalDataMigrationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in JQLPersonalDataMigrationRequest is not found in the empty JSON string", JQLPersonalDataMigrationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JQLPersonalDataMigrationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `JQLPersonalDataMigrationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

...
public class IssuesAndJQLQueries {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_JQLS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  /**
   * Return true if this IssuesAndJQLQueries object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `jqls` to the URL query string
    if (getJqls() != null) {
      for (int i = 0; i < getJqls().size(); i++) {
        joiner.add(String.format(Locale.ROOT, "%sjqls%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format(Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix),
            ApiClient.urlEncode(ApiClient.valueToString(getJqls().get(i)))));
      }
    }

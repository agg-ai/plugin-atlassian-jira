...
public class PageBeanCustomFieldContextOption {
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageBeanCustomFieldContextOption
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PageBeanCustomFieldContextOption.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in PageBeanCustomFieldContextOption is not found in the empty JSON string", PageBeanCustomFieldContextOption.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageBeanCustomFieldContextOption.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PageBeanCustomFieldContextOption` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

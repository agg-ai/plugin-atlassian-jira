 ...
 */
@JsonPropertyOrder({
  PageBeanCustomFieldContextOption.JSON_PROPERTY_IS_LAST,
  PageBeanCustomFieldContextOption.JSON_PROPERTY_MAX_RESULTS,
  PageBeanCustomFieldContextOption.JSON_PROPERTY_NEXT_PAGE,
  PageBeanCustomFieldContextOption.JSON_PROPERTY_SELF,
  PageBeanCustomFieldContextOption.JSON_PROPERTY_START_AT,
  PageBeanCustomFieldContextOption.JSON_PROPERTY_TOTAL,
  PageBeanCustomFieldContextOption.JSON_PROPERTY_VALUES
})
...
public class PageBeanCustomFieldContextOption {
  ...
  public PageBeanCustomFieldContextOption(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<CustomFieldContextOption> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanCustomFieldContextOption object is equal to o.
   */
  @Override

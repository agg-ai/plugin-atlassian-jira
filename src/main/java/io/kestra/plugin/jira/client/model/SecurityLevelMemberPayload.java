 ...
 */
@JsonPropertyOrder({
  SecurityLevelMemberPayload.JSON_PROPERTY_PARAMETER,
  SecurityLevelMemberPayload.JSON_PROPERTY_TYPE
})
...
public class SecurityLevelMemberPayload {
  ...
  /**
   * Return true if this SecurityLevelMemberPayload object is equal to o.
   */
  @Override

...
public class WorkflowSchemeIdName {
   ...
   * @throws IOException if the JSON Element is invalid with respect to WorkflowSchemeIdName
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WorkflowSchemeIdName.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WorkflowSchemeIdName is not found in the empty JSON string", WorkflowSchemeIdName.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WorkflowSchemeIdName.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WorkflowSchemeIdName` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

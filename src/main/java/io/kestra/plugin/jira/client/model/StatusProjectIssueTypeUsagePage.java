 ...
 */
@JsonPropertyOrder({
  StatusProjectIssueTypeUsagePage.JSON_PROPERTY_NEXT_PAGE_TOKEN,
  StatusProjectIssueTypeUsagePage.JSON_PROPERTY_VALUES
})
...
public class StatusProjectIssueTypeUsagePage {
  ...
  /**
   * Return true if this StatusProjectIssueTypeUsagePage object is equal to o.
   */
  @Override

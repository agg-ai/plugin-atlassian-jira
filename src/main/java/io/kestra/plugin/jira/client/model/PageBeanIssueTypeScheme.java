 ...
 */
@JsonPropertyOrder({
  PageBeanIssueTypeScheme.JSON_PROPERTY_IS_LAST,
  PageBeanIssueTypeScheme.JSON_PROPERTY_MAX_RESULTS,
  PageBeanIssueTypeScheme.JSON_PROPERTY_NEXT_PAGE,
  PageBeanIssueTypeScheme.JSON_PROPERTY_SELF,
  PageBeanIssueTypeScheme.JSON_PROPERTY_START_AT,
  PageBeanIssueTypeScheme.JSON_PROPERTY_TOTAL,
  PageBeanIssueTypeScheme.JSON_PROPERTY_VALUES
})
...
public class PageBeanIssueTypeScheme {
  ...
  public PageBeanIssueTypeScheme(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<IssueTypeScheme> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanIssueTypeScheme object is equal to o.
   */
  @Override

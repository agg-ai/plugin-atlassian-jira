...
import io.kestra.plugin.jira.client.model.IssuesMetaBean;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JiraExpressionEvaluationMetaDataBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in JiraExpressionEvaluationMetaDataBean is not found in the empty JSON string", JiraExpressionEvaluationMetaDataBean.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JiraExpressionEvaluationMetaDataBean.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `JiraExpressionEvaluationMetaDataBean` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

 ...
 */
@JsonPropertyOrder({
  CreateResolutionDetails.JSON_PROPERTY_DESCRIPTION,
  CreateResolutionDetails.JSON_PROPERTY_NAME
})
...
public class CreateResolutionDetails {
  ...
  /**
   * Return true if this CreateResolutionDetails object is equal to o.
   */
  @Override

...
import io.kestra.plugin.jira.client.model.UserKey;
import java.net.URI;
 ...
 */
@JsonPropertyOrder({
  PageBeanUserKey.JSON_PROPERTY_IS_LAST,
  PageBeanUserKey.JSON_PROPERTY_MAX_RESULTS,
  PageBeanUserKey.JSON_PROPERTY_NEXT_PAGE,
  PageBeanUserKey.JSON_PROPERTY_SELF,
  PageBeanUserKey.JSON_PROPERTY_START_AT,
  PageBeanUserKey.JSON_PROPERTY_TOTAL,
  PageBeanUserKey.JSON_PROPERTY_VALUES
})
...
public class PageBeanUserKey {
  ...
  public PageBeanUserKey(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<UserKey> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanUserKey object is equal to o.
   */
  @Override

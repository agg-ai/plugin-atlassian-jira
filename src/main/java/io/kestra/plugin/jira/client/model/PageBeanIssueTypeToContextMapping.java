 ...
 */
@JsonPropertyOrder({
  PageBeanIssueTypeToContextMapping.JSON_PROPERTY_IS_LAST,
  PageBeanIssueTypeToContextMapping.JSON_PROPERTY_MAX_RESULTS,
  PageBeanIssueTypeToContextMapping.JSON_PROPERTY_NEXT_PAGE,
  PageBeanIssueTypeToContextMapping.JSON_PROPERTY_SELF,
  PageBeanIssueTypeToContextMapping.JSON_PROPERTY_START_AT,
  PageBeanIssueTypeToContextMapping.JSON_PROPERTY_TOTAL,
  PageBeanIssueTypeToContextMapping.JSON_PROPERTY_VALUES
})
...
public class PageBeanIssueTypeToContextMapping {
  ...
  public PageBeanIssueTypeToContextMapping(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<IssueTypeToContextMapping> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanIssueTypeToContextMapping object is equal to o.
   */
  @Override

 ...
 */
@JsonPropertyOrder({
  PageBeanWorkflowTransitionRules.JSON_PROPERTY_IS_LAST,
  PageBeanWorkflowTransitionRules.JSON_PROPERTY_MAX_RESULTS,
  PageBeanWorkflowTransitionRules.JSON_PROPERTY_NEXT_PAGE,
  PageBeanWorkflowTransitionRules.JSON_PROPERTY_SELF,
  PageBeanWorkflowTransitionRules.JSON_PROPERTY_START_AT,
  PageBeanWorkflowTransitionRules.JSON_PROPERTY_TOTAL,
  PageBeanWorkflowTransitionRules.JSON_PROPERTY_VALUES
})
...
public class PageBeanWorkflowTransitionRules {
  ...
  public PageBeanWorkflowTransitionRules(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<WorkflowTransitionRules> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanWorkflowTransitionRules object is equal to o.
   */
  @Override

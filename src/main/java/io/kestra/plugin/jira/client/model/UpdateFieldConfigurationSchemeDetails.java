 ...
 */
@JsonPropertyOrder({
  UpdateFieldConfigurationSchemeDetails.JSON_PROPERTY_DESCRIPTION,
  UpdateFieldConfigurationSchemeDetails.JSON_PROPERTY_NAME
})
...
public class UpdateFieldConfigurationSchemeDetails {
  ...
  /**
   * Return true if this UpdateFieldConfigurationSchemeDetails object is equal to o.
   */
  @Override

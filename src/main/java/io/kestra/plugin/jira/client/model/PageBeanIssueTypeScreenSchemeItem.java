 ...
 */
@JsonPropertyOrder({
  PageBeanIssueTypeScreenSchemeItem.JSON_PROPERTY_IS_LAST,
  PageBeanIssueTypeScreenSchemeItem.JSON_PROPERTY_MAX_RESULTS,
  PageBeanIssueTypeScreenSchemeItem.JSON_PROPERTY_NEXT_PAGE,
  PageBeanIssueTypeScreenSchemeItem.JSON_PROPERTY_SELF,
  PageBeanIssueTypeScreenSchemeItem.JSON_PROPERTY_START_AT,
  PageBeanIssueTypeScreenSchemeItem.JSON_PROPERTY_TOTAL,
  PageBeanIssueTypeScreenSchemeItem.JSON_PROPERTY_VALUES
})
...
public class PageBeanIssueTypeScreenSchemeItem {
  ...
  public PageBeanIssueTypeScreenSchemeItem(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<IssueTypeScreenSchemeItem> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanIssueTypeScreenSchemeItem object is equal to o.
   */
  @Override

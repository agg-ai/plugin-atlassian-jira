...
public class IssueTypeSchemeID {
   ...
   * @throws IOException if the JSON Element is invalid with respect to IssueTypeSchemeID
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IssueTypeSchemeID.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in IssueTypeSchemeID is not found in the empty JSON string", IssueTypeSchemeID.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IssueTypeSchemeID.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `IssueTypeSchemeID` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DefaultLevelValue.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DefaultLevelValue is not found in the empty JSON string", DefaultLevelValue.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("defaultLevelId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `defaultLevelId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("defaultLevelId").toString()));
      }

 ...
 */
@JsonPropertyOrder({
  DefaultLevelValue.JSON_PROPERTY_DEFAULT_LEVEL_ID,
  DefaultLevelValue.JSON_PROPERTY_ISSUE_SECURITY_SCHEME_ID
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.17.0")
public class DefaultLevelValue {
  public static final String JSON_PROPERTY_DEFAULT_LEVEL_ID = "defaultLevelId";
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_DEFAULT_LEVEL_ID, required = true)
  ...
  /**
   * Return true if this DefaultLevelValue object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `defaultLevelId` to the URL query string
    if (getDefaultLevelId() != null) {
      joiner.add(String.format(Locale.ROOT, "%sdefaultLevelId%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDefaultLevelId()))));
    }

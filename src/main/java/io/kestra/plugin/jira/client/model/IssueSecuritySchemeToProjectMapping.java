 ...
 */
@JsonPropertyOrder({
  IssueSecuritySchemeToProjectMapping.JSON_PROPERTY_ISSUE_SECURITY_SCHEME_ID,
  IssueSecuritySchemeToProjectMapping.JSON_PROPERTY_PROJECT_ID
})
...
public class IssueSecuritySchemeToProjectMapping {
  ...
  /**
   * Return true if this IssueSecuritySchemeToProjectMapping object is equal to o.
   */
  @Override

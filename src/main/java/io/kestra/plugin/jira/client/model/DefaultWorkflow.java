...
public class DefaultWorkflow {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("updateDraftIfNeeded", "workflow"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("workflow"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DefaultWorkflow.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DefaultWorkflow is not found in the empty JSON string", DefaultWorkflow.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DefaultWorkflow.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DefaultWorkflow` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

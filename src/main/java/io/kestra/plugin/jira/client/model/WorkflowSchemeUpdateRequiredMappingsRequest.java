...
public class WorkflowSchemeUpdateRequiredMappingsRequest {
   ...
   * @throws IOException if the JSON Element is invalid with respect to WorkflowSchemeUpdateRequiredMappingsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WorkflowSchemeUpdateRequiredMappingsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WorkflowSchemeUpdateRequiredMappingsRequest is not found in the empty JSON string", WorkflowSchemeUpdateRequiredMappingsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WorkflowSchemeUpdateRequiredMappingsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WorkflowSchemeUpdateRequiredMappingsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkflowSchemeUpdateRequiredMappingsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkflowSchemeUpdateRequiredMappingsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkflowSchemeUpdateRequiredMappingsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkflowSchemeUpdateRequiredMappingsRequest.class));
  ...
  /**
   * Create an instance of WorkflowSchemeUpdateRequiredMappingsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WorkflowSchemeUpdateRequiredMappingsRequest
   * @throws IOException if the JSON string is invalid with respect to WorkflowSchemeUpdateRequiredMappingsRequest
   */
  ...
  /**
   * Convert an instance of WorkflowSchemeUpdateRequiredMappingsRequest to an JSON string
   *
   * @return JSON string
   */

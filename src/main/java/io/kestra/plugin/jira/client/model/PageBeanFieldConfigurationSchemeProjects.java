...
public class PageBeanFieldConfigurationSchemeProjects {
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageBeanFieldConfigurationSchemeProjects
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PageBeanFieldConfigurationSchemeProjects.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in PageBeanFieldConfigurationSchemeProjects is not found in the empty JSON string", PageBeanFieldConfigurationSchemeProjects.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageBeanFieldConfigurationSchemeProjects.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PageBeanFieldConfigurationSchemeProjects` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

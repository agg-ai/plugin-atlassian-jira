...
import io.kestra.plugin.jira.client.model.FieldConfigurationSchemeProjects;
import java.net.URI;
 ...
 */
@JsonPropertyOrder({
  PageBeanFieldConfigurationSchemeProjects.JSON_PROPERTY_IS_LAST,
  PageBeanFieldConfigurationSchemeProjects.JSON_PROPERTY_MAX_RESULTS,
  PageBeanFieldConfigurationSchemeProjects.JSON_PROPERTY_NEXT_PAGE,
  PageBeanFieldConfigurationSchemeProjects.JSON_PROPERTY_SELF,
  PageBeanFieldConfigurationSchemeProjects.JSON_PROPERTY_START_AT,
  PageBeanFieldConfigurationSchemeProjects.JSON_PROPERTY_TOTAL,
  PageBeanFieldConfigurationSchemeProjects.JSON_PROPERTY_VALUES
})
...
public class PageBeanFieldConfigurationSchemeProjects {
  ...
  public PageBeanFieldConfigurationSchemeProjects(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<FieldConfigurationSchemeProjects> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanFieldConfigurationSchemeProjects object is equal to o.
   */
  @Override

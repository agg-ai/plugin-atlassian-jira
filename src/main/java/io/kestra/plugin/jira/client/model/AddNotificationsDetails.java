 ...
 */
@JsonPropertyOrder({
  AddNotificationsDetails.JSON_PROPERTY_NOTIFICATION_SCHEME_EVENTS
})
...
public class AddNotificationsDetails {
  ...
  public AddNotificationsDetails notificationSchemeEvents(@javax.annotation.Nonnull List<NotificationSchemeEventDetails> notificationSchemeEvents) {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_NOTIFICATION_SCHEME_EVENTS, required = true)
  ...
  @JsonProperty(value = JSON_PROPERTY_NOTIFICATION_SCHEME_EVENTS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setNotificationSchemeEvents(@javax.annotation.Nonnull List<NotificationSchemeEventDetails> notificationSchemeEvents) {
    this.notificationSchemeEvents = notificationSchemeEvents;
  }
  ...
  /**
   * Return true if this AddNotificationsDetails object is equal to o.
   */
  @Override

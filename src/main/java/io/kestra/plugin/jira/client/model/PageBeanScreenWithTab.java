 ...
 */
@JsonPropertyOrder({
  PageBeanScreenWithTab.JSON_PROPERTY_IS_LAST,
  PageBeanScreenWithTab.JSON_PROPERTY_MAX_RESULTS,
  PageBeanScreenWithTab.JSON_PROPERTY_NEXT_PAGE,
  PageBeanScreenWithTab.JSON_PROPERTY_SELF,
  PageBeanScreenWithTab.JSON_PROPERTY_START_AT,
  PageBeanScreenWithTab.JSON_PROPERTY_TOTAL,
  PageBeanScreenWithTab.JSON_PROPERTY_VALUES
})
...
public class PageBeanScreenWithTab {
  ...
  public PageBeanScreenWithTab(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<ScreenWithTab> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanScreenWithTab object is equal to o.
   */
  @Override

 ...
 */
@JsonPropertyOrder({
  PageBeanPriority.JSON_PROPERTY_IS_LAST,
  PageBeanPriority.JSON_PROPERTY_MAX_RESULTS,
  PageBeanPriority.JSON_PROPERTY_NEXT_PAGE,
  PageBeanPriority.JSON_PROPERTY_SELF,
  PageBeanPriority.JSON_PROPERTY_START_AT,
  PageBeanPriority.JSON_PROPERTY_TOTAL,
  PageBeanPriority.JSON_PROPERTY_VALUES
})
...
public class PageBeanPriority {
  ...
  public PageBeanPriority(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<Priority> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanPriority object is equal to o.
   */
  @Override

...
public class PageBeanVersion {
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageBeanVersion
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PageBeanVersion.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in PageBeanVersion is not found in the empty JSON string", PageBeanVersion.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageBeanVersion.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PageBeanVersion` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

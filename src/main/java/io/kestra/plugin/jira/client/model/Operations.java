...
import io.kestra.plugin.jira.client.model.LinkGroup;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Operations.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Operations is not found in the empty JSON string", Operations.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("linkGroups") != null && !jsonObj.get("linkGroups").isJsonNull()) {
        ...
        if (jsonArraylinkGroups != null) {
          ...
          if (!jsonObj.get("linkGroups").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `linkGroups` to be an array in the JSON string but got `%s`", jsonObj.get("linkGroups").toString()));
          }

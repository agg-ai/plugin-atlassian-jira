...
public class Operations {
  ...
  @JsonCreator
  public Operations(
    @JsonProperty(JSON_PROPERTY_LINK_GROUPS) List<LinkGroup> linkGroups
  ) {
  this();
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_LINK_GROUPS, required = false)
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `linkGroups` to the URL query string
    if (getLinkGroups() != null) {
      for (int i = 0; i < getLinkGroups().size(); i++) {
        if (getLinkGroups().get(i) != null) {
          joiner.add(getLinkGroups().get(i).toUrlQueryString(String.format(Locale.ROOT, "%slinkGroups%s%s", prefix, suffix,

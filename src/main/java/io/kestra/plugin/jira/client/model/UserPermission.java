...
public class UserPermission {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("deprecatedKey", "description", "havePermission", "id", "key", "name", "type"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserPermission.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in UserPermission is not found in the empty JSON string", UserPermission.openapiRequiredFields.toString()));
        }
      }

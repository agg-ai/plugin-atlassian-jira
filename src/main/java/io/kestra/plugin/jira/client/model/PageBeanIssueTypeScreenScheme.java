 ...
 */
@JsonPropertyOrder({
  PageBeanIssueTypeScreenScheme.JSON_PROPERTY_IS_LAST,
  PageBeanIssueTypeScreenScheme.JSON_PROPERTY_MAX_RESULTS,
  PageBeanIssueTypeScreenScheme.JSON_PROPERTY_NEXT_PAGE,
  PageBeanIssueTypeScreenScheme.JSON_PROPERTY_SELF,
  PageBeanIssueTypeScreenScheme.JSON_PROPERTY_START_AT,
  PageBeanIssueTypeScreenScheme.JSON_PROPERTY_TOTAL,
  PageBeanIssueTypeScreenScheme.JSON_PROPERTY_VALUES
})
...
public class PageBeanIssueTypeScreenScheme {
  ...
  public PageBeanIssueTypeScreenScheme(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<IssueTypeScreenScheme> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanIssueTypeScreenScheme object is equal to o.
   */
  @Override

...
public class IssueCustomFieldValuesAppsApi {
     ...
     */
    public okhttp3.Call updateCustomFieldValueCall(@javax.annotation.Nonnull String fieldIdOrKey, @javax.annotation.Nonnull CustomFieldValueUpdateDetails customFieldValueUpdateDetails, @javax.annotation.Nullable Boolean generateChangelog, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call updateCustomFieldValueValidateBeforeCall(@javax.annotation.Nonnull String fieldIdOrKey, @javax.annotation.Nonnull CustomFieldValueUpdateDetails customFieldValueUpdateDetails, @javax.annotation.Nullable Boolean generateChangelog, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call updateCustomFieldValueAsync(@javax.annotation.Nonnull String fieldIdOrKey, @javax.annotation.Nonnull CustomFieldValueUpdateDetails customFieldValueUpdateDetails, @javax.annotation.Nullable Boolean generateChangelog, final ApiCallback<Object> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call updateMultipleCustomFieldValuesCall(@javax.annotation.Nonnull MultipleCustomFieldValuesUpdateDetails multipleCustomFieldValuesUpdateDetails, @javax.annotation.Nullable Boolean generateChangelog, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateMultipleCustomFieldValuesValidateBeforeCall(@javax.annotation.Nonnull MultipleCustomFieldValuesUpdateDetails multipleCustomFieldValuesUpdateDetails, @javax.annotation.Nullable Boolean generateChangelog, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call updateMultipleCustomFieldValuesAsync(@javax.annotation.Nonnull MultipleCustomFieldValuesUpdateDetails multipleCustomFieldValuesUpdateDetails, @javax.annotation.Nullable Boolean generateChangelog, final ApiCallback<Object> _callback) throws ApiException {

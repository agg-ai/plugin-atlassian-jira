 ...
 */
@JsonPropertyOrder({
  PageBeanContextualConfiguration.JSON_PROPERTY_IS_LAST,
  PageBeanContextualConfiguration.JSON_PROPERTY_MAX_RESULTS,
  PageBeanContextualConfiguration.JSON_PROPERTY_NEXT_PAGE,
  PageBeanContextualConfiguration.JSON_PROPERTY_SELF,
  PageBeanContextualConfiguration.JSON_PROPERTY_START_AT,
  PageBeanContextualConfiguration.JSON_PROPERTY_TOTAL,
  PageBeanContextualConfiguration.JSON_PROPERTY_VALUES
})
...
public class PageBeanContextualConfiguration {
  ...
  public PageBeanContextualConfiguration(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<ContextualConfiguration> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanContextualConfiguration object is equal to o.
   */
  @Override

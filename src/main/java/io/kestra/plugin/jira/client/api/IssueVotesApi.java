...
public class IssueVotesApi {
     ...
     */
    public okhttp3.Call addVoteCall(@javax.annotation.Nonnull String issueIdOrKey, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call addVoteValidateBeforeCall(@javax.annotation.Nonnull String issueIdOrKey, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call addVoteAsync(@javax.annotation.Nonnull String issueIdOrKey, final ApiCallback<Object> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getVotesCall(@javax.annotation.Nonnull String issueIdOrKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getVotesValidateBeforeCall(@javax.annotation.Nonnull String issueIdOrKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'issueIdOrKey' is set
        if (issueIdOrKey == null) {
     ...
     */
    public okhttp3.Call getVotesAsync(@javax.annotation.Nonnull String issueIdOrKey, final ApiCallback<Votes> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call removeVoteCall(@javax.annotation.Nonnull String issueIdOrKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call removeVoteValidateBeforeCall(@javax.annotation.Nonnull String issueIdOrKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'issueIdOrKey' is set
        if (issueIdOrKey == null) {
     ...
     */
    public okhttp3.Call removeVoteAsync(@javax.annotation.Nonnull String issueIdOrKey, final ApiCallback<Void> _callback) throws ApiException {

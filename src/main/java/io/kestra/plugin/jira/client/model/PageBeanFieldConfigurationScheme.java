 ...
 */
@JsonPropertyOrder({
  PageBeanFieldConfigurationScheme.JSON_PROPERTY_IS_LAST,
  PageBeanFieldConfigurationScheme.JSON_PROPERTY_MAX_RESULTS,
  PageBeanFieldConfigurationScheme.JSON_PROPERTY_NEXT_PAGE,
  PageBeanFieldConfigurationScheme.JSON_PROPERTY_SELF,
  PageBeanFieldConfigurationScheme.JSON_PROPERTY_START_AT,
  PageBeanFieldConfigurationScheme.JSON_PROPERTY_TOTAL,
  PageBeanFieldConfigurationScheme.JSON_PROPERTY_VALUES
})
...
public class PageBeanFieldConfigurationScheme {
  ...
  public PageBeanFieldConfigurationScheme(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<FieldConfigurationScheme> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanFieldConfigurationScheme object is equal to o.
   */
  @Override

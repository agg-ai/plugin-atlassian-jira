...
public class UpdateScreenDetails {
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateScreenDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateScreenDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in UpdateScreenDetails is not found in the empty JSON string", UpdateScreenDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateScreenDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateScreenDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

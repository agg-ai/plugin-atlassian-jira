...
public class WorkflowReadRequest {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("projectAndIssueTypes", "workflowIds", "workflowNames"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WorkflowReadRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in WorkflowReadRequest is not found in the empty JSON string", WorkflowReadRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WorkflowReadRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WorkflowReadRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("projectAndIssueTypes") != null && !jsonObj.get("projectAndIssueTypes").isJsonNull()) {
        ...
        if (jsonArrayprojectAndIssueTypes != null) {
          ...
          if (!jsonObj.get("projectAndIssueTypes").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `projectAndIssueTypes` to be an array in the JSON string but got `%s`", jsonObj.get("projectAndIssueTypes").toString()));
          }

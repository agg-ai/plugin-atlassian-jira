...
public class ApplicationRolesApi {
     ...
     */
    public okhttp3.Call getApplicationRoleCall(@javax.annotation.Nonnull String key, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getApplicationRoleValidateBeforeCall(@javax.annotation.Nonnull String key, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getApplicationRoleAsync(@javax.annotation.Nonnull String key, final ApiCallback<ApplicationRole> _callback) throws ApiException {

...
public class CreatePrioritySchemeDetails {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("defaultPriorityId", "description", "mappings", "name", "priorityIds", "projectIds"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePrioritySchemeDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CreatePrioritySchemeDetails is not found in the empty JSON string", CreatePrioritySchemeDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePrioritySchemeDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreatePrioritySchemeDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("priorityIds") == null) {
        ...
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `priorityIds` to be an array in the JSON string but got `%s`", jsonObj.get("priorityIds").toString()));
      }

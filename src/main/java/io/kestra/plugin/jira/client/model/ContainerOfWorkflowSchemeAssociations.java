...
import io.kestra.plugin.jira.client.model.WorkflowSchemeAssociations;
...
public class ContainerOfWorkflowSchemeAssociations {
  ...
  public ContainerOfWorkflowSchemeAssociations values(@javax.annotation.Nonnull List<WorkflowSchemeAssociations> values) {
    this.values = values;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContainerOfWorkflowSchemeAssociations.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ContainerOfWorkflowSchemeAssociations is not found in the empty JSON string", ContainerOfWorkflowSchemeAssociations.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContainerOfWorkflowSchemeAssociations.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContainerOfWorkflowSchemeAssociations` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

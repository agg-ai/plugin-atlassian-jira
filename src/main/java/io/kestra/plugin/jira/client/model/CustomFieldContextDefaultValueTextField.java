 ...
 */
@JsonPropertyOrder({
  CustomFieldContextDefaultValueTextField.JSON_PROPERTY_TEXT,
  CustomFieldContextDefaultValueTextField.JSON_PROPERTY_TYPE
})
...
public class CustomFieldContextDefaultValueTextField {
  ...
  /**
   * Return true if this CustomFieldContextDefaultValueTextField object is equal to o.
   */
  @Override

 ...
 */
@JsonPropertyOrder({
  TargetStatus.JSON_PROPERTY_STATUSES
})
...
public class TargetStatus {
  ...
  /**
   * Return true if this targetStatus object is equal to o.
   */
  @Override
    ...
    if (getStatuses() != null) {
      for (String _key : getStatuses().keySet()) {
        joiner.add(String.format(Locale.ROOT, "%sstatuses%s%s=%s", prefix, suffix,
            ...
            getStatuses().get(_key), ApiClient.urlEncode(ApiClient.valueToString(getStatuses().get(_key)))));
      }
    }

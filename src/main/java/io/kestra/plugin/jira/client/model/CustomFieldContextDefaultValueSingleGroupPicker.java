 ...
 */
@JsonPropertyOrder({
  CustomFieldContextDefaultValueSingleGroupPicker.JSON_PROPERTY_CONTEXT_ID,
  CustomFieldContextDefaultValueSingleGroupPicker.JSON_PROPERTY_GROUP_ID,
  CustomFieldContextDefaultValueSingleGroupPicker.JSON_PROPERTY_TYPE
})
...
public class CustomFieldContextDefaultValueSingleGroupPicker {
  ...
  /**
   * Return true if this CustomFieldContextDefaultValueSingleGroupPicker object is equal to o.
   */
  @Override

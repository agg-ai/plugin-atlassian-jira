 ...
 */
@JsonPropertyOrder({
  PageBeanIssueSecurityLevelMember.JSON_PROPERTY_IS_LAST,
  PageBeanIssueSecurityLevelMember.JSON_PROPERTY_MAX_RESULTS,
  PageBeanIssueSecurityLevelMember.JSON_PROPERTY_NEXT_PAGE,
  PageBeanIssueSecurityLevelMember.JSON_PROPERTY_SELF,
  PageBeanIssueSecurityLevelMember.JSON_PROPERTY_START_AT,
  PageBeanIssueSecurityLevelMember.JSON_PROPERTY_TOTAL,
  PageBeanIssueSecurityLevelMember.JSON_PROPERTY_VALUES
})
...
public class PageBeanIssueSecurityLevelMember {
  ...
  public PageBeanIssueSecurityLevelMember(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<IssueSecurityLevelMember> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanIssueSecurityLevelMember object is equal to o.
   */
  @Override

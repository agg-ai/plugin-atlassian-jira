...
import io.kestra.plugin.jira.client.model.Field;
import java.net.URI;
 ...
 */
@JsonPropertyOrder({
  PageBeanField.JSON_PROPERTY_IS_LAST,
  PageBeanField.JSON_PROPERTY_MAX_RESULTS,
  PageBeanField.JSON_PROPERTY_NEXT_PAGE,
  PageBeanField.JSON_PROPERTY_SELF,
  PageBeanField.JSON_PROPERTY_START_AT,
  PageBeanField.JSON_PROPERTY_TOTAL,
  PageBeanField.JSON_PROPERTY_VALUES
})
...
public class PageBeanField {
  ...
  public PageBeanField(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<Field> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanField object is equal to o.
   */
  @Override

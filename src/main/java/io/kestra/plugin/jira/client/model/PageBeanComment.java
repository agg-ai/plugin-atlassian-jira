 ...
 */
@JsonPropertyOrder({
  PageBeanComment.JSON_PROPERTY_IS_LAST,
  PageBeanComment.JSON_PROPERTY_MAX_RESULTS,
  PageBeanComment.JSON_PROPERTY_NEXT_PAGE,
  PageBeanComment.JSON_PROPERTY_SELF,
  PageBeanComment.JSON_PROPERTY_START_AT,
  PageBeanComment.JSON_PROPERTY_TOTAL,
  PageBeanComment.JSON_PROPERTY_VALUES
})
...
public class PageBeanComment {
  ...
  public PageBeanComment(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<Comment> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanComment object is equal to o.
   */
  @Override

 ...
 */
@JsonPropertyOrder({
  PageBeanWorkflowScheme.JSON_PROPERTY_IS_LAST,
  PageBeanWorkflowScheme.JSON_PROPERTY_MAX_RESULTS,
  PageBeanWorkflowScheme.JSON_PROPERTY_NEXT_PAGE,
  PageBeanWorkflowScheme.JSON_PROPERTY_SELF,
  PageBeanWorkflowScheme.JSON_PROPERTY_START_AT,
  PageBeanWorkflowScheme.JSON_PROPERTY_TOTAL,
  PageBeanWorkflowScheme.JSON_PROPERTY_VALUES
})
...
public class PageBeanWorkflowScheme {
  ...
  public PageBeanWorkflowScheme(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<WorkflowScheme> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanWorkflowScheme object is equal to o.
   */
  @Override

  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NotificationSchemeAndProjectMappingJsonBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in NotificationSchemeAndProjectMappingJsonBean is not found in the empty JSON string", NotificationSchemeAndProjectMappingJsonBean.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NotificationSchemeAndProjectMappingJsonBean.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `NotificationSchemeAndProjectMappingJsonBean` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("notificationSchemeId") != null && !jsonObj.get("notificationSchemeId").isJsonNull()) && !jsonObj.get("notificationSchemeId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `notificationSchemeId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("notificationSchemeId").toString()));
      }

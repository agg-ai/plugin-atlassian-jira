...
public class IssueNavigatorSettingsApi {
     ...
     */
    public okhttp3.Call setIssueNavigatorDefaultColumnsCall(@javax.annotation.Nonnull ColumnRequestBody columnRequestBody, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call setIssueNavigatorDefaultColumnsValidateBeforeCall(@javax.annotation.Nonnull ColumnRequestBody columnRequestBody, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call setIssueNavigatorDefaultColumnsAsync(@javax.annotation.Nonnull ColumnRequestBody columnRequestBody, final ApiCallback<Void> _callback) throws ApiException {

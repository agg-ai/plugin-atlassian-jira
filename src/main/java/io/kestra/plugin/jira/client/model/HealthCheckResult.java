...
public class HealthCheckResult {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_PASSED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPassed() != null) {
      joiner.add(String.format(Locale.ROOT, "%spassed%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPassed()))));
    }

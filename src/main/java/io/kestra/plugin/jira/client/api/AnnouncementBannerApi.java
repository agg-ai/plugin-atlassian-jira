...
public class AnnouncementBannerApi {
     ...
     */
    public okhttp3.Call setBannerCall(@javax.annotation.Nonnull AnnouncementBannerConfigurationUpdate announcementBannerConfigurationUpdate, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call setBannerValidateBeforeCall(@javax.annotation.Nonnull AnnouncementBannerConfigurationUpdate announcementBannerConfigurationUpdate, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call setBannerAsync(@javax.annotation.Nonnull AnnouncementBannerConfigurationUpdate announcementBannerConfigurationUpdate, final ApiCallback<Object> _callback) throws ApiException {

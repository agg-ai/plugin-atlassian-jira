...
public class AuditRecordsApi {
     ...
     */
    public okhttp3.Call getAuditRecordsCall(@javax.annotation.Nullable Integer offset, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable String filter, @javax.annotation.Nullable String from, @javax.annotation.Nullable String to, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAuditRecordsValidateBeforeCall(@javax.annotation.Nullable Integer offset, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable String filter, @javax.annotation.Nullable String from, @javax.annotation.Nullable String to, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getAuditRecordsAsync(@javax.annotation.Nullable Integer offset, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable String filter, @javax.annotation.Nullable String from, @javax.annotation.Nullable String to, final ApiCallback<AuditRecords> _callback) throws ApiException {

...
public class ContainerForRegisteredWebhooks {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_WEBHOOK_REGISTRATION_RESULT, required = false)
  ...
  /**
   * Return true if this ContainerForRegisteredWebhooks object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `webhookRegistrationResult` to the URL query string
    if (getWebhookRegistrationResult() != null) {
      for (int i = 0; i < getWebhookRegistrationResult().size(); i++) {
        if (getWebhookRegistrationResult().get(i) != null) {
          joiner.add(getWebhookRegistrationResult().get(i).toUrlQueryString(String.format(Locale.ROOT, "%swebhookRegistrationResult%s%s", prefix, suffix,

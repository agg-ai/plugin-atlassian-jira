 ...
 */
@JsonPropertyOrder({
  CustomFieldContextDefaultValueDate.JSON_PROPERTY_DATE,
  CustomFieldContextDefaultValueDate.JSON_PROPERTY_TYPE,
  CustomFieldContextDefaultValueDate.JSON_PROPERTY_USE_CURRENT
})
...
public class CustomFieldContextDefaultValueDate {
  ...
  /**
   * Return true if this CustomFieldContextDefaultValueDate object is equal to o.
   */
  @Override

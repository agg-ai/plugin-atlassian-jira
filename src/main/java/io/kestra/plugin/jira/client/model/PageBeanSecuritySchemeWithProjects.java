 ...
 */
@JsonPropertyOrder({
  PageBeanSecuritySchemeWithProjects.JSON_PROPERTY_IS_LAST,
  PageBeanSecuritySchemeWithProjects.JSON_PROPERTY_MAX_RESULTS,
  PageBeanSecuritySchemeWithProjects.JSON_PROPERTY_NEXT_PAGE,
  PageBeanSecuritySchemeWithProjects.JSON_PROPERTY_SELF,
  PageBeanSecuritySchemeWithProjects.JSON_PROPERTY_START_AT,
  PageBeanSecuritySchemeWithProjects.JSON_PROPERTY_TOTAL,
  PageBeanSecuritySchemeWithProjects.JSON_PROPERTY_VALUES
})
...
public class PageBeanSecuritySchemeWithProjects {
  ...
  public PageBeanSecuritySchemeWithProjects(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<SecuritySchemeWithProjects> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanSecuritySchemeWithProjects object is equal to o.
   */
  @Override

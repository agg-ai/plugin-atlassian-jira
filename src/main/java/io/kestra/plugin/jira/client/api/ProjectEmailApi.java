...
public class ProjectEmailApi {
     ...
     */
    public okhttp3.Call getProjectEmailCall(@javax.annotation.Nonnull Long projectId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getProjectEmailValidateBeforeCall(@javax.annotation.Nonnull Long projectId, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getProjectEmailAsync(@javax.annotation.Nonnull Long projectId, final ApiCallback<ProjectEmailAddress> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call updateProjectEmailCall(@javax.annotation.Nonnull Long projectId, @javax.annotation.Nonnull ProjectEmailAddress projectEmailAddress, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateProjectEmailValidateBeforeCall(@javax.annotation.Nonnull Long projectId, @javax.annotation.Nonnull ProjectEmailAddress projectEmailAddress, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectId' is set
        if (projectId == null) {
     ...
     */
    public okhttp3.Call updateProjectEmailAsync(@javax.annotation.Nonnull Long projectId, @javax.annotation.Nonnull ProjectEmailAddress projectEmailAddress, final ApiCallback<Object> _callback) throws ApiException {

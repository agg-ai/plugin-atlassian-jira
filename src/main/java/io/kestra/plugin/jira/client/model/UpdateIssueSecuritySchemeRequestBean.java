 ...
 */
@JsonPropertyOrder({
  UpdateIssueSecuritySchemeRequestBean.JSON_PROPERTY_DESCRIPTION,
  UpdateIssueSecuritySchemeRequestBean.JSON_PROPERTY_NAME
})
...
public class UpdateIssueSecuritySchemeRequestBean {
  ...
  /**
   * Return true if this UpdateIssueSecuritySchemeRequestBean object is equal to o.
   */
  @Override

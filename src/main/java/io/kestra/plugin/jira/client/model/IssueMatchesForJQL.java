...
public class IssueMatchesForJQL {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_MATCHED_ISSUES, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  /**
   * Return true if this IssueMatchesForJQL object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `matchedIssues` to the URL query string
    if (getMatchedIssues() != null) {
      int i = 0;
      for (Long _item : getMatchedIssues()) {
        joiner.add(String.format(Locale.ROOT, "%smatchedIssues%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format(Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix),
            ApiClient.urlEncode(ApiClient.valueToString(_item))));
      }
      i++;

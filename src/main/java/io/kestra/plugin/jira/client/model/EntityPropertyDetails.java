 ...
 */
@JsonPropertyOrder({
  EntityPropertyDetails.JSON_PROPERTY_ENTITY_ID,
  EntityPropertyDetails.JSON_PROPERTY_KEY,
  EntityPropertyDetails.JSON_PROPERTY_VALUE
})
...
public class EntityPropertyDetails {
  ...
  /**
   * Return true if this EntityPropertyDetails object is equal to o.
   */
  @Override

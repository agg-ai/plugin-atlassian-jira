 ...
 */
@JsonPropertyOrder({
  UpdateUiModificationDetails.JSON_PROPERTY_CONTEXTS,
  UpdateUiModificationDetails.JSON_PROPERTY_DATA,
  UpdateUiModificationDetails.JSON_PROPERTY_DESCRIPTION,
  UpdateUiModificationDetails.JSON_PROPERTY_NAME
})
...
public class UpdateUiModificationDetails {
  ...
  /**
   * Return true if this UpdateUiModificationDetails object is equal to o.
   */
  @Override

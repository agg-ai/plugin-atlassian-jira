...
public class FieldConfigurationSchemeProjectAssociation {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_FIELD_CONFIGURATION_SCHEME_ID, required = false)
  ...
  /**
   * Return true if this FieldConfigurationSchemeProjectAssociation object is equal to o.
   */
  @Override

 ...
 */
@JsonPropertyOrder({
  ReorderIssuePriorities.JSON_PROPERTY_AFTER,
  ReorderIssuePriorities.JSON_PROPERTY_IDS,
  ReorderIssuePriorities.JSON_PROPERTY_POSITION
})
...
public class ReorderIssuePriorities {
  ...
  /**
   * Return true if this ReorderIssuePriorities object is equal to o.
   */
  @Override

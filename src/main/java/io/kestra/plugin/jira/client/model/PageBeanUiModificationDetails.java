 ...
 */
@JsonPropertyOrder({
  PageBeanUiModificationDetails.JSON_PROPERTY_IS_LAST,
  PageBeanUiModificationDetails.JSON_PROPERTY_MAX_RESULTS,
  PageBeanUiModificationDetails.JSON_PROPERTY_NEXT_PAGE,
  PageBeanUiModificationDetails.JSON_PROPERTY_SELF,
  PageBeanUiModificationDetails.JSON_PROPERTY_START_AT,
  PageBeanUiModificationDetails.JSON_PROPERTY_TOTAL,
  PageBeanUiModificationDetails.JSON_PROPERTY_VALUES
})
...
public class PageBeanUiModificationDetails {
  ...
  public PageBeanUiModificationDetails(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<UiModificationDetails> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanUiModificationDetails object is equal to o.
   */
  @Override

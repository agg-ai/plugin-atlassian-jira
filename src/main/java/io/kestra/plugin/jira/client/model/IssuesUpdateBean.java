  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IssuesUpdateBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in IssuesUpdateBean is not found in the empty JSON string", IssuesUpdateBean.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("issueUpdates") != null && !jsonObj.get("issueUpdates").isJsonNull() && !jsonObj.get("issueUpdates").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `issueUpdates` to be an array in the JSON string but got `%s`", jsonObj.get("issueUpdates").toString()));
      }
  }

...
public class IssuesUpdateBean {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_ISSUE_UPDATES, required = false)
  ...
  /**
   * Return true if this IssuesUpdateBean object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `issueUpdates` to the URL query string
    if (getIssueUpdates() != null) {
      for (int i = 0; i < getIssueUpdates().size(); i++) {
        if (getIssueUpdates().get(i) != null) {
          joiner.add(String.format(Locale.ROOT, "%sissueUpdates%s%s=%s", prefix, suffix,
              "".equals(suffix) ? "" : String.format(Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix),
              ApiClient.urlEncode(ApiClient.valueToString(getIssueUpdates().get(i)))));
        }
      }
    }

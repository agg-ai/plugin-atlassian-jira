...
public class IssueTypeUpdateBean {
   ...
   * @throws IOException if the JSON Element is invalid with respect to IssueTypeUpdateBean
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IssueTypeUpdateBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in IssueTypeUpdateBean is not found in the empty JSON string", IssueTypeUpdateBean.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IssueTypeUpdateBean.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `IssueTypeUpdateBean` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

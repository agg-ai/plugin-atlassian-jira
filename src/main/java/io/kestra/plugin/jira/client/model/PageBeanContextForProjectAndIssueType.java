...
import io.kestra.plugin.jira.client.model.ContextForProjectAndIssueType;
import java.net.URI;
 ...
 */
@JsonPropertyOrder({
  PageBeanContextForProjectAndIssueType.JSON_PROPERTY_IS_LAST,
  PageBeanContextForProjectAndIssueType.JSON_PROPERTY_MAX_RESULTS,
  PageBeanContextForProjectAndIssueType.JSON_PROPERTY_NEXT_PAGE,
  PageBeanContextForProjectAndIssueType.JSON_PROPERTY_SELF,
  PageBeanContextForProjectAndIssueType.JSON_PROPERTY_START_AT,
  PageBeanContextForProjectAndIssueType.JSON_PROPERTY_TOTAL,
  PageBeanContextForProjectAndIssueType.JSON_PROPERTY_VALUES
})
...
public class PageBeanContextForProjectAndIssueType {
  ...
  public PageBeanContextForProjectAndIssueType(
    ...
    @JsonProperty(JSON_PROPERTY_VALUES) List<ContextForProjectAndIssueType> values
  ) {
  this();
    this.isLast = isLast;
  ...
  /**
   * Return true if this PageBeanContextForProjectAndIssueType object is equal to o.
   */
  @Override
